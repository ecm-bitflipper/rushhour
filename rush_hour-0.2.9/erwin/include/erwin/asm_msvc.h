...
#ifndef ERWIN_ASM_MSVC_H
#define ERWIN_ASM_MSVC_H
...
ERWIN_WRAPPER ERWIN_U32 erwin_mulh32 (ERWIN_U32 i, ERWIN_U32 m)
{
    __asm
    {
        mov   eax, i
...
ERWIN_WRAPPER int erwin_count_bits_non0_aux (unsigned long x)
{
    __asm
    {
        bsr   eax, x
...
{
    return erwin_count_bits_non0_aux(x)+1;
}
...
/* ********************************************************************** */
#define erwin_rol1_16_defined 1
...
/* ********************************************************************** */
#define erwin_ror1_16_defined 1
...
/* ********************************************************************** */
#define erwin_rol1_32_defined 1
...
/* ********************************************************************** */
#define erwin_ror1_32_defined 1
