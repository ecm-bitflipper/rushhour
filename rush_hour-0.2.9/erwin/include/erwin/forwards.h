...
#ifndef ERWIN_FORWARDS_H
#define ERWIN_FORWARDS_H
...
#include "vector_char_p_f.h"
#else
#include <vector_char_p_f.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_edge_p_f.h"
#else
#include <vector_edge_p_f.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_car_p_f.h"
#else
#include <vector_car_p_f.h>
#endif
#ifdef ERWIN_COMPILING
#include "map_int_char_p_f.h"
#else
#include <map_int_char_p_f.h>
#endif
#ifdef ERWIN_COMPILING
...
#endif
#ifdef ERWIN_COMPILING
#include "map_board_p_node_p_f.h"
#else
#include <map_board_p_node_p_f.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_board_p_f.h"
#else
#include <vector_board_p_f.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_node_p_f.h"
#else
#include <vector_node_p_f.h>
#endif
#ifdef ERWIN_COMPILING
...
#endif
#ifdef ERWIN_COMPILING
#include "map_int_int_f.h"
#else
#include <map_int_int_f.h>
#endif
#ifdef ERWIN_COMPILING
#include "map_int_rgbcolour_p_f.h"
#else
#include <map_int_rgbcolour_p_f.h>
#endif
#ifdef __cplusplus
