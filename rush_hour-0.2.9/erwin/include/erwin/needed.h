...
#ifndef ERWIN_NEEDED_H
#define ERWIN_NEEDED_H
...
#include "vector_char_p_n.h"
#else
#include <vector_char_p_n.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_edge_p_n.h"
#else
#include <vector_edge_p_n.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_car_p_n.h"
#else
#include <vector_car_p_n.h>
#endif
#ifdef ERWIN_COMPILING
#include "map_int_char_p_n.h"
#else
#include <map_int_char_p_n.h>
#endif
#ifdef ERWIN_COMPILING
...
#endif
#ifdef ERWIN_COMPILING
#include "map_board_p_node_p_n.h"
#else
#include <map_board_p_node_p_n.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_board_p_n.h"
#else
#include <vector_board_p_n.h>
#endif
#ifdef ERWIN_COMPILING
#include "vector_node_p_n.h"
#else
#include <vector_node_p_n.h>
#endif
#ifdef ERWIN_COMPILING
...
#endif
#ifdef ERWIN_COMPILING
#include "map_int_int_n.h"
#else
#include <map_int_int_n.h>
#endif
#ifdef ERWIN_COMPILING
#include "map_int_rgbcolour_p_n.h"
#else
#include <map_int_rgbcolour_p_n.h>
#endif
/* @@End: #include@@ */
