...
#endif
#ifdef ERWIN_CPP_ONLY
#define ERWIN_CPP_ONLY ERWIN_CPP_ONLY
#endif
#ifdef ERWIN_DEFAULT_ASSERTION_FAILED_HANDLER
#define ERWIN_DEFAULT_ASSERTION_FAILED_HANDLER ERWIN_DEFAULT_ASSERTION_FAILED_HANDLER
#endif
#ifdef ERWIN_ERROR_PRINT
#define ERWIN_ERROR_PRINT ERWIN_ERROR_PRINT
#endif
#ifdef ERWIN_ERROR_STREAM
#define ERWIN_ERROR_STREAM ERWIN_ERROR_STREAM
#endif
#ifdef ERWIN_EXPORT
#define ERWIN_EXPORT ERWIN_EXPORT
#endif
#ifdef ERWIN_INLINE_PERHAPS
#define ERWIN_INLINE_PERHAPS ERWIN_INLINE_PERHAPS
#endif
#ifdef ERWIN_OPTIMISE_SIZE
#define ERWIN_OPTIMISE_SIZE ERWIN_OPTIMISE_SIZE
#endif
#ifdef ERWIN_RAND_MAX
#define ERWIN_RAND_MAX ERWIN_RAND_MAX
#endif
#ifdef ERWIN_NEED_DET_RANDOM
#define ERWIN_NEED_DET_RANDOM ERWIN_NEED_DET_RANDOM
#endif
#ifdef ERWIN_RANDOM
#define ERWIN_RANDOM ERWIN_RANDOM
#endif
#ifdef ERWIN_RANDOM_FUNC
#define ERWIN_RANDOM_FUNC ERWIN_RANDOM_FUNC
#endif
#ifdef ERWIN_THREAD_SAFE
#define ERWIN_THREAD_SAFE ERWIN_THREAD_SAFE
#endif
#ifdef ERWIN_TCALLOC
#define ERWIN_TCALLOC ERWIN_TCALLOC
#endif
#ifdef ERWIN_TMALLOC
#define ERWIN_TMALLOC ERWIN_TMALLOC
#endif
#ifdef ERWIN_TO_BOOL
#define ERWIN_TO_BOOL ERWIN_TO_BOOL
#endif
#ifdef ERWIN_TREALLOC_ARRAY
#define ERWIN_TREALLOC_ARRAY ERWIN_TREALLOC_ARRAY
#endif
#ifdef ERWIN_TREALLOC_ATOMS
#define ERWIN_TREALLOC_ATOMS ERWIN_TREALLOC_ATOMS
#endif
#ifdef ERWIN_TFREE
#define ERWIN_TFREE ERWIN_TFREE
#endif
#ifdef BOOL_DEFINED
#define BOOL_DEFINED BOOL_DEFINED
#endif
#ifdef ERWIN_FALSE
#define ERWIN_FALSE ERWIN_FALSE
#endif
#ifdef ERWIN_TRUE
#define ERWIN_TRUE ERWIN_TRUE
#endif
#ifdef ERWIN_EXPLICIT
#define ERWIN_EXPLICIT ERWIN_EXPLICIT
#endif
#ifdef ERWIN_USE_EXPLICIT
#define ERWIN_USE_EXPLICIT ERWIN_USE_EXPLICIT
#endif
#ifdef ERWIN_USE_MUTABLE
#define ERWIN_USE_MUTABLE ERWIN_USE_MUTABLE
#endif
#ifdef ERWIN_MUTABLE
#define ERWIN_MUTABLE ERWIN_MUTABLE
#endif

#else /* !defined(ERWIN_ADAM_NAME) */

#define ERWIN_VERSION(X,Y,Z) (((X) * 1000000UL) | ((Y) * 10000UL) | (Z))

/* Compatibility #defines */
#ifndef ERWIN_COMPAT_VERSION_CODE
#define ERWIN_COMPAT_VERSION_CODE ERWIN_VERSION(999,0,0)
#endif /* !defined ERWIN_COMPAT_VERSION_CODE */

#if !defined(ERWINMM_COMPAT1)
#  if ERWIN_COMPAT_VERSION_CODE < ERWIN_VERSION(2,0,0)
#    define ERWIN_COMPAT1 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_228)
#  if defined(ERWINMM_COMPAT1) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,228)
#    define ERWIN_COMPAT_2_0_228 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_236)
#  if defined(ERWIN_COMPAT_2_0_228) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,236)
#    define ERWIN_COMPAT_2_0_236 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_241)
#  if defined(ERWIN_COMPAT_2_0_236) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,241)
#    define ERWIN_COMPAT_2_0_241 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_249)
#  if defined(ERWIN_COMPAT_2_0_241) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,249)
#    define ERWIN_COMPAT_2_0_249 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_250)
#  if defined(ERWIN_COMPAT_2_0_249) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,250)
#    define ERWIN_COMPAT_2_0_250 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_260)
#  if defined(ERWIN_COMPAT_2_0_250) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,260)
#    define ERWIN_COMPAT_2_0_260 1
#  endif
#endif

#if !defined(ERWIN_COMPAT_2_0_264)
#  if defined(ERWIN_COMPAT_2_0_260) || ERWIN_COMPAT_VERSION_CODE <= ERWIN_VERSION(2,0,264)
#    define ERWIN_COMPAT_2_0_264 1
#  endif
#endif
...
#      include "erwin/confmsvc.h"
#    else
#      include <erwin/confmsvc.h>
#    endif

#    ifndef ERWIN_OPTIMISE
#    define ERWIN_OPTIMISE      1
#    endif /* !defined ERWIN_OPTIMISE */
#    ifndef ERWIN_OPTIMISE_SIZE
#    define ERWIN_OPTIMISE_SIZE 1
#    endif /* !defined ERWIN_OPTIMISE_SIZE */
...
#  define ERWIN_S64_CMP    ERWIN_LONG_LONG_CMP
#  endif /* !defined ERWIN_S64_CMP */
#  ifndef ERWIN_U64_CMP
#  define ERWIN_U64_CMP    ERWIN_UNSIGNED_LONG_LONG_CMP
#  endif /* !defined ERWIN_U64_CMP */
#  ifndef ERWIN_S64_HASH
#  define ERWIN_S64_HASH   ERWIN_LONG_LONG_HASH
#  endif /* !defined ERWIN_S64_HASH */
#  ifndef ERWIN_U64_HASH
#  define ERWIN_U64_HASH   ERWIN_UNSIGNED_LONG_LONG_HASH
#  endif /* !defined ERWIN_U64_HASH */
#elif SIZEOF_INT == 8
...
#  endif /* !defined ERWIN_U64_TYPE_INFO */
#  ifndef ERWIN_S64_CMP
#  define ERWIN_S64_CMP    INT_CMP
#  endif /* !defined ERWIN_S64_CMP */
#  ifndef ERWIN_U64_CMP
#  define ERWIN_U64_CMP    UNSIGNED_CMP
#  endif /* !defined ERWIN_U64_CMP */
#  ifndef ERWIN_S64_HASH
#  define ERWIN_S64_HASH   INT_HASH
#  endif /* !defined ERWIN_S64_HASH */
#  ifndef ERWIN_U64_HASH
#  define ERWIN_U64_HASH   UNSIGNED_HASH
#  endif /* !defined ERWIN_U64_HASH */
#elif SIZEOF_LONG == 8
...
#  endif /* !defined ERWIN_U64_TYPE_INFO */
#  ifndef ERWIN_S64_CMP
#  define ERWIN_S64_CMP    LONG_CMP
#  endif /* !defined ERWIN_S64_CMP */
#  ifndef ERWIN_U64_CMP
#  define ERWIN_U64_CMP    UNSIGNED_LONG_CMP
#  endif /* !defined ERWIN_U64_CMP */
#  ifndef ERWIN_S64_HASH
#  define ERWIN_S64_HASH   LONG_HASH
#  endif /* !defined ERWIN_S64_HASH */
#  ifndef ERWIN_U64_HASH
#  define ERWIN_U64_HASH   UNSIGNED_LONG_HASH
#  endif /* !defined ERWIN_U64_HASH */
...
#  endif /* !defined ERWIN_U64_TYPE_INFO */
#  ifndef ERWIN_S64_CMP
#  define ERWIN_S64_CMP    LONG_LONG_CMP
#  endif /* !defined ERWIN_S64_CMP */
#  ifndef ERWIN_U64_CMP
#  define ERWIN_U64_CMP    UNSIGNED_LONG_LONG_CMP
#  endif /* !defined ERWIN_U64_CMP */
#  ifndef ERWIN_S64_HASH
#  define ERWIN_S64_HASH   LONG_LONG_HASH
#  endif /* !defined ERWIN_S64_HASH */
#  ifndef ERWIN_U64_HASH
#  define ERWIN_U64_HASH   UNSIGNED_LONG_LONG_HASH
#  endif /* !defined ERWIN_U64_HASH */
#endif
#endif /* ERWIN_S64 */
...
#  define ERWIN_S32_CMP    INT_CMP
#  endif /* !defined ERWIN_S32_CMP */
#  ifndef ERWIN_U32_CMP
#  define ERWIN_U32_CMP    UNSIGNED_CMP
#  endif /* !defined ERWIN_U32_CMP */
#  ifndef ERWIN_S32_HASH
#  define ERWIN_S32_HASH   INT_HASH
#  endif /* !defined ERWIN_S32_HASH */
#  ifndef ERWIN_U32_HASH
#  define ERWIN_U32_HASH   UNSIGNED_HASH
#  endif /* !defined ERWIN_U32_HASH */
#elif SIZEOF_LONG == 4
...
#  endif /* !defined ERWIN_U32_TYPE_INFO */
#  ifndef ERWIN_S32_CMP
#  define ERWIN_S32_CMP    LONG_CMP
#  endif /* !defined ERWIN_S32_CMP */
#  ifndef ERWIN_U32_CMP
#  define ERWIN_U32_CMP    UNSIGNED_LONG_CMP
#  endif /* !defined ERWIN_U32_CMP */
#  ifndef ERWIN_S32_HASH
#  define ERWIN_S32_HASH   LONG_HASH
#  endif /* !defined ERWIN_S32_HASH */
#  ifndef ERWIN_U32_HASH
#  define ERWIN_U32_HASH   UNSIGNED_LONG_HASH
#  endif /* !defined ERWIN_U32_HASH */
#endif
#endif /* ERWIN_S32 */
...
#  define ERWIN_S16_CMP    SHORT_CMP
#  endif /* !defined ERWIN_S16_CMP */
#  ifndef ERWIN_U16_CMP
#  define ERWIN_U16_CMP    UNSIGNED_SHORT_CMP
#  endif /* !defined ERWIN_U16_CMP */
#  ifndef ERWIN_S16_HASH
#  define ERWIN_S16_HASH   SHORT_HASH
#  endif /* !defined ERWIN_S16_HASH */
#  ifndef ERWIN_U16_HASH
#  define ERWIN_U16_HASH   UNSIGNED_SHORT_HASH
#  endif /* !defined ERWIN_U16_HASH */
#elif SIZEOF_INT == 2
...
#  endif /* !defined ERWIN_U16_TYPE_INFO */
#  ifndef ERWIN_S16_CMP
#  define ERWIN_S16_CMP    INT_CMP
#  endif /* !defined ERWIN_S16_CMP */
#  ifndef ERWIN_U16_CMP
#  define ERWIN_U16_CMP    UNSIGNED_CMP
#  endif /* !defined ERWIN_U16_CMP */
#  ifndef ERWIN_S16_HASH
#  define ERWIN_S16_HASH   INT_HASH
#  endif /* !defined ERWIN_S16_HASH */
#  ifndef ERWIN_U16_HASH
#  define ERWIN_U16_HASH   UNSIGNED_HASH
#  endif /* !defined ERWIN_U16_HASH */
#endif
#endif /* ERWIN_S16 */
...
#ifndef ERWIN_S8_CMP
#define ERWIN_S8_CMP       SIGNED_CHAR_CMP
#endif /* !defined ERWIN_S8_CMP */
#ifndef ERWIN_U8_CMP
#define ERWIN_U8_CMP       UNSIGNED_CHAR_CMP
#endif /* !defined ERWIN_U8_CMP */
#ifndef ERWIN_S8_HASH
#define ERWIN_S8_HASH      SIGNED_CHAR_HASH
#endif /* !defined ERWIN_S8_HASH */
#ifndef ERWIN_U8_HASH
#define ERWIN_U8_HASH      UNSIGNED_CHAR_HASH
#endif /* !defined ERWIN_U8_HASH */
#endif /* ERWIN_S8 */
...
#  ifndef PTRINT_CMP
#  define PTRINT_CMP       UNSIGNED_CMP
#  endif /* !defined PTRINT_CMP */
#  ifndef PTRINT_EQUAL
#  define PTRINT_EQUAL     UNSIGNED_EQUAL
#  endif /* !defined PTRINT_EQUAL */
#  ifndef PTRINT_HASH
#  define PTRINT_HASH      UNSIGNED_HASH
#  endif /* !defined PTRINT_HASH */
...
#  endif /* !defined ERWIN_PTRINT_TYPE_INFO */
#  ifndef PTRINT_CMP
#  define PTRINT_CMP       UNSIGNED_LONG_CMP
#  endif /* !defined PTRINT_CMP */
#  ifndef PTRINT_EQUAL
#  define PTRINT_EQUAL     UNSIGNED_LONG_EQUAL
#  endif /* !defined PTRINT_EQUAL */
#  ifndef PTRINT_HASH
#  define PTRINT_HASH      UNSIGNED_LONG_HASH
#  endif /* !defined PTRINT_HASH */
...
#  endif /* !defined ERWIN_PTRINT_TYPE_INFO */
#  ifndef PTRINT_CMP
#  define PTRINT_CMP       UNSIGNED_LONG_LONG_CMP
#  endif /* !defined PTRINT_CMP */
#  ifndef PTRINT_EQUAL
#  define PTRINT_EQUAL     UNSIGNED_LONG_LONG_EQUAL
#  endif /* !defined PTRINT_EQUAL */
#  ifndef PTRINT_HASH
#  define PTRINT_HASH      UNSIGNED_LONG_LONG_HASH
#  endif /* !defined PTRINT_HASH */
#else
...
/* Define ERWIN_EXPLICIT to be empty or 'explicit'. */
#if defined(__cplusplus) && defined(HAVE_WORKING_EXPLICIT)
#  define ERWIN_EXPLICIT     explicit
#  define ERWIN_USE_EXPLICIT 1
#else
#  define ERWIN_EXPLICIT
#  define ERWIN_USE_EXPLICIT 0
#endif

/* Define ERWIN_MUTABLE to be empty or 'mutable'. */
#if defined(__cplusplus) && defined(HAVE_WORKING_MUTABLE)
#  define ERWIN_MUTABLE     mutable
#  define ERWIN_USE_MUTABLE 1
#else
#  define ERWIN_MUTABLE
#  define ERWIN_USE_MUTABLE 0
#endif
...
#  ifndef GNUC_ATTRIBUTE_V30_X86_LINUX
#  define GNUC_ATTRIBUTE_V30_X86_LINUX(X)  GNUC_ATTRIBUTE_V30(X)
#  endif /* !defined GNUC_ATTRIBUTE_V30_X86_LINUX */
#endif
#ifndef GNUC_ATTRIBUTE_V30_X86_LINUX
#define GNUC_ATTRIBUTE_V30_X86_LINUX(X)
#endif /* !defined GNUC_ATTRIBUTE_V30_X86_LINUX */
...
#ifndef ATTR_SECTION
#define ATTR_SECTION(X)                  GNUC_ATTRIBUTE_V30_X86_LINUX((__section__(X)))
...
#  ifndef ERWIN_THREAD_SAFE
#  define ERWIN_THREAD_SAFE 1
#  endif /* !defined ERWIN_THREAD_SAFE */
#endif
 ...
 * safety:
 *
 * #if defined(ERWIN_USE_PTHREAD) && ERWIN_USE_PTHREAD
 * #  define ?ERWIN_THREAD_SAFE 1
 * #endif
 * #if defined(ERWIN_USE_THREAD_KEYWORD) && ERWIN_USE_THREAD_KEYWORD
 * #  define ?ERWIN_THREAD_SAFE 1
 * #endif
 */
 ...
 * ERWIN_USE_THREAD_KEYWORD to 0.  Setting that variable to 1 does
 ...
 * define both macros to 1 (i.e., also ERWIN_USE_PTHREAD).
 *
 * Current macro logic:
 *
...
#  undef ERWIN_USE_THREAD_KEYWORD
#  define ERWIN_USE_THREAD_KEYWORD 0
#endif
/* do not use __thread keyword if pthread is explicitly requested instead: */
#if defined(ERWIN_USE_PTHREAD) && ERWIN_USE_PTHREAD
#  ifndef ERWIN_USE_THREAD_KEYWORD
#  define ERWIN_USE_THREAD_KEYWORD 0
#  endif /* !defined ERWIN_USE_THREAD_KEYWORD */
#endif
/* if __thread does work, we try to use it only if thread safety is requested: */
#if defined(HAVE_THREAD_KEYWORD) && defined(ERWIN_THREAD_SAFE)
#  ifndef ERWIN_USE_THREAD_KEYWORD
#  define ERWIN_USE_THREAD_KEYWORD 1
#  endif /* !defined ERWIN_USE_THREAD_KEYWORD */
#endif
...
#if ERWIN_USE_THREAD_KEYWORD
#  ifndef ERWIN_THREAD_LOCAL
#  define ERWIN_THREAD_LOCAL ERWIN_THREAD_KEYWORD
#  endif /* !defined ERWIN_THREAD_LOCAL */
#else
#  ifndef ERWIN_THREAD_LOCAL
#  define ERWIN_THREAD_LOCAL
#  endif /* !defined ERWIN_THREAD_LOCAL */
#endif
...
#  ifndef ERWIN_USE_PTHREAD
#  define ERWIN_USE_PTHREAD 1
#  endif /* !defined ERWIN_USE_PTHREAD */
#endif
/* By default, we will not try to use it: */
#ifndef ERWIN_USE_PTHREAD
#define ERWIN_USE_PTHREAD 0
#endif /* !defined ERWIN_USE_PTHREAD */
...
#ifdef ERWIN_THREAD_SAFE
#  ifdef ERWIN_COMPILING
#    if ERWIN_USE_PTHREAD && !ERWIN_USE_THREAD_KEYWORD
#      include <pthread.h>
#    endif
#  endif

#endif /* ERWIN_THREAD_SAFE */
 ...
 */
#if !defined(ERWIN_THREAD_SAFE) || ERWIN_USE_THREAD_KEYWORD || ERWIN_USE_PTHREAD
#  define ERWIN_GLOBAL_ERRNO 1
#else
#  define ERWIN_GLOBAL_ERRNO 0
#endif


#ifdef ERWIN_COMPAT_2_0_249
#define ERWIN_CPP_ONLY 0
#define BOOL  ERWIN_BOOL
#define TRUE  ERWIN_TRUE
#define FALSE ERWIN_FALSE
#else
#define ERWIN_CPP_ONLY 1
#endif

#if !defined(BOOL_DEFINED) && !defined(ERWIN_BOOL)
...
#  endif
     ...
     typedef bool ERWIN_BOOL_;
#    define ERWIN_BOOL  ERWIN_BOOL_
#    define ERWIN_FALSE false
#    define ERWIN_TRUE  true
...
#  else
     ...
     typedef unsigned char erwin_bool_t;
#    define ERWIN_BOOL   erwin_bool_t
#    define ERWIN_FALSE  0
#    define ERWIN_TRUE   1
...
#ifndef ERWIN_TO_BOOL
#  ifdef __cplusplus
#    define ERWIN_TO_BOOL(X) ((X) ? true : false)
#  else
#    define ERWIN_TO_BOOL(X) ((X) ? ERWIN_TRUE : ERWIN_FALSE)
#  endif
#endif

#ifdef ERWIN_WEAK_DETERMINISM
#  define ERWIN_REQUIRE_DETERMINISM 1
#endif

#if defined(ERWIN_REQUIRE_DETERMINISM) || !defined(HAVE_RAND)
#  define ERWIN_RANDOM_FUNC     erwin_det_random
#  define ERWIN_RAND_MAX        0xffffffffUL
#  define ERWIN_NEED_DET_RANDOM 1
#else
#  define ERWIN_RANDOM_FUNC     rand
#ifdef RAND_MAX
#  define ERWIN_RAND_MAX        RAND_MAX
#endif /* defined RAND_MAX */
#endif

#ifndef ERWIN_RANDOM
#define ERWIN_RANDOM(N) \
         ((unsigned long)erwin_hash_into(ERWIN_RANDOM_FUNC(),N))
#endif /* !defined ERWIN_RANDOM */
...
#ifndef ERWIN_HASH_STRENGTH
#define ERWIN_HASH_STRENGTH  2
#endif /* !defined ERWIN_HASH_STRENGTH */
...
#ifndef ERWIN_OPTIMISE
#define ERWIN_OPTIMISE      0
#endif /* !defined ERWIN_OPTIMISE */
#ifndef ERWIN_OPTIMISE_SIZE
#define ERWIN_OPTIMISE_SIZE 0
#endif /* !defined ERWIN_OPTIMISE_SIZE */
...
#ifndef ERWIN_TMUL_OR_NULL
#define ERWIN_TMUL_OR_NULL(TYPE,COUNT,EXPR) \
        (ERWIN_LIKELY(erwin_mul_ok(COUNT,sizeof(TYPE))) ? ((TYPE*)(EXPR)) : ((TYPE*)NULL))
#endif /* !defined ERWIN_TMUL_OR_NULL */

#ifndef ERWIN_TMALLOC
   /* NOTE:
    ...
    *        string_dup()        - returns pointer to caller
    *        string_n_dup()      - returns pointer to caller
    *        erwin_merge_sort()  - allocates temporary memory freed
...
#ifndef ERWIN_DEFAULT_NEW_DELETE
#define ERWIN_DEFAULT_NEW_DELETE 1
#endif /* !defined ERWIN_DEFAULT_NEW_DELETE */
 ...
 * is not resizable.
 */
#  define ERWIN_TMALLOC(TYPE,SIZE)             (TYPE*)(malloc (SIZE))
#  define ERWIN_TCALLOC(TYPE,SIZE)             (TYPE*)(calloc (1, SIZE))
#  define ERWIN_TFREE(PTR,TYPE,SIZE)           free(PTR)
 ...
 * for C++.
 */
#  define ERWIN_TMALLOC_ARRAY(TYPE,COUNT) \
          ERWIN_TMUL_OR_NULL (TYPE, COUNT, malloc (COUNT * sizeof(TYPE)))

   /* We do not trust calloc's int overflow detection.
    * FIXME: We should check this in configure. */
#  define ERWIN_TCALLOC_ARRAY(TYPE,COUNT) \
          ERWIN_TMUL_OR_NULL (TYPE, COUNT, calloc (COUNT, sizeof(TYPE)))

#  define ERWIN_TREALLOC_ARRAY(PTR,TYPE,NEWCOUNT,OLDCOUNT) \
          ERWIN_TMUL_OR_NULL (TYPE, NEWCOUNT, realloc(PTR,NEWCOUNT * sizeof(TYPE)))

#  undef  ERWIN_TCREALLOC_ARRAY /*(PTR,TYPE,NEWCOUNT,OLDCOUNT)*/
       /* not available in standard libc, so use default implemented below. */

#  define  ERWIN_TFREE_ARRAY(PTR)  free(PTR)
 ...
 */
#  define ERWIN_TNEW(TYPE,SIZE)                (TYPE*)(::operator new(SIZE))
#  undef  ERWIN_TCNEW /*(TYPE,COUNT)*/
#  define ERWIN_TDELETE(PTR,TYPE,SIZE)         ::operator delete(PTR)
 ...
 */
#  define ERWIN_TNEW_ARRAY(TYPE,COUNT)         new TYPE[COUNT]
#  undef  ERWIN_TCNEW_ARRAY /*(TYPE,COUNT)*/

#  undef  ERWIN_TRENEW_ARRAY /*(PTR,TYPE,NEWCOUNT,OLDCOUNT)*/
#  undef  ERWIN_TCRENEW_ARRAY /*(PTR,TYPE,NEWCOUNT,OLDCOUNT)*/
    /* The C++ standard does not have a concept of reallocation in C++,
     * so it is more efficient to use C-style allocation here.
     */

#  define ERWIN_TDELETE_ARRAY(PTR)             delete[] PTR
    ...
    * ERWIN_TFREE_ARRAY does not have enough parameters to be implemented
    * correctly with ERWIN_TFREE in all cases.
    *
    ...
    *
    * If you define ERWIN_TNEW, you must at least define ERWIN_TMALLOC
    * (and the other mandatory functions), and also ERWIN_TDELETE,
    * ERWIN_TNEW_ARRAY, ERWIN_TDELETE_ARRAY.
    *
    * If you define ERWIN_TMALLOC_ATOMS, you must at least define
    * ERWIN_TMALLOC (and the other mandatory functions) and
    * ERWIN_TFREE_ATOMS.
    *
    * If you define ERWIN_TNEW_ATOMS, you must at least define
    * ERWIN_TNEW (and all the macros that macro requires to be defined) and
    * ERWIN_TDELETE_ATOMS.
    *
    ...
    * ERWIN_TNEW, in which case no default implementation will be used
    * for any of the C++ macros.
    *
    * The _ATOMS family will be implemented using the _ARRAY family, unless you
    * define ERWIN_TNEW_ATOMS, in which case no default implementation
    ...
    * it works, do provide ERWIN_TNEW and ERWIN_TDELETE (and maybe more)
    ...
    * If you do not want this, define ERWIN_DEFAULT_NEW_DELETE to 1.
    *
    * Functionality:
    *  +-----------------+---------------+-----------------------------------------------+
    *  |! C              |! C++          |! Description                                  |
...
#endif  /* defined(ERWIN_TMALLOC) */


#ifndef ERWIN_PTR_ASSIGN
#define ERWIN_PTR_ASSIGN(P,Q)  ((P)=(Q))
#endif /* !defined ERWIN_PTR_ASSIGN */
...
#ifndef ERWIN_TCLEAR
#define ERWIN_TCLEAR(T,P,S) \
               ((T*)erwin_memset0((void*)(P), 0, S))
#endif /* !defined ERWIN_TCLEAR */

#ifndef ERWIN_TCLEAR_ARRAY
#define ERWIN_TCLEAR_ARRAY(T,P,N,O) \
               ((T*)erwin_memset0((void*)(P), (O)*sizeof(T), (N)*sizeof(T)))
#endif /* !defined ERWIN_TCLEAR_ARRAY */


/* For C: */
#ifdef ERWIN_TMALLOC
#ifndef ERWIN_TCALLOC
#define ERWIN_TCALLOC(T,S) \
               ERWIN_TCLEAR(T, ERWIN_TMALLOC(T,S), S)
#endif /* !defined ERWIN_TCALLOC */
#endif /* defined ERWIN_TMALLOC */

#ifdef ERWIN_TMALLOC_ARRAY
#ifndef ERWIN_TCALLOC_ARRAY
#define ERWIN_TCALLOC_ARRAY(T,C) \
               ERWIN_TCLEAR_ARRAY(T, ERWIN_TMALLOC_ARRAY(T,C), C, 0)
#endif /* !defined ERWIN_TCALLOC_ARRAY */
#endif /* defined ERWIN_TMALLOC_ARRAY */

#ifdef ERWIN_TREALLOC_ARRAY
#ifndef ERWIN_TCREALLOC_ARRAY
#define ERWIN_TCREALLOC_ARRAY(P,T,N,O) \
               ERWIN_TCLEAR_ARRAY(T, ERWIN_TREALLOC_ARRAY(P,T,N,O), N, O)
#endif /* !defined ERWIN_TCREALLOC_ARRAY */
...
#ifdef ERWIN_TNEW
#ifndef ERWIN_TCNEW
#define ERWIN_TCNEW(T,S) \
               ERWIN_TCLEAR(T, ERWIN_TNEW(T,S), S)
#endif /* !defined ERWIN_TCNEW */
#endif /* defined ERWIN_TNEW */

#ifdef ERWIN_TNEW_ARRAY
#ifndef ERWIN_TCNEW_ARRAY
#define ERWIN_TCNEW_ARRAY(T,C) \
               ERWIN_TCLEAR_ARRAY(T, ERWIN_TNEW_ARRAY(T,C), C, 0)
#endif /* !defined ERWIN_TCNEW_ARRAY */
#endif /* defined ERWIN_TNEW_ARRAY */

#ifdef ERWIN_TRENEW_ARRAY
#ifndef ERWIN_TCRENEW_ARRAY
#define ERWIN_TCRENEW_ARRAY(P,T,N,O) \
               ERWIN_TCLEAR_ARRAY(T, ERWIN_TRENEW_ARRAY(P,T,N,O), N, O)
#endif /* !defined ERWIN_TCRENEW_ARRAY */
#endif /* defined ERWIN_TRENEW_ARRAY */


#ifndef ERWIN_TMALLOC_ATOMS
/* Use _ARRAY as default for _ATOMS: */

#ifdef ERWIN_TMALLOC_ARRAY
#ifndef ERWIN_TMALLOC_ATOMS
#define ERWIN_TMALLOC_ATOMS    ERWIN_TMALLOC_ARRAY
#endif /* !defined ERWIN_TMALLOC_ATOMS */
#endif /* defined ERWIN_TMALLOC_ARRAY */
#ifdef ERWIN_TCALLOC_ARRAY
#ifndef ERWIN_TCALLOC_ATOMS
#define ERWIN_TCALLOC_ATOMS    ERWIN_TCALLOC_ARRAY
#endif /* !defined ERWIN_TCALLOC_ATOMS */
#endif /* defined ERWIN_TCALLOC_ARRAY */
#ifdef ERWIN_TREALLOC_ARRAY
#ifndef ERWIN_TREALLOC_ATOMS
#define ERWIN_TREALLOC_ATOMS   ERWIN_TREALLOC_ARRAY
#endif /* !defined ERWIN_TREALLOC_ATOMS */
#endif /* defined ERWIN_TREALLOC_ARRAY */
#ifdef ERWIN_TRECALLOC_ARRAY
#ifndef ERWIN_TRECALLOC_ATOMS
#define ERWIN_TRECALLOC_ATOMS  ERWIN_TRECALLOC_ARRAY
#endif /* !defined ERWIN_TRECALLOC_ATOMS */
#endif /* defined ERWIN_TRECALLOC_ARRAY */
#ifdef ERWIN_TFREE_ARRAY
#ifndef ERWIN_TFREE_ATOMS
#define ERWIN_TFREE_ATOMS      ERWIN_TFREE_ARRAY
#endif /* !defined ERWIN_TFREE_ATOMS */
#endif /* defined ERWIN_TFREE_ARRAY */

#ifdef ERWIN_TNEW_ARRAY
#ifndef ERWIN_TNEW_ATOMS
#define ERWIN_TNEW_ATOMS       ERWIN_TNEW_ARRAY
#endif /* !defined ERWIN_TNEW_ATOMS */
#endif /* defined ERWIN_TNEW_ARRAY */
#ifdef ERWIN_TCNEW_ARRAY
#ifndef ERWIN_TCNEW_ATOMS
#define ERWIN_TCNEW_ATOMS      ERWIN_TCNEW_ARRAY
#endif /* !defined ERWIN_TCNEW_ATOMS */
#endif /* defined ERWIN_TCNEW_ARRAY */
#ifdef ERWIN_TRENEW_ARRAY
#ifndef ERWIN_TRENEW_ATOMS
#define ERWIN_TRENEW_ATOMS     ERWIN_TRENEW_ARRAY
#endif /* !defined ERWIN_TRENEW_ATOMS */
#endif /* defined ERWIN_TRENEW_ARRAY */
#ifdef ERWIN_TRECNEW_ARRAY
#ifndef ERWIN_TRECNEW_ATOMS
#define ERWIN_TRECNEW_ATOMS    ERWIN_TRECNEW_ARRAY
#endif /* !defined ERWIN_TRECNEW_ATOMS */
#endif /* defined ERWIN_TRECNEW_ARRAY */
#ifdef ERWIN_TDELETE_ARRAY
#ifndef ERWIN_TDELETE_ATOMS
#define ERWIN_TDELETE_ATOMS    ERWIN_TDELETE_ARRAY
#endif /* !defined ERWIN_TDELETE_ATOMS */
#endif /* defined ERWIN_TDELETE_ARRAY */

#endif


#if defined(__cplusplus) && defined(ERWIN_TNEW) && ERWIN_CPP_ONLY && !defined(ERWIN_C_MM)

#  define ERWIN_THING_NEW(T,S)              (ERWIN_TNEW(T,(S)))
#ifdef ERWIN_TCNEW
#  define ERWIN_THING_CNEW(T,S)             (ERWIN_TCNEW(T,(S)))
#endif /* defined ERWIN_TCNEW */
#  define ERWIN_THING_DELETE(P,T,S)         do{ ERWIN_TDELETE((P),T,(S)); }while(0)

#  define ERWIN_THING_NEW_ARRAY(T,C)        (ERWIN_TNEW_ARRAY(T,(C)))
#ifdef ERWIN_TCNEW_ARRAY
#  define ERWIN_THING_CNEW_ARRAY(T,C)       (ERWIN_TCNEW_ARRAY(T,(C)))
#endif /* defined ERWIN_TCNEW_ARRAY */
#ifdef ERWIN_TRENEW_ARRAY
#  define ERWIN_THING_RENEW_ARRAY(P,T,N,O)  (ERWIN_TRENEW_ARRAY((P),T,(N),(O)))
#endif /* defined ERWIN_TRENEW_ARRAY */
#ifdef ERWIN_TCRENEW_ARRAY
#  define ERWIN_THING_CRENEW_ARRAY(P,T,N,O) (ERWIN_TCRENEW_ARRAY((P),T,(N),(O)))
#endif /* defined ERWIN_TCRENEW_ARRAY */
#  define ERWIN_THING_DELETE_ARRAY(P)       do{ ERWIN_TDELETE_ARRAY((P)); }while(0)

#  define ERWIN_THING_NEW_ATOMS(T,C)        (ERWIN_TNEW_ATOMS(T,(C)))
#ifdef ERWIN_TCNEW_ATOMS
#  define ERWIN_THING_CNEW_ATOMS(T,C)       (ERWIN_TCNEW_ATOMS(T,(C)))
#endif /* defined ERWIN_TCNEW_ATOMS */
#ifdef ERWIN_TRENEW_ATOMS
#  define ERWIN_THING_RENEW_ATOMS(P,T,N,O)  (ERWIN_TRENEW_ATOMS((P),T,(N),(O)))
#endif /* defined ERWIN_TRENEW_ATOMS */
#ifdef ERWIN_TCRENEW_ATOMS
#  define ERWIN_THING_CRENEW_ATOMS(P,T,N,O) (ERWIN_TCRENEW_ATOMS((P),T,(N),(O)))
#endif /* defined ERWIN_TCRENEW_ATOMS */
#  define ERWIN_THING_DELETE_ATOMS(P)       do{ ERWIN_TDELETE_ATOMS((P)); }while(0)

#else

#  define ERWIN_THING_NEW(T,S)              (ERWIN_TMALLOC(T,(S)))
#ifdef ERWIN_TCALLOC
#  define ERWIN_THING_CNEW(T,S)             (ERWIN_TCALLOC(T,(S)))
#endif /* defined ERWIN_TCALLOC */
#  define ERWIN_THING_DELETE(P,T,S)         do{ ERWIN_TFREE((P),T,(S)); }while(0)

#  define ERWIN_THING_NEW_ARRAY(T,C)        (ERWIN_TMALLOC_ARRAY(T,(C)))
#ifdef ERWIN_TCALLOC_ARRAY
#  define ERWIN_THING_CNEW_ARRAY(T,C)       (ERWIN_TCALLOC_ARRAY(T,(C)))
#endif /* defined ERWIN_TCALLOC_ARRAY */
#ifdef ERWIN_TREALLOC_ARRAY
#  define ERWIN_THING_RENEW_ARRAY(P,T,N,O)  (ERWIN_TREALLOC_ARRAY((P),T,(N),(O)))
#endif /* defined ERWIN_TREALLOC_ARRAY */
#ifdef ERWIN_TCREALLOC_ARRAY
#  define ERWIN_THING_CRENEW_ARRAY(P,T,N,O) (ERWIN_TCREALLOC_ARRAY((P),T,(N),(O)))
#endif /* defined ERWIN_TCREALLOC_ARRAY */
#  define ERWIN_THING_DELETE_ARRAY(P)       do{ ERWIN_TFREE_ARRAY((P)); }while(0)

#  define ERWIN_THING_NEW_ATOMS(T,C)        (ERWIN_TMALLOC_ATOMS(T,(C)))
#ifdef ERWIN_TCALLOC_ATOMS
#  define ERWIN_THING_CNEW_ATOMS(T,C)       (ERWIN_TCALLOC_ATOMS(T,(C)))
#endif /* defined ERWIN_TCALLOC_ATOMS */
#ifdef ERWIN_TREALLOC_ATOMS
#  define ERWIN_THING_RENEW_ATOMS(P,T,N,O)  (ERWIN_TREALLOC_ATOMS((P),T,(N),(O)))
#endif /* defined ERWIN_TREALLOC_ATOMS */
#ifdef ERWIN_TCREALLOC_ATOMS
#  define ERWIN_THING_CRENEW_ATOMS(P,T,N,O) (ERWIN_TCREALLOC_ATOMS((P),T,(N),(O)))
#endif /* defined ERWIN_TCREALLOC_ATOMS */
#  define ERWIN_THING_DELETE_ATOMS(P)       do{ ERWIN_TFREE_ATOMS((P)); }while(0)
...
/* The raw macros are not expected to contain a correct macro structure, so
 * we use many parens and do{}while() to ensure one in own internal macros. */
#define ERWIN_TMALLOC1(T)              (ERWIN_TMALLOC(T,sizeof(T)))
#define ERWIN_TCALLOC1(T)              (ERWIN_TCALLOC(T,sizeof(T)))
#define ERWIN_TFREE1(P,T)              do{ ERWIN_TFREE((P),T,sizeof(T)); }while(0)


#define ERWIN_TNEW1(T)                 (ERWIN_TNEW(T,sizeof(T)))
#define ERWIN_TCNEW1(T)                (ERWIN_TCNEW(T,sizeof(T)))
#define ERWIN_TDELETE1(P,T)            do{ ERWIN_TDELETE((P),T,sizeof(T)); }while(0)

/* The _THING_ macros already wrap the raw macros, so they do have a correct macro structure. */
#define ERWIN_THING_NEW1(T)            ERWIN_THING_NEW(T,sizeof(T))
#define ERWIN_THING_CNEW1(T)           ERWIN_THING_CNEW(T,sizeof(T))
#define ERWIN_THING_DELETE1(P,T)       ERWIN_THING_DELETE(P,T,sizeof(T))


#if defined(ERWIN_TNEW)
#  define ERWIN_PREFER_TNEW     ERWIN_TNEW
#  define ERWIN_PREFER_TDELETE  ERWIN_TDELETE
#else
#  define ERWIN_PREFER_TNEW     ERWIN_TMALLOC
#  define ERWIN_PREFER_TDELETE  ERWIN_TFREE
#endif


#define ERWIN_SET_PTR(X,Y)  ((void)(ERWIN_PTR_ASSIGN((X),(Y))))


#ifndef ERWIN_DEFAULT_NEW_DELETE
#define ERWIN_DEFAULT_NEW_DELETE 0
#endif /* !defined ERWIN_DEFAULT_NEW_DELETE */

/*
 * Decide the storage class */
#ifdef ERWIN_INLINE_FUNCTIONS
#  ifndef ERWIN_INLINE_PERHAPS
#  define ERWIN_INLINE_PERHAPS ERWIN_INLINE
#  endif /* !defined ERWIN_INLINE_PERHAPS */
#else
#  ifndef ERWIN_INLINE_PERHAPS
#  define ERWIN_INLINE_PERHAPS
#  endif /* !defined ERWIN_INLINE_PERHAPS */
#endif /* defined(ERWIN_INLINE_FUNCTIONS) */
...
#ifdef ERWIN_STATIC
#  ifndef ERWIN_EXPORT
#  define ERWIN_EXPORT static ERWIN_INLINE_PERHAPS
#  endif /* !defined ERWIN_EXPORT */
#else
#  ifndef ERWIN_EXPORT
#  define ERWIN_EXPORT extern ERWIN_INLINE_PERHAPS
#  endif /* !defined ERWIN_EXPORT */
#endif /* defined(ERWIN_STATIC) */
...
#ifndef ERWIN_ERROR_STREAM
#  define ERWIN_ERROR_STREAM stderr
#endif

#ifndef ERWIN_ERROR_PRINT
#  define ERWIN_ERROR_PRINT fprintf
#endif

#ifndef ERWIN_FORCE_SIG
#define ERWIN_FORCE_SIG 0
#endif /* !defined ERWIN_FORCE_SIG */
#ifndef ERWIN_NO_SIG
#define ERWIN_NO_SIG    0
#endif /* !defined ERWIN_NO_SIG */
 ...
 * in general in C++: */
#ifndef __cplusplus
#    define ERWIN_SIZEOF_MEMBER(Container,slot) \
                  sizeof(((Container*)0)->slot)

#    define ERWIN_OFFSETOF(Container,slot)       \
                  (((char *)&(((Container*)0)->slot)) - \
                  ((char *)(Container*)0))

#else
#    define ERWIN_SIZEOF_MEMBER(Container,slot) \
                  sizeof(((Container*)&erwin_init)->slot)

#    define ERWIN_OFFSETOF(Container,slot)                                              \
                  ((&reinterpret_cast<char volatile const &>(((Container*)&erwin_init)->slot)) - \
                   ((char const *)(Container*)&erwin_init))
...
#ifndef ERWIN_SPLIT
#define ERWIN_SPLIT ALL_ERWIN_SPLIT
#endif /* !defined ERWIN_SPLIT */
...
#ifdef HAVE_LIBERROR
#  define ERWIN_ABORT err_crash
#else
#  define ERWIN_ABORT abort
#endif

#ifndef ERWIN_DEFAULT_ASSERTION_FAILED_HANDLER
#  define ERWIN_DEFAULT_ASSERTION_FAILED_HANDLER(FL,I,FU,A) \
    ((void)(erwin_assertion_is_fatal ? (ERWIN_ABORT(), 0) : 0))
#endif
