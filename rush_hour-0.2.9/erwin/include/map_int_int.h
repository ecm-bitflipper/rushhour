/* -*- Mode: C -*- */
/* Generated Tue Aug 19 15:44:07 GMT 2008
 */
/*
...
#warning "Including map_int_int.h"
#endif

#ifndef ERWIN_MAP_INT_INT_h
#define ERWIN_MAP_INT_INT_h

#ifdef ERWIN_DEBUG_INCLUDE
#warning "First inclusion of map_int_int.h"
#endif
...
typedef int map_int_int_index_t;
typedef int map_int_int_value_t;

typedef struct _map_int_int_pair_t {
    int key;
    int value;
} map_int_int_pair_t;

typedef map_int_int_pair_t map_int_int_pair_dynarray;


typedef struct _map_int_int_pair_ptr_t {
    int key;
    int *value;
} map_int_int_pair_ptr_t;


typedef map_int_int_pair_ptr_t map_int_int_pair_ptr_dynarray;

typedef int (*map_int_int_pair_cmp_t)(map_int_int_pair_t const *, map_int_int_pair_t const *);

typedef int (*map_int_int_pair_ptr_cmp_t)(map_int_int_pair_ptr_t const *, map_int_int_pair_ptr_t const *);

typedef int (*map_int_int_void_pair_cmp_t)(void const *, void const *);



typedef ERWIN_BOOL (*map_int_int_feature_t)(int , int );


typedef int *map_int_int_element_ptr_t;



typedef int map_int_int_key_result_t;
...
typedef struct _map_iterator_t {
     ...
     * manually.  map_int_int iteration looks like this:
     *     : map_iterator_t iter;
     *     : ...
     *     : map_int_int_forall (map, iter, key, value) {
     *     :     ...
     *     : }
     *
...
/*--BEGIN-C--*/
ERWIN_EXPORT
map_int_int_t *map_int_int_new (void) ATTR_MALLOC;
  /* Return a new map with default settings.  I.e., with the
   * default zero element MAP_INT_INT_ZERO and the default initial hash table
   * size of MAP_INT_INT_INITIAL_SIZE.
   *
   * \errno(OK, ERR_NOMEM)
   */

ERWIN_EXPORT
map_int_int_t *map_int_int_new_with_initial_size (int /*initial_size*/) ATTR_MALLOC;
   ...
   *
   * If initial_size < 0 the default size MAP_INT_INT_INITIAL_SIZE will be used.
   * If initial_size == 0 but MAP_INT_INT_MINIMAL_SIZE > 0, a size of 1 will be
   * used.
   *
   ...
   * MAP_INT_INT_TRIGGER_NUMERATOR * 80 / MAP_INT_INT_TRIGGER_DENOMINATOR.
   *
   * \errno(OK, ERR_NOMEM)
   */

#if MAP_INT_INT_DYN_ZERO
ERWIN_EXPORT
map_int_int_t *map_int_int_new_with_zero (int  /*zero*/) ATTR_MALLOC;
...
ERWIN_EXPORT
map_int_int_t *map_int_int_new_with_zero_and_initial_size (int  /*zero*/, int /*initial_size*/) ATTR_MALLOC;
...
ERWIN_EXPORT
int map_int_int_init (
    map_int_int_t * /*self*/) ATTR_NONNULL((1));
  /*
   * This is for initialising non-heap map_int_int_t objects.
   *
...
#if MAP_INT_INT_DYN_ZERO
ERWIN_EXPORT
int map_int_int_init_with_zero_and_initial_size (
    map_int_int_t *      /*self*/,
    int  /*zero*/,
    int          /*initial_size*/) ATTR_NONNULL((1));
  /*
   * This is for initialising non-heap map_int_int_t objects that are allocated
   * manually (thus, not via map_int_int_new).
   *
   * Invoking this function manually is usually discouraged.  It is thought
   * to be for nesting data structures.  However, if you need to optimise
   * heap usage, it is ok to use this function.
...
ERWIN_EXPORT
int map_int_int_init_with_initial_size (
    map_int_int_t * /*self*/,
    int     /*initial_size*/) ATTR_NONNULL((1));
  /*
   * This is for initialising non-heap map_int_int_t objects.
...
ERWIN_EXPORT
void map_int_int_destroy (map_int_int_t * /*self*/);
  /*
   * This is for deleting non-heap map_int_int_t objects.
   *
   * Invoking this function manually is usually discouraged.  It is thought
   * to be for nesting data structures.  However, if you need to optimise
   * heap usage, it is ok to use this function.
...
ERWIN_EXPORT
void map_int_int_xchg (map_int_int_t * /*self*/, map_int_int_t * /*other*/);
  /*
...
ERWIN_EXPORT
void map_int_int_destroy_flags (
  map_int_int_t * /*self*/, ERWIN_BOOL /* destroy_keys */, ERWIN_BOOL /* destroy_values */);
  /*
   * Same as map_int_int_destroy with the possiblity to determine what to destroy.
   *
   * Invoking this function manually is usually discouraged.  It is thought
   * to be for nesting data structures.  However, if you need to optimise
   * heap usage, it is ok to use this function.
...
#if !ERWIN_GLOBAL_ERRNO
ERWIN_EXPORT
int map_int_int_errno(map_int_int_t const *) ATTR_PURE ATTR_NONNULL((1));
...
ERWIN_EXPORT
void map_int_int_clear_errno(map_int_int_t const *) ATTR_NONNULL((1));
...
#define map_int_int_errno(X)          map_errno
  /* If the library was not compiled with ERWIN_THREAD_SAFE, map_int_int_errno(X)
...
#define map_int_int_clear_errno(X)    ((void)(map_errno= MAP_OK))
  /* If the library was not compiled with ERWIN_THREAD_SAFE, map_int_int_clear_errno(X)
...
ERWIN_EXPORT
map_int_int_t *map_int_int_copy (map_int_int_t const* /*self*/);
...
ERWIN_EXPORT
map_int_int_t *map_int_int_copy_err (map_int_int_t const* /*self*/, int *err);
...
ERWIN_EXPORT
void map_int_int_delete (map_int_int_t* /*self*/);
...
ERWIN_EXPORT
void   map_int_int_delete_flags (map_int_int_t* /* self*/, ERWIN_BOOL /* destroy_keys */, ERWIN_BOOL /* destroy_values */);
  /* Deletes only the map structure, not the entries.  This is
   * useful if you got the entries via map_int_int_get_{values|keys}.
   * map_int_int_delete_flat (a, true, true) is the same as
   * map_int_int_delete (a);
   *
   * \errno(OK)
   */
 ...
 * easily possible. */
ERWIN_EXPORT
int map_int_int_insert (map_int_int_t* /*self*/, int  /*key*/, int  /*value*/) ATTR_NONNULL((1));
...
ERWIN_EXPORT
int map_int_int_insert_map (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
...
ERWIN_EXPORT
int  map_int_int_ensure_no_icopy (map_int_int_t * /*self*/, int  /*key*/) ATTR_NONNULL((1));
  /* This is like map_int_int_ensure(), but the input key will be stolen or freed, i.e.,
   * it will be used as a copy inside the hash table, instead of being copied
   * as in map_int_int_ensure.  If the key already exists, the key passed will be freed.
   *
   * Note: This function implements symbol tables.
   *
   * This could be called map_int_int_ensure_steal(), but we already have poke_no_icopy().
   *
   * \errno(OK, WARN_EXISTINGKEY, REHASH_*, ERR_NOMEM)
   */

ERWIN_EXPORT
int  map_int_int_find_any (map_int_int_t const* /*self*/)
  ATTR_ERRNO_PURE;
...
ERWIN_EXPORT
int map_int_int_find_any_pair (map_int_int_key_result_t *, map_int_int_element_ptr_t *, map_int_int_t const* /*self*/)
  ATTR_ERRNO_PURE;
   ...
   * the return value.
   *
   * See map_int_int_find_any() for more documentation.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */
...
ERWIN_EXPORT
int   map_int_int_find (map_int_int_t const* /*self*/, int  /*index*/)
  ATTR_ERRNO_PURE;
  /* Returns the found element or the zero element if not found.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
...
ERWIN_EXPORT
int  map_int_int_find_ensure (map_int_int_t * /*self*/, int  /*index*/);
  /* Returns the found element or introduces an empty element into the
   * map and returns that (use MAP_INT_INT_ENSURE_VALUE to determine the value
   * that is introduced).
   *
   * Also consider find_ptr_ensure if you want to modify the (newly
   * introduced) value.  Also see map_int_int_ensure if you need the key, not
...
ERWIN_EXPORT
int   map_int_int_find_key (map_int_int_t const* /*self*/, int  /*index*/) ATTR_ERRNO_PURE;
...
ERWIN_EXPORT
int   map_int_int_find_any_key (map_int_int_t const* /*self*/) ATTR_ERRNO_PURE;
  /* Returns some key that is stored in the table.
   *
   * See map_int_int_find_any() for docu.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */
...
ERWIN_EXPORT
map_int_int_element_ptr_t map_int_int_find_ptr (map_int_int_t const* /*self*/, int  /*index*/) ATTR_ERRNO_PURE;
...
ERWIN_EXPORT
map_int_int_element_ptr_t map_int_int_find_any_ptr (map_int_int_t const* /*self*/) ATTR_ERRNO_PURE;
...
ERWIN_EXPORT
map_int_int_element_ptr_t map_int_int_find_ptr_ensure (map_int_int_t * /*self*/, int  /*index*/);
...
ERWIN_EXPORT
int map_int_int_modify (
    map_int_int_t* /*self*/, int  /*index*/, int  /*value*/) ATTR_NONNULL((1));
...
ERWIN_EXPORT
int map_int_int_modify_map (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* like map_int_int_modify on all entries in other.  If any key was not found,
...
ERWIN_EXPORT
int map_int_int_set (map_int_int_t* /*self*/, int  /*index*/, int  /*value*/) ATTR_NONNULL((1));
   ...
   *
   * Similar to map_int_int_modify, but value is freed and the status instead of the value
   * is returned.   Furthermore, of course, it is different in that if the value
   * does not exist, it will be inserted.
   *
   * Note: If you don't care whether to use map_int_int_set or map_int_int_insert, use map_int_int_insert.
   *       map_int_int_insert might be a little faster.
   *
   * Result:
...
ERWIN_EXPORT
int map_int_int_set_map (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* like map_int_int_set on all entries in other
   *
   * \errno(OK, REHASH_*, ERR_NOMEM)
   */
...
ERWIN_EXPORT
int map_int_int_intersect (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* Implements set intersection: this invokes map_int_int_erase on all entries
   * in self that are not in other.
   * Returns the number of erased elements (quite like map_int_int_erase_if).
   *
   * \errno(OK, REHASH_*, ERR_NOMEM)
   */

ERWIN_EXPORT
int map_int_int_intersect_no_resize (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* Like map_int_int_intersect, but does not shrink the internal hash table.
   *
   * \errno(OK, REHASH_*, ERR_NOMEM)
   */

ERWIN_EXPORT
int map_int_int_remove (map_int_int_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
...
ERWIN_EXPORT
int map_int_int_remove_no_resize (map_int_int_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
  /* Like map_int_int_remove, but does not shrink the internal hash table.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */

ERWIN_EXPORT
int map_int_int_remove_map (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* like map_int_int_remove on all entries in other.  If any key was not found,
   * WARN_KEYNOTFOUND is returned.
   *
   * \errno(OK, WARN_KEYNOTFOUND, REHASH_*)
   */
...
ERWIN_EXPORT
int map_int_int_remove_if (map_int_int_t * /*self */, map_int_int_feature_t /* feature */, ERWIN_BOOL /* value */);
...
ERWIN_EXPORT
int map_int_int_erase (map_int_int_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
  /* Same as map_int_int_remove, but value is freed.  In error-free operation, returns
...
ERWIN_EXPORT
int map_int_int_erase_no_resize (map_int_int_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
  /* Same as map_int_int_erase, but does not shrink the internal hash table.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */

ERWIN_EXPORT
int map_int_int_erase_map (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* like map_int_int_erase on all entries in other.  If any key was not found,
   * WARN_KEYNOTFOUND is returned.
   *
   * \errno(OK, WARN_KEYNOTFOUND, REHASH_*)
   */
...
ERWIN_EXPORT
int map_int_int_erase_map_no_resize (map_int_int_t* /*self*/, map_int_int_t const * /* other */);
  /* Like map_int_int_erase_map, but does not shrink the internal hash table.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */

ERWIN_EXPORT
int map_int_int_erase_if (map_int_int_t * /*self */, map_int_int_feature_t /* feature */, ERWIN_BOOL /* value */);
...
int map_int_int_poke (
  ...
  /* This is the generalised interface to map_int_int_insert, map_int_int_modify, map_int_int_set, map_int_int_ensure, map_int_int_find
   * and map_int_int_find_key.  This function cannot erase, however (see map_int_int_erase).
   *
   * Input parameters:
   *   +--------------+----------------------------------------------------------------------+
   ...
   *
   * map_int_int_insert:
   *       : return map_int_int_poke (NULL, NULL, self, key, value,
   ...
   * map_int_int_modify:
   *       : int *result;
   *       : map_int_int_poke (NULL, &result, self, key, value,
   *       :           ERWIN_FALSE, ERWIN_TRUE);
   *       : return result;
   *
   * map_int_int_find:
   *       : int *result;
   *       : map_int_int_poke (NULL, &result, self, key, ZERO (int),
   *       :           ERWIN_FALSE, ERWIN_FALSE);
   *       : return (int*)result;
   *
   * map_int_int_find_key:
   *       : int *result;
   *       : map_int_int_poke (&result, NULL, self, key, ZERO (int),
   *       :           ERWIN_FALSE, ERWIN_FALSE);
   *       : return (int*)result;
   *
   * Almost:
   ...
   *       :           ERWIN_TRUE, ERWIN_FALSE);
   *       : result;
   * (Only map_int_int_ensure uses MAP_INT_INT_ENSURE_VALUE to introduce a new element, not
   * ZERO and without copying)
   *
   * Note that map_int_int_find_ptr, map_int_int_remove and map_int_int_erase cannot be implemented with
   * this function.
   *
   * Return Values:
   *    - MAP_OK:
...
int map_int_int_poke_no_icopy (
   ...
   ERWIN_BOOL /*introduce*/,
   ERWIN_BOOL /*overwrite*/) ATTR_NONNULL((3));
  /* Like map_int_int_poke, but the key is not copied.  However, \p key will be freed if it is not
...
int map_int_int_poke_no_ocopy (
  ...
  ERWIN_BOOL /*introduce*/,
  ERWIN_BOOL /*overwrite*/) ATTR_NONNULL((3));
  /* Like map_int_int_poke, but the value is not copied.  However, value may be freed if
   * value_out is NULL.  The rules for copying and freeing values are the same as
   * for key with map_int_int_poke_no_icopy.
   */

ERWIN_EXPORT
int map_int_int_poke_no_icopy_no_ocopy (
  int * /*key_out*/,
  int * /*value_out*/,
  map_int_int_t * /*self*/,
  int  /*key*/,
  ...
  ERWIN_BOOL /*introduce*/,
  ERWIN_BOOL /*overwrite*/) ATTR_NONNULL((3));
  /* Like map_int_int_poke, but neither the key nor the value are copied.  Both, key and value
   * may be freed.  The rules for copying and freeing keys and values are the same
   * as for map_int_int_poke_no_icopy and map_int_int_poke_no_ocopy.
   */

ERWIN_EXPORT
int  map_int_int_zero (map_int_int_t const* /*self*/) ATTR_PURE ATTR_NONNULL((1));
...
ERWIN_EXPORT
int map_int_int_cmp (map_int_int_t const* /*self*/, map_int_int_t const * /*other */) ATTR_ERRNO_PURE;
   ...
   *
   * For equality tests, use map_int_int_equal instead, which is faster.
   *
   ...
   *    INT_CMP or INT_CMP is not defined.
   *
   * \errno(OK, ERR_NOMEM)
   */

ERWIN_EXPORT
ERWIN_BOOL map_int_int_equal (map_int_int_t const* /*self*/, map_int_int_t const * /*other */) ATTR_ERRNO_PURE;
...
ERWIN_EXPORT
int map_int_int_cmp_keys (map_int_int_t const* /*self*/, map_int_int_t const * /*other */) ATTR_ERRNO_PURE;
...
ERWIN_EXPORT
ERWIN_BOOL map_int_int_equal_keys (map_int_int_t const* /*self*/, map_int_int_t const * /*other */) ATTR_ERRNO_PURE;
  /* Returns whether the set of keys in the map is equal.
   *
   * Note: This operation is quite expensive but less expensive than
   *                map_int_int_keys_cmp
   *
   * \errno(OK)
   */

ERWIN_EXPORT
hashval_t map_int_int_hash_raw (map_int_int_t const * /*self*/) ATTR_ERRNO_PURE;
  /* Calculates a hash value for this hash table.  In earlier versions of Erwin,
   * the result was inferior to that of map_int_int_hash, but they are now the same
...
ERWIN_WRAPPER hashval_t map_int_int_hash (map_int_int_t const *) ATTR_ERRNO_PURE;
    /* Same as map_int_int_hash_raw() now that hash_raw() is good enough. */

ERWIN_WRAPPER hashval_t map_int_int_hash (map_int_int_t const *x)
{
    return map_int_int_hash_raw(x);
}


/* ***** access to all entries: ***** */
ERWIN_EXPORT
void map_int_int_clear (map_int_int_t* /*self*/);
   /* Like map_int_int_erase for all elements
    *
    * \errno(OK)
    */

ERWIN_EXPORT
void map_int_int_clear_no_resize (map_int_int_t* /*self*/);
   /* Like map_int_int_erase for all elements, but does not shrink the internal hash table.
    *
    * \errno(OK)
    */

ERWIN_EXPORT
void map_int_int_clear_flags (
    map_int_int_t* /*self*/,
...
ERWIN_EXPORT
void map_int_int_clear_flags_no_resize (
    map_int_int_t* /*self*/,
    ERWIN_BOOL     /*destroy_keys*/,
    ERWIN_BOOL     /*destroy_values*/);
   /* Like map_int_int_clear_flags, but does not shrink the internal hash table.
    *
    * \errno(OK)
    */

ERWIN_EXPORT
int map_int_int_nentries (map_int_int_t const* /*self*/) ATTR_PURE;
...
ERWIN_EXPORT
ERWIN_BOOL map_int_int_empty (map_int_int_t const* /*self*/) ATTR_PURE;
...
ERWIN_EXPORT
map_int_int_pair_t *map_int_int_get_entries (map_int_int_t const* /*self*/) ATTR_MALLOC;
   /* Use map_int_int_delete_entries to deallocate the returned array.
    *
    * \errno(OK, ERR_NOMEM)
    */

ERWIN_EXPORT
void map_int_int_delete_entries (map_int_int_pair_t * /*entries*/);
   /* Deallocate keys obtained by map_int_int_get_entries(). */


ERWIN_EXPORT
map_int_int_pair_ptr_t *map_int_int_get_entries_ptr (map_int_int_t const* /*self*/) ATTR_MALLOC;
   /* Usp map_int_int_delete_entries_ptr to deallocate the returned array.
    *
    * \errno(OK, ERR_NOMEM) */

ERWIN_EXPORT
void map_int_int_delete_entries_ptr (map_int_int_pair_ptr_t * /*entries_ptr*/);
   /* Deallocate keys obtained by map_int_int_get_entries_ptr(). */

ERWIN_EXPORT
int *map_int_int_get_values (map_int_int_t const* /*self*/) ATTR_MALLOC;
   /* \errno(OK, ERR_NOMEM) */

ERWIN_EXPORT
void map_int_int_delete_values (int * /*values*/);
   /* Deallocate keys obtained by map_int_int_get_values(). */

ERWIN_EXPORT
int *map_int_int_get_keys   (map_int_int_t const* /*self*/) ATTR_MALLOC;
    ...
    *       freed by the user using map_int_int_delete_keys().  In earlier versions
    *       of Erwin, free() was recommended for freeing, but due to more
    *       sophisticated memory management, map_int_int_delete_keys() is the
...
ERWIN_EXPORT
void map_int_int_delete_keys (int * /*keys*/);
   /* Deallocate keys obtained by map_int_int_get_keys(). */


/* ***** debugging and special purposes (use rarely!): ***** */
ERWIN_EXPORT
int map_int_int_hash_size (map_int_int_t const* /*self*/) ATTR_PURE;
...
ERWIN_EXPORT
void map_int_int_rehash (map_int_int_t* /*self*/, int /*newsize*/);
...
ERWIN_EXPORT
ERWIN_BOOL map_int_int_expect_size (map_int_int_t* /*self*/, int /*newsize*/);
...
ERWIN_EXPORT
double map_int_int_average_line_length (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
double map_int_int_variance_line_length (map_int_int_t const* /*self*/) ATTR_PURE;

#ifdef HAVE_SQRT
ERWIN_EXPORT
double map_int_int_deviation_line_length (map_int_int_t const* /*self*/) ATTR_PURE;
#endif

ERWIN_EXPORT
int map_int_int_max_line_length (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
int map_int_int_min_line_length (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
void map_int_int_dump (FILE *, map_int_int_t const * /*self*/);
  /* Dumps the internal structure of the map to the given file. */

/* ***** iteration: ***** */
/* New approach: */
#define map_int_int_forall_nondet(h,i,k,v) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration ((h),&i,&k,&v);)
 ...
 * using this.  See map_int_int_forall for details.
 */

#define map_int_int_forall_ptr_nondet(h,i,k,v) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration_ptr ((h),&i,&k,&v);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERWIN_REQUIRE_DETERMINISM is #defined.
 *
 * This iterates over keys and pointers to values.  You need a map_iterator_t as a
 * temporary for using this.  See map_int_int_forall for details.  Iterating over pointers
 * allows you to change entries in the table on the fly.
 */

#define map_int_int_forall_values_nondet(h,i,v) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration_values ((h),&i,&v);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERWIN_REQUIRE_DETERMINISM is #defined.
 *
...
#define map_int_int_forall_values_ptr_nondet(h,i,v) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration_values_ptr ((h),&i,&v);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERWIN_REQUIRE_DETERMINISM is #defined.
 *
 * This iterates over values only.  You need a map_iterator_t as a temporary for
 * using this.  See map_int_int_forall for details.  Iterating over pointers
 * allows you to change entries in the table on the fly.
 */

#define map_int_int_forall_keys_nondet(h,i,k) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration_keys ((h),&i,&k);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERWIN_REQUIRE_DETERMINISM is #defined.
 *
...
#define map_int_int_forall_pairs_nondet(h,i,p) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration_pairs ((h),&i,&p);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERWIN_REQUIRE_DETERMINISM is #defined.
 *
...
#define map_int_int_forall_pairs_ptr_nondet(h,i,p) \
        for(map_int_int_init_iterator ((h),&i); \
            map_int_int_next_iteration_pairs_ptr ((h),&i,&p);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERWIN_REQUIRE_DETERMINISM is #defined.
 *
 * This iterates over key/value pairs.  You need a map_iterator_t as a temporary for
...
#  define map_int_int_forall(h,i,k,v) map_int_int_forall_nondet(h,i,k,v)
...
#  define map_int_int_forall_ptr(h,i,k,v) map_int_int_forall_ptr_nondet(h,i,k,v)
...
#  define map_int_int_forall_values(h,i,v) map_int_int_forall_values_nondet(h,i,v)
/* Works similar to map_forall.
 *
 * This iterates over values only.  You need a map_iterator_t as a temporary for
 * using this.  See map_int_int_forall for details.
...
#  define map_int_int_forall_values_ptr(h,i,v) map_int_int_forall_values_ptr_nondet(h,i,v)
/* Works similar to map_forall.
 *
 * This iterates over values only.  You need a map_iterator_t as a temporary for
 * using this.  See map_int_int_forall for details.  Iterating over pointers
...
#  define map_int_int_forall_keys(h,i,k)   map_int_int_forall_keys_nondet(h,i,k)
/* Works similar to map_forall.
 *
 * This iterates over keys only.  You need a map_iterator_t as a temporary for
 * using this.  See map_int_int_forall for details.
...
#  define map_int_int_forall_pairs(h,i,p)  map_int_int_forall_pairs_nondet(h,i,p)
/* Works similar to map_forall.
 *
 * This iterates over key/value pairs.  You need a map_iterator_t as a temporary for
 * using this.  See map_int_int_forall for details.
...
#  define map_int_int_forall_pairs_ptr(h,i,p)  map_int_int_forall_pairs_ptr_nondet(h,i,p)
/* Works similar to map_forall.
 *
 * This iterates over key/value pairs.  You need a map_iterator_t as a temporary for
 * using this.  See map_int_int_forall for details.  Iterating over pointers
...
ERWIN_EXPORT
void map_int_int_init_iterator (map_int_int_t const *, map_iterator_t *);
/*private*/

#ifdef __cplusplus
ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_key (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_value (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_key_and_value (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_value_and_key (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_user (map_int_int_t const *, map_iterator_sorted_t *,
    map_int_int_pair_cmp_t);
/*private*/

ERWIN_EXPORT                       
void map_int_int_init_iterator_ptr_sorted_by_key (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_value (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_key_and_value (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_value_and_key (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_user (map_int_int_t const *, map_iterator_sorted_t *,
    map_int_int_pair_ptr_cmp_t);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_key_reverse (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_value_reverse (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_key_and_value_reverse (
    map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_value_and_key_reverse (
   map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_sorted_by_user_reverse (
    map_int_int_t const *, map_iterator_sorted_t *, map_int_int_pair_cmp_t);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_key_reverse (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_value_reverse (map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_key_and_value_reverse (
    map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_value_and_key_reverse (
    map_int_int_t const *, map_iterator_sorted_t *);
/*private*/

ERWIN_EXPORT
void map_int_int_init_iterator_ptr_sorted_by_user_reverse (
    map_int_int_t const *, map_iterator_sorted_t *, map_int_int_pair_ptr_cmp_t);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted (map_int_int_t const *, map_iterator_sorted_t *,
    int *, int *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_ptr (map_int_int_t const *, map_iterator_sorted_t *,
    int *, map_int_int_element_ptr_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_keys (map_int_int_t const *,
    map_iterator_sorted_t *, int *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_values (map_int_int_t const *,
    map_iterator_sorted_t *, int *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_values_ptr (map_int_int_t const *,
    map_iterator_sorted_t *, map_int_int_element_ptr_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_pairs (map_int_int_t const *,
    map_iterator_sorted_t *, map_int_int_pair_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_pairs_ptr (map_int_int_t const *,
    map_iterator_sorted_t *, map_int_int_pair_ptr_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_reverse (
    map_int_int_t const *, map_iterator_sorted_t *, int *, int *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_ptr_reverse (
    map_int_int_t const *, map_iterator_sorted_t *, int *, map_int_int_element_ptr_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_keys_reverse (map_int_int_t const *,
    map_iterator_sorted_t *, int *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_values_reverse (map_int_int_t const *,
    map_iterator_sorted_t *, int *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_values_ptr_reverse (map_int_int_t const *,
    map_iterator_sorted_t *, map_int_int_element_ptr_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_pairs_reverse (map_int_int_t const *,
    map_iterator_sorted_t *, map_int_int_pair_t *);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_sorted_pairs_ptr_reverse (map_int_int_t const *,
    map_iterator_sorted_t *, map_int_int_pair_ptr_t *);
/*private*/
...
ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration  (map_int_int_t const* /*self*/,
    map_iterator_t *, int * /*key*/, int * /*value*/);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_ptr  (map_int_int_t const* /*self*/,
    map_iterator_t *, int * /*key*/, map_int_int_element_ptr_t * /*value_ptr*/);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_values  (map_int_int_t const * /*self*/,
    map_iterator_t *, int * /* value */);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_values_ptr  (map_int_int_t const * /*self*/,
    map_iterator_t *, map_int_int_element_ptr_t * /* value_ptr */);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_keys  (map_int_int_t const* /*self*/,
    map_iterator_t *, int * /* key */);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_pairs (map_int_int_t const* /*self*/,
    map_iterator_t *, map_int_int_pair_t * /*pair*/);
/*private*/

ERWIN_EXPORT
ERWIN_BOOL map_int_int_next_iteration_pairs_ptr (map_int_int_t const* /*self*/,
    map_iterator_t *, map_int_int_pair_ptr_t * /*pair*/);
/*private*/

#ifdef ERWIN_PROFILE

ERWIN_EXPORT
int map_int_int_nrehash_ops (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
int map_int_int_nrehash (map_int_int_t const* /*self*/) ATTR_PURE;
  /* rehash_ops is the number of pure rehash operations and rehash
   * is the number of elements moved around during rehashes */

ERWIN_EXPORT
int map_int_int_ninsert (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
int map_int_int_nremove (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
int map_int_int_nfind (map_int_int_t const* /*self*/) ATTR_PURE;

ERWIN_EXPORT
int map_int_int_nops (map_int_int_t const* /*self*/) ATTR_PURE;
  /* Sum of inserts, deletions, and searches */

  /* Most interesting are map_int_int_nops / map_int_int_nrehash. */
#endif
 ...
 */
#include "map_int_int_i.h"


struct map_int_int_t
#ifdef MAP_INT_INT_SUPER_CLASS
   : MAP_INT_INT_SUPER_CLASS_ACCESS MAP_INT_INT_SUPER_CLASS
#endif
{
    /* The map_int_int Class
     * =============
     ...
     *
     *   - map_int_int_:
     *       This is equivalent to map_int_int, or the name
     ...
     *       +-------------------+------------------------------+
     *       |! Template         |! Instantiation               |
     *       | map_int_int_t             | xyz_map_int_p_int_t          |
     *       | MAP_INT_INT_ALLOW_NULL    | XYZ_MAP_INT_P_INT_ALLOW_NULL |
     *       +-------------------+------------------------------+
     *   - MapIntInt:
     *       This is the name of the data structure type in C++: capitalised
     *       and with underbars removed:
     *       +-------------------+-----------------+
     *       |! map_int_int_t            |! MapIntInt      |
    ...
    MAP_INT_INT_STD_MEMBERS(map_int_int_t)
...
public:
    ...
    /*! doc-ignore */
    map_int_int_t *it()             { return this; }

    /*! doc-ignore */
    map_int_int_t const *it() const { return this; }
...
public:
    ...
    static map_int_int_t const &static_zero();

#if MAP_INT_INT_HAVE_INT_CONSTRUCTOR
    ERWIN_EXPLICIT map_int_int_t (int initial_size);
#endif
#if MAP_INT_INT_DYN_ZERO
    ERWIN_EXPLICIT map_int_int_t (int  zero_element);
    map_int_int_t (int  zero_element, int initial_size);
#endif

    /* status code */
#if !ERWIN_GLOBAL_ERRNO
    int get_errno(void) const        { cn(); return it()->m_errno; }
    void clear_errno(void) const     { cn(); map_int_int_clear_errno (it()); }
#else
    ...
    ERWIN_EXPLICIT map_int_int_t (map_int_int_t const *a);

    map_int_int_t (map_int_int_t const &a);

    map_int_int_t *copy (void) const
    {
        cn();
        return new map_int_int_t (it());
    }

    map_int_int_t *copy_err (int *err) const
    {
        cn();
        map_int_int_t *result= new map_int_int_t (it());
        if (err != NULL && MAP_IS_ERROR (get_errno ()))
            *err= 1;
        return result;
    }

    map_int_int_t &xchg(map_int_int_t *other)
    {
        map_int_int_xchg (it(), other);
        return *this;
    }

    map_int_int_t &xchg(map_int_int_t &other)
    {
        map_int_int_xchg (this, &other);
        return *this;
    }

    /* Assignment */

    map_int_int_t &operator= (map_int_int_t const &);
     ...
     * DO NOT CALL map_int_int_delete or map_int_int_delete_flags ON THE RETURNED VALUE!
     * All other things you do are ok. */

    operator map_int_int_t *(void)             { cn(); return it(); }
    operator map_int_int_t const *(void) const { cn(); return it(); }
    ...
    int &operator[] (int  i) {
        cn();
        return *map_int_int_find_ptr_ensure (it(), i);
    }


    int *find_ptr (int  i) const
        { nocn(); return map_int_int_find_ptr (it(), i); }

    int *find_ptr_ensure (int  i)
        { cn(); return map_int_int_find_ptr_ensure (it(), i); }

    /* All other members map to the C equivalent directly. */
    int  find (int  i) const
        { nocn(); return map_int_int_find (it(), i); }
      
    int  find_ensure (int  i)
        { cn(); return map_int_int_find_ensure (it(), i); }

    int  find_any() const
        { nocn(); return map_int_int_find_any (it()); }

    int  find_any_key() const
        { nocn(); return map_int_int_find_any_key (it()); }

    map_int_int_element_ptr_t find_any_ptr() const
        { nocn(); return map_int_int_find_any_ptr (it()); }

    int find_any_pair(map_int_int_key_result_t &kp, map_int_int_element_ptr_t &vp) const
        { nocn(); return map_int_int_find_any_pair (&kp, &vp, it()); }


    /* insert */
    map_int_int_t  &insert (int  k, int  v)
        { cn(); map_int_int_insert (it(), k, v); return *this; }

    map_int_int_t  &insert_map (map_int_int_t const &other)
        { cn(&other); map_int_int_insert_map (it(), other.it()); return *this; }

    map_int_int_t  &insert_map (map_int_int_t const *other)
        { cn(other); map_int_int_insert_map (it(), other->it()); return *this; }

#if MAP_INT_INT_DIRECT_RECURSION == 0
    map_int_int_t  &insert (map_int_int_t const &other)
        { cn(&other); map_int_int_insert_map (it(), other.it()); return *this; }
    ...
    int modify (int  i, int  v)
        { cn(); return map_int_int_modify (it(), i, v); }

    map_int_int_t  &modify_map (map_int_int_t const &other)
        { cn(&other);  map_int_int_modify_map (it(), other.it()); return *this; }

    map_int_int_t  &modify_map (map_int_int_t const *other)
        { cn(other); map_int_int_modify_map (it(), other->it()); return *this; }

#if MAP_INT_INT_DIRECT_RECURSION == 0
    map_int_int_t  &modify (map_int_int_t const &other)
        { cn(&other); map_int_int_modify_map (it(), other.it()); return *this; }
    ...
    map_int_int_t  &set (int  i, int  v)
        { cn(); map_int_int_set (it(), i, v); return *this; }

    map_int_int_t  &set_map (map_int_int_t const &other)
        { cn(&other); map_int_int_set_map (it(), other.it()); return *this; }
...
#if MAP_INT_INT_DIRECT_RECURSION == 0
    map_int_int_t  &set (map_int_int_t const &other)
        { cn(&other); map_int_int_set_map (it(), other.it()); return *this; }
    ...
    /* remove */
    int remove (int  i)
        { nocn(); return map_int_int_remove (it(), i); }

    map_int_int_t &remove_map (map_int_int_t const &other)
        { nocn(&other); map_int_int_remove_map (it(), other.it()); return *this; }

    map_int_int_t &remove_map (map_int_int_t const *other)
        { nocn(other); map_int_int_remove_map (it(), other->it()); return *this; }

    int remove_if (map_int_int_feature_t f, bool value = true)
    {
        nocn();
        return map_int_int_remove_if (it(), f, value);
    }

    /* erase */
    map_int_int_t  &erase (int  i)
        { nocn(); map_int_int_erase (it(), i); return *this; }

    map_int_int_t  &erase_map (map_int_int_t const &other)
        { nocn(&other); map_int_int_erase_map (it(), other.it()); return *this; }

    map_int_int_t  &erase_map (map_int_int_t const *other)
        { nocn(other); map_int_int_erase_map (it(), other->it()); return *this; }

#if MAP_INT_INT_DIRECT_RECURSION == 0
    map_int_int_t  &erase (map_int_int_t const &other)
        { nocn(other); map_int_int_erase_map (it(), other.it()); return *this; }
    ...
    int erase_if (map_int_int_feature_t f, bool value = true)
    {
        nocn();
        return map_int_int_erase_if (it(), f, value);
    }

    map_int_int_t &intersect (map_int_int_t const &other)
        { nocn(&other); map_int_int_intersect (it(), other.it()); return *this; }

    map_int_int_t &intersect (map_int_int_t const *other)
        { nocn(other); map_int_int_intersect (it(), other->it()); return *this; }

    map_int_int_t &intersect_no_resize (map_int_int_t const &other)
        { nocn(&other); map_int_int_intersect_no_resize (it(), other.it()); return *this; }
    ...
    /* others */
    int  find_key (int  i) const { nocn(); return map_int_int_find_key (it(), i); }

    int  zero(void) const { nocn(); return map_int_int_zero (it()); }

    int  ensure (int  k)
        { cn(); return map_int_int_ensure (it(), k); }

    int  ensure_no_icopy (int  k)
        { cn(); return map_int_int_ensure_no_icopy (it(), k); }
    ...
    map_int_int_t &poke (
        int *kp, int *vo,
        int  k, int  v,
        bool aintroduce MAP_INT_INT_DEFAULT_ARG(true),
        bool aoverwrite MAP_INT_INT_DEFAULT_ARG(true))
    {
        cn();
        map_int_int_poke (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    map_int_int_t &poke_no_icopy (
        int *kp, int *vo,
        int  k, int  v,
        bool aintroduce MAP_INT_INT_DEFAULT_ARG(true),
        bool aoverwrite MAP_INT_INT_DEFAULT_ARG(true))
    {
        cn();
        map_int_int_poke_no_icopy (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    map_int_int_t &poke_no_ocopy (
        int *kp, int *vo,
        int  k, int  v,
        bool aintroduce MAP_INT_INT_DEFAULT_ARG(true),
        bool aoverwrite MAP_INT_INT_DEFAULT_ARG(true))
    {
        cn();
        map_int_int_poke_no_ocopy (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    map_int_int_t &poke_no_icopy_no_ocopy (
        int *kp, int *vo,
        int  k, int  v,
        bool aintroduce MAP_INT_INT_DEFAULT_ARG(true),
        bool aoverwrite MAP_INT_INT_DEFAULT_ARG(true))
    {
        cn();
        map_int_int_poke_no_icopy_no_ocopy (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    /* clear */
    map_int_int_t &clear (void)
    {
        nocn();
        map_int_int_clear (it());
        return *this;
    }

    map_int_int_t &clear_no_resize (void)
    {
        nocn();
        map_int_int_clear_no_resize (it());
        return *this;
    }

    map_int_int_t &clear (bool k, bool v)
    {
        nocn();
        map_int_int_clear_flags (it(), k, v);
        return *this;
    }

    int   nentries (void) const                  { nocn(); return map_int_int_nentries (it()); }
    bool  empty (void) const                     { nocn(); return ERWIN_TO_BOOL(map_int_int_empty (it())); }
    bool  non_empty (void) const                 { nocn(); return !map_int_int_empty (it()); }

    int          *get_keys   (void) const      { nocn(); return map_int_int_get_keys (it()); }
    static void delete_keys        (int          *k) { map_int_int_delete_keys (k); }

    map_int_int_pair_t     *get_entries (void) const     { nocn(); return map_int_int_get_entries (it()); }
    map_int_int_pair_ptr_t *get_entries_ptr (void) const { nocn(); return map_int_int_get_entries_ptr (it()); }
    int          *get_values (void) const      { nocn(); return map_int_int_get_values (it()); }

    static void delete_entries_ptr (map_int_int_pair_ptr_t *k) { map_int_int_delete_entries_ptr (k); }
    static void delete_entries     (map_int_int_pair_t     *k) { map_int_int_delete_entries (k); }
    static void delete_values      (int          *k) { map_int_int_delete_values (k); }

    int     hash_size (void) const            { nocn(); return map_int_int_hash_size (it()); }
    map_int_int_t &rehash (int n)                     { nocn(); map_int_int_rehash (it(), n); return *this;}
    double  average_line_length (void) const  { nocn(); return map_int_int_average_line_length (it()); }
    double  variance_line_length (void) const { nocn(); return map_int_int_variance_line_length (it()); }
#ifdef HAVE_SQRT
    double  deviation_line_length (void) const { nocn(); return map_int_int_deviation_line_length (it()); }
#endif
    int     max_line_length (void) const      { nocn(); return map_int_int_max_line_length (it()); }
    int     min_line_length (void) const      { nocn(); return map_int_int_min_line_length (it()); }

    void    dump (FILE *f) const              { nocn(); map_int_int_dump (f, it()); }

#ifdef ERWIN_PROFILE
    int     nrehash_ops (void) const          { nocn(); return map_int_int_nrehash_ops (it()); }
    int     nrehash (void) const              { nocn(); return map_int_int_nrehash (it()); }
    int     ninsert (void) const              { nocn(); return map_int_int_ninsert (it()); }
    int     nremove (void) const              { nocn(); return map_int_int_nremove (it()); }
    int     nfind (void) const                { nocn(); return map_int_int_nfind (it()); }
    int     nops(void) const                  { nocn(); return map_int_int_nops (it()); }
#endif

    hashval_t hash_raw(void) const { nocn(); return map_int_int_hash_raw (it()); }
    hashval_t hash(void) const     { nocn(); return map_int_int_hash     (it()); }

    bool equal(map_int_int_t const *other) const
    {
        if (this == NULL || other == NULL) /* must be NULL-safe */
            return this == other;
        return ERWIN_TO_BOOL(map_int_int_equal (it(), other->it()));
    }
    ...
    int cmp (map_int_int_t const *other) const
    {
        if (this == NULL)
            return other == NULL ? 0 : -1;
        if (other == NULL)
            return +1;
        return map_int_int_cmp (it(), other->it());
    }

    int cmp (map_int_int_t const &other) const { nocn(); return cmp (&other); }

    bool operator== (map_int_int_t const &b) { nocn(); return equal(b); }    /* see equal() */
    bool operator== (map_int_int_t const *b) { nocn(); return equal(b); }    /* see equal() */

    bool operator!= (map_int_int_t const &b) { nocn(); return !equal(b); }   /* see equal() */
    bool operator!= (map_int_int_t const *b) { nocn(); return !equal(b); }   /* see equal() */

    bool operator<= (map_int_int_t const &b) { nocn(); return cmp(b) <= 0; } /* see cmp() */
    bool operator<= (map_int_int_t const *b) { nocn(); return cmp(b) <= 0; } /* see cmp() */
...
/* Note: The map_int_int_pair_cmp_t argument to the next_user_... functions is useful only
 ...
 */
    ...
    {
        map_int_int_init_iterator (((MapIntInt const *)map)->it(), iter);
    }

    bool next (map_iterator_t &iter, int &k, int &v) const
    {
        return map_int_int_next_iteration (it(), &iter, &k, &v) != ERWIN_FALSE;
    }

    static void init_iterator_sorted_by_key (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_key (((MapIntInt const *)map)->it(), iter);
    }

    bool next_sorted (map_iterator_sorted_t &iter, int &k, int &v) const
    {
        return map_int_int_next_iteration_sorted (it(), &iter, &k, &v) != ERWIN_FALSE;
    }

    static void init_iterator_sorted_by_value (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_value (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_key_and_value (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_key_and_value (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_value_and_key (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_value_and_key (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_user (void const *map, map_iterator_sorted_t *iter, map_int_int_void_pair_cmp_t u)
    {
        map_int_int_init_iterator_sorted_by_user (((MapIntInt const *)map)->it(), iter, (map_int_int_pair_cmp_t)u);
    }

    bool next_user_sorted (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, int &k, int &v) const
    {
        return map_int_int_next_iteration_sorted (it(), &iter, &k, &v) != ERWIN_FALSE;
    }

    bool next_ptr (map_iterator_t &iter, int &k, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_ptr (it(), &iter, &k, &V) != ERWIN_FALSE;
    }

    static void init_iterator_ptr_sorted_by_key (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_key (((MapIntInt const *)map)->it(), iter);
    }

    bool next_sorted_ptr (map_iterator_sorted_t &iter, int &k, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_ptr (it(), &iter, &k, &V) != ERWIN_FALSE;
    }

    static void init_iterator_ptr_sorted_by_value (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_value (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_key_and_value (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_key_and_value (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_value_and_key (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_value_and_key (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_user (void const *map, map_iterator_sorted_t *iter, map_int_int_void_pair_cmp_t U)
    {
        map_int_int_init_iterator_ptr_sorted_by_user (((MapIntInt const *)map)->it(), iter, (map_int_int_pair_ptr_cmp_t)U);
    }

    bool next_user_sorted_ptr (map_iterator_sorted_t &iter, map_int_int_pair_ptr_cmp_t, int &k, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_ptr (it(), &iter, &k, &V) != ERWIN_FALSE;
    }
    ...
    {
        return map_int_int_next_iteration_keys (it(), &iter, &k) != ERWIN_FALSE;
    }

    bool next_sorted_key (map_iterator_sorted_t &iter, int &k) const
    {
        return map_int_int_next_iteration_sorted_keys (it(), &iter, &k) != ERWIN_FALSE;
    }

    bool next_user_sorted_key (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, int &k) const
    {
        return map_int_int_next_iteration_sorted_keys (it(), &iter, &k) != ERWIN_FALSE;
    }
    ...
    {
        return map_int_int_next_iteration_values (it(), &iter, &v) != ERWIN_FALSE;
    }

    bool next_sorted_value (map_iterator_sorted_t &iter, int &v) const
    {
        return map_int_int_next_iteration_sorted_values (it(), &iter, &v) != ERWIN_FALSE;
    }

    bool next_user_sorted_value (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, int &v) const
    {
        return map_int_int_next_iteration_sorted_values (it(), &iter, &v) != ERWIN_FALSE;
    }

    bool next_value_ptr (map_iterator_t &iter, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_values_ptr (it(), &iter, &V) != ERWIN_FALSE;
    }

    bool next_sorted_value_ptr (map_iterator_sorted_t &iter, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_values_ptr (it(), &iter, &V) != ERWIN_FALSE;
    }

    bool next_user_sorted_value_ptr (map_iterator_sorted_t &iter, map_int_int_pair_ptr_cmp_t, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_values_ptr (it(), &iter, &V) != ERWIN_FALSE;
    }

    bool next_pair (map_iterator_t &iter, map_int_int_pair_t &p) const
    {
        return map_int_int_next_iteration_pairs (it(), &iter, &p) != ERWIN_FALSE;
    }

    bool next_sorted_pair (map_iterator_sorted_t &iter, map_int_int_pair_t &p) const
    {
        return map_int_int_next_iteration_sorted_pairs (it(), &iter, &p) != ERWIN_FALSE;
    }

    bool next_user_sorted_pair (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, map_int_int_pair_t &p) const
    {
        return map_int_int_next_iteration_sorted_pairs (it(), &iter, &p) != ERWIN_FALSE;
    }

    bool next_pair_ptr (map_iterator_t &iter, map_int_int_pair_ptr_t &P) const
    {
        return map_int_int_next_iteration_pairs_ptr (it(), &iter, &P) != ERWIN_FALSE;
    }

    bool next_sorted_pair_ptr (map_iterator_sorted_t &iter, map_int_int_pair_ptr_t &P) const
    {
        return map_int_int_next_iteration_sorted_pairs_ptr (it(), &iter, &P) != ERWIN_FALSE;
    }

    bool next_user_sorted_pair_ptr (map_iterator_sorted_t &iter, map_int_int_pair_ptr_cmp_t, map_int_int_pair_ptr_t &P) const
    {
        return map_int_int_next_iteration_sorted_pairs_ptr (it(), &iter, &P) != ERWIN_FALSE;
    }
    ...
    {
        map_int_int_init_iterator_sorted_by_key_reverse (((MapIntInt const *)map)->it(), iter);
    }

    bool next_sorted_reverse (map_iterator_sorted_t &iter, int &k, int &v) const
    {
        return map_int_int_next_iteration_sorted_reverse (it(), &iter, &k, &v) != ERWIN_FALSE;
    }

    static void init_iterator_sorted_by_value_reverse (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_value_reverse (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_key_and_value_reverse (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_key_and_value_reverse (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_value_and_key_reverse (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_sorted_by_value_and_key_reverse (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_user_reverse (void const *map, map_iterator_sorted_t *iter, map_int_int_void_pair_cmp_t u)
    {
        map_int_int_init_iterator_sorted_by_user_reverse (((MapIntInt const *)map)->it(), iter, (map_int_int_pair_cmp_t)u);
    }

    bool next_user_sorted_reverse (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, int &k, int &v) const
    {
        return map_int_int_next_iteration_sorted_reverse (it(), &iter, &k, &v) != ERWIN_FALSE;
    }
    ...
    {
        map_int_int_init_iterator_ptr_sorted_by_key_reverse (((MapIntInt const *)map)->it(), iter);
    }

    bool next_sorted_ptr_reverse (map_iterator_sorted_t &iter, int &k, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_ptr_reverse (it(), &iter, &k, &V) != ERWIN_FALSE;
    }

    static void init_iterator_ptr_sorted_by_value_reverse (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_value_reverse (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_key_and_value_reverse (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_key_and_value_reverse (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_value_and_key_reverse (void const *map, map_iterator_sorted_t *iter)
    {
        map_int_int_init_iterator_ptr_sorted_by_value_and_key_reverse (((MapIntInt const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_user_reverse (void const *map, map_iterator_sorted_t *iter, map_int_int_void_pair_cmp_t U)
    {
        map_int_int_init_iterator_ptr_sorted_by_user_reverse (((MapIntInt const *)map)->it(), iter, (map_int_int_pair_ptr_cmp_t)U);
    }

    bool next_user_sorted_ptr_reverse (map_iterator_sorted_t &iter, map_int_int_pair_ptr_cmp_t, int &k, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_ptr_reverse (it(), &iter, &k, &V) != ERWIN_FALSE;
    }
    ...
    {
        return map_int_int_next_iteration_sorted_keys_reverse (it(), &iter, &k) != ERWIN_FALSE;
    }

    bool next_user_sorted_key_reverse (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, int &k) const
    {
        return map_int_int_next_iteration_sorted_keys_reverse (it(), &iter, &k) != ERWIN_FALSE;
    }
    ...
    {
        return map_int_int_next_iteration_sorted_values_reverse (it(), &iter, &v) != ERWIN_FALSE;
    }

    bool next_user_sorted_value_reverse (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, int &v) const
    {
        return map_int_int_next_iteration_sorted_values_reverse (it(), &iter, &v) != ERWIN_FALSE;
    }

    bool next_sorted_value_ptr_reverse (map_iterator_sorted_t &iter, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_values_ptr_reverse (it(), &iter, &V) != ERWIN_FALSE;
    }

    bool next_user_sorted_value_ptr_reverse (map_iterator_sorted_t &iter, map_int_int_pair_ptr_cmp_t, map_int_int_element_ptr_t &V) const
    {
        return map_int_int_next_iteration_sorted_values_ptr_reverse (it(), &iter, &V) != ERWIN_FALSE;
    }

    bool next_sorted_pair_reverse (map_iterator_sorted_t &iter, map_int_int_pair_t &p) const
    {
        return map_int_int_next_iteration_sorted_pairs_reverse (it(), &iter, &p) != ERWIN_FALSE;
    }

    bool next_user_sorted_pair_reverse (map_iterator_sorted_t &iter, map_int_int_pair_cmp_t, map_int_int_pair_t &p) const
    {
        return map_int_int_next_iteration_sorted_pairs_reverse (it(), &iter, &p) != ERWIN_FALSE;
    }

    bool next_sorted_pair_ptr_reverse (map_iterator_sorted_t &iter, map_int_int_pair_ptr_t &P) const
    {
        return map_int_int_next_iteration_sorted_pairs_ptr_reverse (it(), &iter, &P) != ERWIN_FALSE;
    }

    bool next_user_sorted_pair_ptr_reverse (map_iterator_sorted_t &iter, map_int_int_pair_ptr_cmp_t, map_int_int_pair_ptr_t &P) const
    {
        return map_int_int_next_iteration_sorted_pairs_ptr_reverse (it(), &iter, &P) != ERWIN_FALSE;
    }
...
extern "C++" {
ERWIN_WRAPPER
map_int_int_t *erwin_ptr_of(map_int_int_t *x) { return x;  }

ERWIN_WRAPPER
map_int_int_t *erwin_ptr_of(map_int_int_t &x) { return &x; }

ERWIN_WRAPPER
map_int_int_t const *erwin_ptr_const_of (map_int_int_t const *x) { return x;  }
...
/*
 * For the sorted iteration you must provide INT_CMP and INT_CMP resp.  Otherwise, you
 ...
 *    : ...
 *
 * It might be interesting to compare this to the C version map_int_int_forall.
 *
 ...
 * to arbitrarily modify (map_int_int_erase, map_int_int_insert, map_int_int_modify) the map while you
 ...
 * Use map_int_int_erase and map_int_int_insert for this.
 *
...
#   define map_forall_sorted_by_user(h,u,k,v) \
        for(map_iterator_sorted_t \
                ERWIN_GENSYM(erwin_local_i)(erwin_ptr_const_of(h)->init_iterator_sorted_by_user, \
                    (void const *)erwin_ptr_const_of(h), (map_int_int_void_pair_cmp_t)u); \
...
#   define map_forall_ptr_sorted_by_user(h,U,k,V) \
        for(map_iterator_sorted_t \
                ERWIN_GENSYM(erwin_local_i)(erwin_ptr_of(h)->init_iterator_ptr_sorted_by_user, \
                    (void const *)erwin_ptr_of(h), (map_int_int_void_pair_cmp_t)U); \
...
#endif /* !defined(ERWIN_MAP_INT_INT_h) */
