...
char const * const erwin_version=      "2.1.85983";
char const * const erwin_package_date= "Tue Apr 22 13:37:22 GMT 2008";
char const * const erwin_install_date= "Fri Jul 18 01:12:42 GMT 2008";
char const * const erwin_init_date=    "Tue Aug 19 15:43:59 GMT 2008";
int const erwin_version_1 = 1;
int const erwin_version_2 = 1;
ERWIN_BOOL erwin_assertion_is_fatal= ERWIN_TRUE;
ERWIN_BOOL erwin_initialised =       ERWIN_FALSE;

#define initialised erwin_initialised
...
int memory_cmp (void const *_a, void const *_b, size_t n)
{
...
int string_case_cmp (char const *a, char const *b)
{
    if (a == (char *)NULL) return b == (char*)NULL ? 0 : -1;
    if (b == (char *)NULL) return a == (char*)NULL ? 0 : 1;
...
#else
    while (*a && *b) {
        unsigned char al= char_to_lower (*a);
        unsigned char bl= char_to_lower (*b);
        if (al < bl) return -1;
        if (al > bl) return 1;
        a++;
        b++;
...
int string_n_cmp (char const *a, char const *b, size_t n)
{
    if (a == (char *)NULL) return b == (char*)NULL ? 0 : -1;
    if (b == (char *)NULL) return a == (char*)NULL ? 0 : 1;
#ifdef HAVE_STRNCMP
...
int string_n_case_cmp (char const *a, char const *b, size_t n)
{
    if (a == (char *)NULL) return b == (char*)NULL ? 0 : -1;
    if (b == (char *)NULL) return a == (char*)NULL ? 0 : 1;
...
char *string_string (char const *haystack, char const *needle)
{
#ifndef HAVE_STRSTR
    int n;
#endif
    ...
    n= erwin_strlen (needle);
    while (*haystack) {
        if (string_n_cmp (haystack, needle, n) == 0)
    ...
    void const *_haystack, size_t haycnt, void const *needle, size_t needlecnt)
{
        ...
        return ERWIN_CONST_CAST(void *,_haystack);
    {
        ...
        while (haycnt >= needlecnt) {
            if (memory_cmp ((void const *)haystack, needle, needlecnt) == 0)
...
char *string_case_string (char const *haystack, char const *needle)
{
    size_t n;
    if (haystack == NULL || needle == NULL)
        return NULL;
    n= erwin_strlen (needle);
    while (*haystack) {
        if (string_n_case_cmp (haystack, needle, n) == 0)
...
char *string_n_string (char const *haystack, char const *needle, size_t n)
{
    if (haystack == NULL || needle == NULL)
        return NULL;
    while (*haystack) {
...
char *string_n_case_string (char const *haystack, char const *needle, size_t n)
{
    if (haystack == NULL || needle == NULL)
        return NULL;
    while (*haystack) {
...
void *erwin_memset0 (void *p, size_t start, size_t end_plus_1)
{
...
size_t string_length (char const *c)
{
    if (c == NULL) return 0;
    return strlen (c);
}

size_t string_n_length (char const *c, size_t n)
{
    if (c == NULL) return 0;
#if 0
 ...
 */
char *string_dup (char const *c, int *err)
{
    char *result;
    if (NULL == c)
        return NULL;

    result= (char *)malloc (erwin_strlen(c)+1);
...
char *string_n_dup (char const *c, size_t n, int *err)
{
    char *result;
    size_t len;
    if (NULL == c)
...
char erwin_get_digit (int digit)
{
...
char erwin_get_digit_upper (int digit)
{
...
#define STRTOX(NAME2, NAME, NEG, TYPE)                                                       \
    TYPE erwin_##NAME (char const *c, size_t n, char **endptr, int options)           \
    {                                                                                        \
        TYPE result= 0;                                                                      \
        ERWIN_BOOL neg= 0;                                                            \
        int base= options & SO_BASE_MASK;                                             \
                                                                                             \
        ...
        if (base == 0) {                                                                     \
            ...
            if (n >= 1 && c[0] == '0') { base= 8; c++; n--; }                                \
                ...
                base= 10;                                                                    \
                                                                                             ...
                                                                                             \
        for (; n > 0; c++, n--) {                                                            \
            int digit= erwin_digit_value (*c);                                        \
            if (ERWIN_UNLIKELY(digit >= base)) {                                             \
                if (*c == '_' && !(options & SO_NO_UNDERBAR))                         \
                    continue;  /*!*/                                                         \
                else                                                                         \
                    break; /*!*/                                                             \
            }                                                                                \
    ...
    TYPE erwin_##NAME2 (char const *c, char **endptr, int options)                    \
    {                                                                                        \
        return erwin_##NAME (c, erwin_strlen (c), endptr, options);            \
    }
...
ERWIN_BOOL char_is_alpha (char c)
{
#ifdef HAVE_ISALPHA
#ifdef BROKEN_CTYPE
    return ERWIN_TO_BOOL (((unsigned char)c) <= 127 && isalpha (((unsigned char)c)));
#else
    return ERWIN_TO_BOOL (isalpha (((unsigned char)c)));
...
ERWIN_BOOL char_is_upper (char c)
{
#ifdef HAVE_ISUPPER
#ifdef BROKEN_CTYPE
    return ERWIN_TO_BOOL (((unsigned char)c) <= 127 && isupper (((unsigned char)c)));
#else
    return ERWIN_TO_BOOL (isupper (((unsigned char)c)));
           /* e.g. Solaris 5.8 generates warning if cast is left out */
#endif
#else
    switch (c) {
...
ERWIN_BOOL char_is_lower (char c)
{
#ifdef HAVE_ISLOWER
#ifdef BROKEN_CTYPE
    return ERWIN_TO_BOOL (((unsigned char)c) <= 127 && islower (((unsigned char)c)));
#else
    return ERWIN_TO_BOOL (islower (((unsigned char)c)));
           /* e.g. Solaris 5.8 generates warning if cast is left out */
#endif
#else
    switch (c) {
...
ERWIN_BOOL char_is_digit (char c)
{
#ifdef HAVE_ISDIGIT
#ifdef BROKEN_CTYPE
    return ERWIN_TO_BOOL (((unsigned char)c) <= 127 && isdigit (((unsigned char)c)));
#else
    return ERWIN_TO_BOOL (isdigit (((unsigned char)c)));
           /* e.g. Solaris 5.8 generates warning if cast is left out */
#endif
#else
    switch (c) {
...
ERWIN_BOOL char_is_xdigit (char c)
{
#ifdef HAVE_ISXDIGIT
#ifdef BROKEN_CTYPE
    return ERWIN_TO_BOOL (((unsigned char)c) <= 127 && isxdigit (((unsigned char)c)));
#else
    return ERWIN_TO_BOOL (isxdigit (((unsigned char)c)));
           /* e.g. Solaris 5.8 generates warning if cast is left out */
#endif
#else
    switch (c) {
...
ERWIN_BOOL char_is_space (char c)
{
#ifdef HAVE_ISSPACE
#ifdef BROKEN_CTYPE
    return ERWIN_TO_BOOL (((unsigned char)c) <= 127 && isspace (((unsigned char)c)));
#else
    return ERWIN_TO_BOOL (isspace (((unsigned char)c)));
           /* e.g. Solaris 5.8 generates warning if cast is left out */
#endif
#else
    switch (c) {
        ...
        case '\n':
        case '\r':
        case '\v': return ERWIN_TRUE;
        default:   return ERWIN_FALSE;
    }
#endif
}

ERWIN_BOOL char_is_cr (char c)
{
    return ERWIN_TO_BOOL (c == '\n' || c=='\r');
}

ERWIN_BOOL char_is_space0 (char c)
{
    return ERWIN_TO_BOOL (c == '\0' || char_is_space (c));
}

ERWIN_BOOL char_is_cr0 (char c)
{
    return ERWIN_TO_BOOL (c == '\0' || char_is_cr (c));
}

ERWIN_BOOL string_is_prefix (
    int *needle_length_p, char const *haystack, char const *needle)
{
    int n= erwin_strlen (needle);
    if (needle_length_p != NULL)
        *needle_length_p= n;
    return erwin_strncmp (haystack, needle, n) == 0;
}

ERWIN_BOOL string_is_suffix (
    int *needle_length_p, char const *haystack, char const *needle)
{
    int s= erwin_strlen (haystack);
    int n= erwin_strlen (needle);
    if (needle_length_p != NULL)
        *needle_length_p= n;
    return s >= n &&
           erwin_strncmp (haystack + s - n, needle, n) == 0;
}

char const *erwin_strsignal (int x)
{
#if defined(NSIG)
...
static ERWIN_BOOL internal_erwin_require_determinism= ERWIN_TRUE;
static ERWIN_BOOL internal_erwin_init_determinism= ERWIN_TRUE;

void erwin_set_determinism (ERWIN_BOOL bol)
{
...
#else
        ERWIN_ERROR_PRINT (ERWIN_ERROR_STREAM,
...
ERWIN_BOOL erwin_require_determinism (void)
{
...
unsigned long erwin_det_random (void)
{
...
static
TYPE_ENUM_T(ERWIN_BOOL)=
    TYPE_ENUM_BEGIN(ERWIN_BOOL)
    TYPE_ENUM_VALUE(ERWIN_BOOL, ERWIN_FALSE)
    TYPE_ENUM_VALUE(ERWIN_BOOL, ERWIN_TRUE)
    TYPE_ENUM_END
;
TYPE_INFO_T(ERWIN_BOOL)= TYPE_INFO_ENUM(ERWIN_BOOL, ERWIN_BOOL);
...
TYPE_ENUM_T(bool)=
    ...
    TYPE_ENUM_END
;
TYPE_INFO_T(erwininternalbool)= TYPE_INFO_ENUM(bool, bool);
#endif

#ifdef __CHAR_UNSIGNED__
TYPE_INFO_T(erwininternalchar)= TYPE_INFO_UINT(char);
#else
TYPE_INFO_T(erwininternalchar)= TYPE_INFO_SINT(char);
#endif

TYPE_INFO_T(erwininternalunsigned_char)=  TYPE_INFO_UINT(unsigned char);
TYPE_INFO_T(erwininternalsigned_char)=    TYPE_INFO_SINT(signed char);

TYPE_INFO_T(erwininternalint)=            TYPE_INFO_SINT(int);
TYPE_INFO_T(erwininternalunsigned)=       TYPE_INFO_UINT(unsigned);

TYPE_INFO_T(erwininternalshort)=          TYPE_INFO_SINT(short);
TYPE_INFO_T(erwininternalunsigned_short)= TYPE_INFO_UINT(unsigned short);

TYPE_INFO_T(erwininternallong)=           TYPE_INFO_SINT(long);
TYPE_INFO_T(erwininternalunsigned_long)=  TYPE_INFO_UINT(unsigned long);

#ifdef ERWIN_LONG_LONG
TYPE_INFO_T(erwininternalERWIN_LONG_LONG)=         TYPE_INFO_SINT(ERWIN_LONG_LONG);
TYPE_INFO_T(erwininternalERWIN_UNSIGNED_LONG_LONG)=TYPE_INFO_UINT(ERWIN_UNSIGNED_LONG_LONG);
#endif

TYPE_INFO_T(erwininternalsize_t)=         TYPE_INFO_UINT(size_t);

TYPE_INFO_T(erwininternalvoid)=           TYPE_INFO_VOID(void);

TYPE_INFO_T(erwininternalfloat)=          TYPE_INFO_SINT(float);
TYPE_INFO_T(erwininternaldouble)=         TYPE_INFO_SINT(double);

TYPE_INFO_T(erwininternalchar_string)=    TYPE_INFO_STRING(char, char);

TYPE_INFO_T(erwininternalchar_p)=         TYPE_INFO_POINTER(char *, char_string);
TYPE_INFO_T(erwininternalchar_const_p)=   TYPE_INFO_POINTER(char const *, char_string);

TYPE_INFO_T(erwininternalvoid_p)=         TYPE_INFO_POINTER(void *, void);
TYPE_INFO_T(erwininternalvoid_const_p)=   TYPE_INFO_POINTER(void const *, void);


#if defined(erwin_kind_t_defined)

char const *erwin_kind_to_string (erwin_kind_t a)
{
    switch (a) {
    case KIND_VOID:     return "void";
    case KIND_SINT:     return "signed integer";
    case KIND_UINT:     return "unsigned integer";
    case KIND_ENUM:     return "enums";
    ...
    case KIND_REF:      return "reference";
    case KIND_STRING:   return "0-string";
...
#endif /*ERWIN_TYPE_INFO && !defined(TYPE_INFO_T) */
