...
ERWIN_THREAD_LOCAL
int erwininternalvectorerrno= ERWININTERNALVECTOROK;
...
int *erwininternalvectorerrnoptr(void)
{
    int *errno_ptr;
    ...
    if (ERWIN_UNLIKELY(!errno_ptr)) {
        ...
        *errno_ptr= ERWININTERNALVECTOROK;
...
char const *erwininternalvectorstrerror (int i)
{
    switch (i) {
        case ERWININTERNALVECTOROK:
            return "No error";

        case ERWININTERNALVECTORERRNOMEM:
            return "Error: Memory exhausted";

        case ERWININTERNALVECTORERROUTOFRANGE:
            return "Error: Index out of range";

        case ERWININTERNALVECTORERRASSERTIONFAILED:
            return "Error: Assertion failed";

        case ERWININTERNALVECTORERRNOTCOMPILED:
            return "Error: Feature disabled at compile time";

        case ERWININTERNALVECTORERRIO:
            return "Error: Input/output error";

        case ERWININTERNALVECTORWARNOUTOFRANGE:
            return "Warning: Index out of range";

        case ERWININTERNALVECTORWARNEMPTY:
