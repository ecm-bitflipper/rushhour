...
#warning "Including err_map_int_char_p.h"
#endif

#ifndef ERWIN_ERR_MAP_INT_CHAR_P_h
#define ERWIN_ERR_MAP_INT_CHAR_P_h

#ifdef ERWIN_DEBUG_INCLUDE
#warning "First inclusion of err_map_int_char_p.h"
#endif
...
#include "error/err_map_int_char_p_d.h"
...
typedef int err_map_int_char_p_index_t;
typedef char * err_map_int_char_p_value_t;

typedef struct _err_map_int_char_p_pair_t {
    int key;
    char * value;
} err_map_int_char_p_pair_t;

typedef err_map_int_char_p_pair_t err_map_int_char_p_pair_dynarray;


typedef struct _err_map_int_char_p_pair_ptr_t {
    int key;
    char * *value;
} err_map_int_char_p_pair_ptr_t;


typedef err_map_int_char_p_pair_ptr_t err_map_int_char_p_pair_ptr_dynarray;

typedef int (*err_map_int_char_p_pair_cmp_t)(err_map_int_char_p_pair_t const *, err_map_int_char_p_pair_t const *);

typedef int (*err_map_int_char_p_pair_ptr_cmp_t)(err_map_int_char_p_pair_ptr_t const *, err_map_int_char_p_pair_ptr_t const *);

typedef int (*err_map_int_char_p_void_pair_cmp_t)(void const *, void const *);



typedef ERR_ERWIN_BOOL (*err_map_int_char_p_feature_t)(int , char * );


typedef char * *err_map_int_char_p_element_ptr_t;



typedef int err_map_int_char_p_key_result_t;
...
typedef struct _err_map_iterator_t {
     ...
     * manually.  err_map_int_char_p iteration looks like this:
     *     : err_map_iterator_t iter;
     *     : ...
     *     : err_map_int_char_p_forall (map, iter, key, value) {
     *     :     ...
     *     : }
     *
...
/*--BEGIN-C--*/
ERR_ERWIN_EXPORT
err_map_int_char_p_t *err_map_int_char_p_new (void) ATTR_MALLOC;
  /* Return a new map with default settings.  I.e., with the
   * default zero element ERR_MAP_INT_CHAR_P_ZERO and the default initial hash table
   * size of ERR_MAP_INT_CHAR_P_INITIAL_SIZE.
   *
   * \errno(OK, ERR_NOMEM)
   */

ERR_ERWIN_EXPORT
err_map_int_char_p_t *err_map_int_char_p_new_with_initial_size (int /*initial_size*/) ATTR_MALLOC;
   ...
   *
   * If initial_size < 0 the default size ERR_MAP_INT_CHAR_P_INITIAL_SIZE will be used.
   * If initial_size == 0 but ERR_MAP_INT_CHAR_P_MINIMAL_SIZE > 0, a size of 1 will be
   * used.
   *
   ...
   * ERR_MAP_INT_CHAR_P_TRIGGER_NUMERATOR * 80 / ERR_MAP_INT_CHAR_P_TRIGGER_DENOMINATOR.
   *
   * \errno(OK, ERR_NOMEM)
   */

#if ERR_MAP_INT_CHAR_P_DYN_ZERO
ERR_ERWIN_EXPORT
err_map_int_char_p_t *err_map_int_char_p_new_with_zero (char *  /*zero*/) ATTR_MALLOC;
...
ERR_ERWIN_EXPORT
err_map_int_char_p_t *err_map_int_char_p_new_with_zero_and_initial_size (char *  /*zero*/, int /*initial_size*/) ATTR_MALLOC;
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_init (
    err_map_int_char_p_t * /*self*/) ATTR_NONNULL((1));
  /*
   * This is for initialising non-heap err_map_int_char_p_t objects.
   *
...
#if ERR_MAP_INT_CHAR_P_DYN_ZERO
ERR_ERWIN_EXPORT
int err_map_int_char_p_init_with_zero_and_initial_size (
    err_map_int_char_p_t *      /*self*/,
    char *  /*zero*/,
    int          /*initial_size*/) ATTR_NONNULL((1));
  /*
   * This is for initialising non-heap err_map_int_char_p_t objects that are allocated
   * manually (thus, not via err_map_int_char_p_new).
   *
   * Invoking this function manually is usually discouraged.  It is thought
   * to be for nesting data structures.  However, if you need to optimise
   * heap usage, it is ok to use this function.
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_init_with_initial_size (
    err_map_int_char_p_t * /*self*/,
    int     /*initial_size*/) ATTR_NONNULL((1));
  /*
   * This is for initialising non-heap err_map_int_char_p_t objects.
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_destroy (err_map_int_char_p_t * /*self*/);
  /*
   * This is for deleting non-heap err_map_int_char_p_t objects.
   *
   * Invoking this function manually is usually discouraged.  It is thought
   * to be for nesting data structures.  However, if you need to optimise
   * heap usage, it is ok to use this function.
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_xchg (err_map_int_char_p_t * /*self*/, err_map_int_char_p_t * /*other*/);
  /*
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_destroy_flags (
  err_map_int_char_p_t * /*self*/, ERR_ERWIN_BOOL /* destroy_keys */, ERR_ERWIN_BOOL /* destroy_values */);
  /*
   * Same as err_map_int_char_p_destroy with the possiblity to determine what to destroy.
   *
   * Invoking this function manually is usually discouraged.  It is thought
   * to be for nesting data structures.  However, if you need to optimise
   * heap usage, it is ok to use this function.
...
#if !ERR_ERWIN_GLOBAL_ERRNO
ERR_ERWIN_EXPORT
int err_map_int_char_p_errno(err_map_int_char_p_t const *) ATTR_PURE ATTR_NONNULL((1));
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_clear_errno(err_map_int_char_p_t const *) ATTR_NONNULL((1));
...
#define err_map_int_char_p_errno(X)          err_map_errno
  /* If the library was not compiled with ERR_ERWIN_THREAD_SAFE, err_map_int_char_p_errno(X)
...
#define err_map_int_char_p_clear_errno(X)    ((void)(err_map_errno= ERR_MAP_OK))
  /* If the library was not compiled with ERR_ERWIN_THREAD_SAFE, err_map_int_char_p_clear_errno(X)
...
ERR_ERWIN_EXPORT
err_map_int_char_p_t *err_map_int_char_p_copy (err_map_int_char_p_t const* /*self*/);
...
ERR_ERWIN_EXPORT
err_map_int_char_p_t *err_map_int_char_p_copy_err (err_map_int_char_p_t const* /*self*/, int *err);
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_delete (err_map_int_char_p_t* /*self*/);
...
ERR_ERWIN_EXPORT
void   err_map_int_char_p_delete_flags (err_map_int_char_p_t* /* self*/, ERR_ERWIN_BOOL /* destroy_keys */, ERR_ERWIN_BOOL /* destroy_values */);
  /* Deletes only the map structure, not the entries.  This is
   * useful if you got the entries via err_map_int_char_p_get_{values|keys}.
   * err_map_int_char_p_delete_flat (a, true, true) is the same as
   * err_map_int_char_p_delete (a);
   *
   * \errno(OK)
   */
 ...
 * easily possible. */
ERR_ERWIN_EXPORT
int err_map_int_char_p_insert (err_map_int_char_p_t* /*self*/, int  /*key*/, char *  /*value*/) ATTR_NONNULL((1));
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_insert_map (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
...
ERR_ERWIN_EXPORT
int  err_map_int_char_p_ensure (err_map_int_char_p_t* /*self*/, int  /*key*/) ATTR_NONNULL((1));
   ...
   * want to change this, re-define ERR_MAP_INT_CHAR_P_ENSURE_VALUE.
...
ERR_ERWIN_EXPORT
int  err_map_int_char_p_ensure_no_icopy (err_map_int_char_p_t * /*self*/, int  /*key*/) ATTR_NONNULL((1));
  /* This is like err_map_int_char_p_ensure(), but the input key will be stolen or freed, i.e.,
   * it will be used as a copy inside the hash table, instead of being copied
   * as in err_map_int_char_p_ensure.  If the key already exists, the key passed will be freed.
   *
   * Note: This function implements symbol tables.
   *
   * This could be called err_map_int_char_p_ensure_steal(), but we already have poke_no_icopy().
   *
   * \errno(OK, WARN_EXISTINGKEY, REHASH_*, ERR_NOMEM)
   */

ERR_ERWIN_EXPORT
char *  err_map_int_char_p_find_any (err_map_int_char_p_t const* /*self*/)
  ATTR_ERRNO_PURE;
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_find_any_pair (err_map_int_char_p_key_result_t *, err_map_int_char_p_element_ptr_t *, err_map_int_char_p_t const* /*self*/)
  ATTR_ERRNO_PURE;
   ...
   * the return value.
   *
   * See err_map_int_char_p_find_any() for more documentation.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */
...
ERR_ERWIN_EXPORT
char *   err_map_int_char_p_find (err_map_int_char_p_t const* /*self*/, int  /*index*/)
  ATTR_ERRNO_PURE;
  /* Returns the found element or the zero element if not found.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
...
ERR_ERWIN_EXPORT
char *  err_map_int_char_p_find_ensure (err_map_int_char_p_t * /*self*/, int  /*index*/);
  /* Returns the found element or introduces an empty element into the
   * map and returns that (use ERR_MAP_INT_CHAR_P_ENSURE_VALUE to determine the value
   * that is introduced).
   *
   * Also consider find_ptr_ensure if you want to modify the (newly
   * introduced) value.  Also see err_map_int_char_p_ensure if you need the key, not
...
ERR_ERWIN_EXPORT
int   err_map_int_char_p_find_key (err_map_int_char_p_t const* /*self*/, int  /*index*/) ATTR_ERRNO_PURE;
...
ERR_ERWIN_EXPORT
int   err_map_int_char_p_find_any_key (err_map_int_char_p_t const* /*self*/) ATTR_ERRNO_PURE;
  /* Returns some key that is stored in the table.
   *
   * See err_map_int_char_p_find_any() for docu.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */
...
ERR_ERWIN_EXPORT
err_map_int_char_p_element_ptr_t err_map_int_char_p_find_ptr (err_map_int_char_p_t const* /*self*/, int  /*index*/) ATTR_ERRNO_PURE;
...
ERR_ERWIN_EXPORT
err_map_int_char_p_element_ptr_t err_map_int_char_p_find_any_ptr (err_map_int_char_p_t const* /*self*/) ATTR_ERRNO_PURE;
...
ERR_ERWIN_EXPORT
err_map_int_char_p_element_ptr_t err_map_int_char_p_find_ptr_ensure (err_map_int_char_p_t * /*self*/, int  /*index*/);
...
ERR_ERWIN_EXPORT
char * err_map_int_char_p_modify (
    err_map_int_char_p_t* /*self*/, int  /*index*/, char *  /*value*/) ATTR_NONNULL((1));
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_modify_map (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* like err_map_int_char_p_modify on all entries in other.  If any key was not found,
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_set (err_map_int_char_p_t* /*self*/, int  /*index*/, char *  /*value*/) ATTR_NONNULL((1));
   ...
   *
   * Similar to err_map_int_char_p_modify, but value is freed and the status instead of the value
   * is returned.   Furthermore, of course, it is different in that if the value
   * does not exist, it will be inserted.
   *
   * Note: If you don't care whether to use err_map_int_char_p_set or err_map_int_char_p_insert, use err_map_int_char_p_insert.
   *       err_map_int_char_p_insert might be a little faster.
   *
   * Result:
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_set_map (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* like err_map_int_char_p_set on all entries in other
   *
   * \errno(OK, REHASH_*, ERR_NOMEM)
   */
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_intersect (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* Implements set intersection: this invokes err_map_int_char_p_erase on all entries
   * in self that are not in other.
   * Returns the number of erased elements (quite like err_map_int_char_p_erase_if).
   *
   * \errno(OK, REHASH_*, ERR_NOMEM)
   */

ERR_ERWIN_EXPORT
int err_map_int_char_p_intersect_no_resize (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* Like err_map_int_char_p_intersect, but does not shrink the internal hash table.
   *
   * \errno(OK, REHASH_*, ERR_NOMEM)
   */

ERR_ERWIN_EXPORT
char * err_map_int_char_p_remove (err_map_int_char_p_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
...
ERR_ERWIN_EXPORT
char * err_map_int_char_p_remove_no_resize (err_map_int_char_p_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
  /* Like err_map_int_char_p_remove, but does not shrink the internal hash table.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */

ERR_ERWIN_EXPORT
int err_map_int_char_p_remove_map (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* like err_map_int_char_p_remove on all entries in other.  If any key was not found,
   * WARN_KEYNOTFOUND is returned.
   *
   * \errno(OK, WARN_KEYNOTFOUND, REHASH_*)
   */
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_remove_if (err_map_int_char_p_t * /*self */, err_map_int_char_p_feature_t /* feature */, ERR_ERWIN_BOOL /* value */);
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_erase (err_map_int_char_p_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
  /* Same as err_map_int_char_p_remove, but value is freed.  In error-free operation, returns
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_erase_no_resize (err_map_int_char_p_t* /*self*/, int  /*index*/) ATTR_NONNULL((1));
  /* Same as err_map_int_char_p_erase, but does not shrink the internal hash table.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */

ERR_ERWIN_EXPORT
int err_map_int_char_p_erase_map (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* like err_map_int_char_p_erase on all entries in other.  If any key was not found,
   * WARN_KEYNOTFOUND is returned.
   *
   * \errno(OK, WARN_KEYNOTFOUND, REHASH_*)
   */
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_erase_map_no_resize (err_map_int_char_p_t* /*self*/, err_map_int_char_p_t const * /* other */);
  /* Like err_map_int_char_p_erase_map, but does not shrink the internal hash table.
   *
   * \errno(OK, WARN_KEYNOTFOUND)
   */

ERR_ERWIN_EXPORT
int err_map_int_char_p_erase_if (err_map_int_char_p_t * /*self */, err_map_int_char_p_feature_t /* feature */, ERR_ERWIN_BOOL /* value */);
...
int err_map_int_char_p_poke (
  ...
  /* This is the generalised interface to err_map_int_char_p_insert, err_map_int_char_p_modify, err_map_int_char_p_set, err_map_int_char_p_ensure, err_map_int_char_p_find
   * and err_map_int_char_p_find_key.  This function cannot erase, however (see err_map_int_char_p_erase).
   *
   * Input parameters:
   *   +--------------+----------------------------------------------------------------------+
   ...
   *
   * err_map_int_char_p_insert:
   *       : return err_map_int_char_p_poke (NULL, NULL, self, key, value,
   *       :                  ERR_ERWIN_TRUE, ERR_ERWIN_FALSE);
   *
   * err_map_int_char_p_set:
   *       : return err_map_int_char_p_poke (NULL, NULL, self, key, value,
   *       :                 ERR_ERWIN_TRUE, ERR_ERWIN_TRUE);
   *
   * err_map_int_char_p_modify:
   *       : char * *result;
   *       : err_map_int_char_p_poke (NULL, &result, self, key, value,
   *       :           ERR_ERWIN_FALSE, ERR_ERWIN_TRUE);
   *       : return result;
   *
   * err_map_int_char_p_find:
   *       : char * *result;
   *       : err_map_int_char_p_poke (NULL, &result, self, key, ZERO (char *),
   *       :           ERR_ERWIN_FALSE, ERR_ERWIN_FALSE);
   *       : return (char **)result;
   *
   * err_map_int_char_p_find_key:
   *       : int *result;
   *       : err_map_int_char_p_poke (&result, NULL, self, key, ZERO (char *),
   *       :           ERR_ERWIN_FALSE, ERR_ERWIN_FALSE);
   *       : return (int*)result;
   *
   * Almost:
   * err_map_int_char_p_ensure:
   *       : int *result;
   *       : err_map_int_char_p_poke (&result, NULL, self, key, ZERO (char *),
   *       :           ERR_ERWIN_TRUE, ERR_ERWIN_FALSE);
   *       : result;
   * (Only err_map_int_char_p_ensure uses ERR_MAP_INT_CHAR_P_ENSURE_VALUE to introduce a new element, not
   * ZERO and without copying)
   *
   * Note that err_map_int_char_p_find_ptr, err_map_int_char_p_remove and err_map_int_char_p_erase cannot be implemented with
   * this function.
   *
   * Return Values:
   *    - ERR_MAP_OK:
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_poke_no_icopy (
   int * /*key_out*/,
   char * * /*value_out*/,
   err_map_int_char_p_t * /*self*/,
   int  /*key*/,
   ...
   ERR_ERWIN_BOOL /*introduce*/,
   ERR_ERWIN_BOOL /*overwrite*/) ATTR_NONNULL((3));
  /* Like err_map_int_char_p_poke, but the key is not copied.  However, \p key will be freed if it is not
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_poke_no_ocopy (
  int * /*key_out*/,
  char * * /*value_out*/,
  err_map_int_char_p_t * /*self*/,
  int  /*key*/,
  ...
  ERR_ERWIN_BOOL /*introduce*/,
  ERR_ERWIN_BOOL /*overwrite*/) ATTR_NONNULL((3));
  /* Like err_map_int_char_p_poke, but the value is not copied.  However, value may be freed if
   * value_out is NULL.  The rules for copying and freeing values are the same as
   * for key with err_map_int_char_p_poke_no_icopy.
   */

ERR_ERWIN_EXPORT
int err_map_int_char_p_poke_no_icopy_no_ocopy (
  int * /*key_out*/,
  char * * /*value_out*/,
  err_map_int_char_p_t * /*self*/,
  int  /*key*/,
  ...
  ERR_ERWIN_BOOL /*introduce*/,
  ERR_ERWIN_BOOL /*overwrite*/) ATTR_NONNULL((3));
  /* Like err_map_int_char_p_poke, but neither the key nor the value are copied.  Both, key and value
   * may be freed.  The rules for copying and freeing keys and values are the same
   * as for err_map_int_char_p_poke_no_icopy and err_map_int_char_p_poke_no_ocopy.
   */

ERR_ERWIN_EXPORT
char *  err_map_int_char_p_zero (err_map_int_char_p_t const* /*self*/) ATTR_PURE ATTR_NONNULL((1));
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_cmp (err_map_int_char_p_t const* /*self*/, err_map_int_char_p_t const * /*other */) ATTR_ERRNO_PURE;
   ...
   *
   * For equality tests, use err_map_int_char_p_equal instead, which is faster.
   *
   ...
   *    ERR_INT_CMP or ERR_CHAR_P_CMP is not defined.
   *
   * \errno(OK, ERR_NOMEM)
   */

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_equal (err_map_int_char_p_t const* /*self*/, err_map_int_char_p_t const * /*other */) ATTR_ERRNO_PURE;
...
ERR_ERWIN_EXPORT
int err_map_int_char_p_cmp_keys (err_map_int_char_p_t const* /*self*/, err_map_int_char_p_t const * /*other */) ATTR_ERRNO_PURE;
...
ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_equal_keys (err_map_int_char_p_t const* /*self*/, err_map_int_char_p_t const * /*other */) ATTR_ERRNO_PURE;
  /* Returns whether the set of keys in the map is equal.
   *
   * Note: This operation is quite expensive but less expensive than
   *                err_map_int_char_p_keys_cmp
   *
   * \errno(OK)
   */

ERR_ERWIN_EXPORT
err_hashval_t err_map_int_char_p_hash_raw (err_map_int_char_p_t const * /*self*/) ATTR_ERRNO_PURE;
  /* Calculates a hash value for this hash table.  In earlier versions of Erwin,
   * the result was inferior to that of err_map_int_char_p_hash, but they are now the same
...
ERWIN_WRAPPER err_hashval_t err_map_int_char_p_hash (err_map_int_char_p_t const *) ATTR_ERRNO_PURE;
    /* Same as err_map_int_char_p_hash_raw() now that hash_raw() is good enough. */

ERWIN_WRAPPER err_hashval_t err_map_int_char_p_hash (err_map_int_char_p_t const *x)
{
    return err_map_int_char_p_hash_raw(x);
}


/* ***** access to all entries: ***** */
ERR_ERWIN_EXPORT
void err_map_int_char_p_clear (err_map_int_char_p_t* /*self*/);
   /* Like err_map_int_char_p_erase for all elements
    *
    * \errno(OK)
    */

ERR_ERWIN_EXPORT
void err_map_int_char_p_clear_no_resize (err_map_int_char_p_t* /*self*/);
   /* Like err_map_int_char_p_erase for all elements, but does not shrink the internal hash table.
    *
    * \errno(OK)
    */

ERR_ERWIN_EXPORT
void err_map_int_char_p_clear_flags (
    err_map_int_char_p_t* /*self*/,
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_clear_flags_no_resize (
    err_map_int_char_p_t* /*self*/,
    ERR_ERWIN_BOOL     /*destroy_keys*/,
    ERR_ERWIN_BOOL     /*destroy_values*/);
   /* Like err_map_int_char_p_clear_flags, but does not shrink the internal hash table.
    *
    * \errno(OK)
    */

ERR_ERWIN_EXPORT
int err_map_int_char_p_nentries (err_map_int_char_p_t const* /*self*/) ATTR_PURE;
...
ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_empty (err_map_int_char_p_t const* /*self*/) ATTR_PURE;
...
ERR_ERWIN_EXPORT
err_map_int_char_p_pair_t *err_map_int_char_p_get_entries (err_map_int_char_p_t const* /*self*/) ATTR_MALLOC;
   /* Use err_map_int_char_p_delete_entries to deallocate the returned array.
    *
    * \errno(OK, ERR_NOMEM)
    */

ERR_ERWIN_EXPORT
void err_map_int_char_p_delete_entries (err_map_int_char_p_pair_t * /*entries*/);
   /* Deallocate keys obtained by err_map_int_char_p_get_entries(). */


ERR_ERWIN_EXPORT
err_map_int_char_p_pair_ptr_t *err_map_int_char_p_get_entries_ptr (err_map_int_char_p_t const* /*self*/) ATTR_MALLOC;
   /* Usp err_map_int_char_p_delete_entries_ptr to deallocate the returned array.
    *
    * \errno(OK, ERR_NOMEM) */

ERR_ERWIN_EXPORT
void err_map_int_char_p_delete_entries_ptr (err_map_int_char_p_pair_ptr_t * /*entries_ptr*/);
   /* Deallocate keys obtained by err_map_int_char_p_get_entries_ptr(). */

ERR_ERWIN_EXPORT
char * *err_map_int_char_p_get_values (err_map_int_char_p_t const* /*self*/) ATTR_MALLOC;
   /* \errno(OK, ERR_NOMEM) */

ERR_ERWIN_EXPORT
void err_map_int_char_p_delete_values (char * * /*values*/);
   /* Deallocate keys obtained by err_map_int_char_p_get_values(). */

ERR_ERWIN_EXPORT
int *err_map_int_char_p_get_keys   (err_map_int_char_p_t const* /*self*/) ATTR_MALLOC;
    ...
    *       freed by the user using err_map_int_char_p_delete_keys().  In earlier versions
    *       of Erwin, free() was recommended for freeing, but due to more
    *       sophisticated memory management, err_map_int_char_p_delete_keys() is the
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_delete_keys (int * /*keys*/);
   /* Deallocate keys obtained by err_map_int_char_p_get_keys(). */


/* ***** debugging and special purposes (use rarely!): ***** */
ERR_ERWIN_EXPORT
int err_map_int_char_p_hash_size (err_map_int_char_p_t const* /*self*/) ATTR_PURE;
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_rehash (err_map_int_char_p_t* /*self*/, int /*newsize*/);
...
ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_expect_size (err_map_int_char_p_t* /*self*/, int /*newsize*/);
...
ERR_ERWIN_EXPORT
double err_map_int_char_p_average_line_length (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
double err_map_int_char_p_variance_line_length (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

#ifdef HAVE_SQRT
ERR_ERWIN_EXPORT
double err_map_int_char_p_deviation_line_length (err_map_int_char_p_t const* /*self*/) ATTR_PURE;
#endif

ERR_ERWIN_EXPORT
int err_map_int_char_p_max_line_length (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
int err_map_int_char_p_min_line_length (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
void err_map_int_char_p_dump (FILE *, err_map_int_char_p_t const * /*self*/);
  /* Dumps the internal structure of the map to the given file. */

/* ***** iteration: ***** */
/* New approach: */
#define err_map_int_char_p_forall_nondet(h,i,k,v) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration ((h),&i,&k,&v);)
 ...
 * using this.  See err_map_int_char_p_forall for details.
 */

#define err_map_int_char_p_forall_ptr_nondet(h,i,k,v) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration_ptr ((h),&i,&k,&v);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERR_ERWIN_REQUIRE_DETERMINISM is #defined.
 *
 * This iterates over keys and pointers to values.  You need a map_iterator_t as a
 * temporary for using this.  See err_map_int_char_p_forall for details.  Iterating over pointers
 * allows you to change entries in the table on the fly.
 */

#define err_map_int_char_p_forall_values_nondet(h,i,v) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration_values ((h),&i,&v);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERR_ERWIN_REQUIRE_DETERMINISM is #defined.
 *
...
#define err_map_int_char_p_forall_values_ptr_nondet(h,i,v) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration_values_ptr ((h),&i,&v);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERR_ERWIN_REQUIRE_DETERMINISM is #defined.
 *
 * This iterates over values only.  You need a map_iterator_t as a temporary for
 * using this.  See err_map_int_char_p_forall for details.  Iterating over pointers
 * allows you to change entries in the table on the fly.
 */

#define err_map_int_char_p_forall_keys_nondet(h,i,k) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration_keys ((h),&i,&k);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERR_ERWIN_REQUIRE_DETERMINISM is #defined.
 *
...
#define err_map_int_char_p_forall_pairs_nondet(h,i,p) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration_pairs ((h),&i,&p);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERR_ERWIN_REQUIRE_DETERMINISM is #defined.
 *
...
#define err_map_int_char_p_forall_pairs_ptr_nondet(h,i,p) \
        for(err_map_int_char_p_init_iterator ((h),&i); \
            err_map_int_char_p_next_iteration_pairs_ptr ((h),&i,&p);)
/* Operator for non-deterministic hash iteration.  This is non-deterministic even if
 * ERR_ERWIN_REQUIRE_DETERMINISM is #defined.
 *
 * This iterates over key/value pairs.  You need a map_iterator_t as a temporary for
...
#  define err_map_int_char_p_forall(h,i,k,v) err_map_int_char_p_forall_nondet(h,i,k,v)
...
#  define err_map_int_char_p_forall_ptr(h,i,k,v) err_map_int_char_p_forall_ptr_nondet(h,i,k,v)
...
#  define err_map_int_char_p_forall_values(h,i,v) err_map_int_char_p_forall_values_nondet(h,i,v)
/* Works similar to map_forall.
 *
 * This iterates over values only.  You need a map_iterator_t as a temporary for
 * using this.  See err_map_int_char_p_forall for details.
...
#  define err_map_int_char_p_forall_values_ptr(h,i,v) err_map_int_char_p_forall_values_ptr_nondet(h,i,v)
/* Works similar to map_forall.
 *
 * This iterates over values only.  You need a map_iterator_t as a temporary for
 * using this.  See err_map_int_char_p_forall for details.  Iterating over pointers
...
#  define err_map_int_char_p_forall_keys(h,i,k)   err_map_int_char_p_forall_keys_nondet(h,i,k)
/* Works similar to map_forall.
 *
 * This iterates over keys only.  You need a map_iterator_t as a temporary for
 * using this.  See err_map_int_char_p_forall for details.
...
#  define err_map_int_char_p_forall_pairs(h,i,p)  err_map_int_char_p_forall_pairs_nondet(h,i,p)
/* Works similar to map_forall.
 *
 * This iterates over key/value pairs.  You need a map_iterator_t as a temporary for
 * using this.  See err_map_int_char_p_forall for details.
...
#  define err_map_int_char_p_forall_pairs_ptr(h,i,p)  err_map_int_char_p_forall_pairs_ptr_nondet(h,i,p)
/* Works similar to map_forall.
 *
 * This iterates over key/value pairs.  You need a map_iterator_t as a temporary for
 * using this.  See err_map_int_char_p_forall for details.  Iterating over pointers
...
ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator (err_map_int_char_p_t const *, err_map_iterator_t *);
/*private*/

#ifdef __cplusplus
ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_key (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_value (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_key_and_value (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_value_and_key (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_user (err_map_int_char_p_t const *, err_map_iterator_sorted_t *,
    err_map_int_char_p_pair_cmp_t);
/*private*/

ERR_ERWIN_EXPORT                       
void err_map_int_char_p_init_iterator_ptr_sorted_by_key (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_value (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_key_and_value (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_value_and_key (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_user (err_map_int_char_p_t const *, err_map_iterator_sorted_t *,
    err_map_int_char_p_pair_ptr_cmp_t);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_key_reverse (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_value_reverse (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_key_and_value_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_value_and_key_reverse (
   err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_sorted_by_user_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *, err_map_int_char_p_pair_cmp_t);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_key_reverse (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_value_reverse (err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_key_and_value_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_value_and_key_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *);
/*private*/

ERR_ERWIN_EXPORT
void err_map_int_char_p_init_iterator_ptr_sorted_by_user_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *, err_map_int_char_p_pair_ptr_cmp_t);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted (err_map_int_char_p_t const *, err_map_iterator_sorted_t *,
    int *, char * *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_ptr (err_map_int_char_p_t const *, err_map_iterator_sorted_t *,
    int *, err_map_int_char_p_element_ptr_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_keys (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, int *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_values (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, char * *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_values_ptr (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, err_map_int_char_p_element_ptr_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_pairs (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, err_map_int_char_p_pair_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_pairs_ptr (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, err_map_int_char_p_pair_ptr_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *, int *, char * *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_ptr_reverse (
    err_map_int_char_p_t const *, err_map_iterator_sorted_t *, int *, err_map_int_char_p_element_ptr_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_keys_reverse (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, int *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_values_reverse (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, char * *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_values_ptr_reverse (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, err_map_int_char_p_element_ptr_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_pairs_reverse (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, err_map_int_char_p_pair_t *);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_sorted_pairs_ptr_reverse (err_map_int_char_p_t const *,
    err_map_iterator_sorted_t *, err_map_int_char_p_pair_ptr_t *);
/*private*/
...
ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration  (err_map_int_char_p_t const* /*self*/,
    err_map_iterator_t *, int * /*key*/, char * * /*value*/);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_ptr  (err_map_int_char_p_t const* /*self*/,
    err_map_iterator_t *, int * /*key*/, err_map_int_char_p_element_ptr_t * /*value_ptr*/);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_values  (err_map_int_char_p_t const * /*self*/,
    err_map_iterator_t *, char * * /* value */);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_values_ptr  (err_map_int_char_p_t const * /*self*/,
    err_map_iterator_t *, err_map_int_char_p_element_ptr_t * /* value_ptr */);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_keys  (err_map_int_char_p_t const* /*self*/,
    err_map_iterator_t *, int * /* key */);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_pairs (err_map_int_char_p_t const* /*self*/,
    err_map_iterator_t *, err_map_int_char_p_pair_t * /*pair*/);
/*private*/

ERR_ERWIN_EXPORT
ERR_ERWIN_BOOL err_map_int_char_p_next_iteration_pairs_ptr (err_map_int_char_p_t const* /*self*/,
    err_map_iterator_t *, err_map_int_char_p_pair_ptr_t * /*pair*/);
/*private*/

#ifdef ERR_ERWIN_PROFILE

ERR_ERWIN_EXPORT
int err_map_int_char_p_nrehash_ops (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
int err_map_int_char_p_nrehash (err_map_int_char_p_t const* /*self*/) ATTR_PURE;
  /* rehash_ops is the number of pure rehash operations and rehash
   * is the number of elements moved around during rehashes */

ERR_ERWIN_EXPORT
int err_map_int_char_p_ninsert (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
int err_map_int_char_p_nremove (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
int err_map_int_char_p_nfind (err_map_int_char_p_t const* /*self*/) ATTR_PURE;

ERR_ERWIN_EXPORT
int err_map_int_char_p_nops (err_map_int_char_p_t const* /*self*/) ATTR_PURE;
  /* Sum of inserts, deletions, and searches */

  /* Most interesting are err_map_int_char_p_nops / err_map_int_char_p_nrehash. */
#endif
 ...
 */
#include "error/err_map_int_char_p_i.h"
...
#ifdef ERR_MAP_INT_CHAR_P_SUPER_CLASS
   : ERR_MAP_INT_CHAR_P_SUPER_CLASS_ACCESS ERR_MAP_INT_CHAR_P_SUPER_CLASS
#endif
{
    /* The err_map_int_char_p Class
     * =============
     ...
     *
     *   - err_map_int_char_p_:
     *       This is equivalent to err_map_int_char_p, or the name
     ...
     *       +-------------------+------------------------------+
     *       |! Template         |! Instantiation               |
     *       | err_map_int_char_p_t             | xyz_map_int_p_int_t          |
     *       | ERR_MAP_INT_CHAR_P_ALLOW_NULL    | XYZ_MAP_INT_P_INT_ALLOW_NULL |
     *       +-------------------+------------------------------+
     *   - ErrMapIntCharP:
     *       This is the name of the data structure type in C++: capitalised
     *       and with underbars removed:
     *       +-------------------+-----------------+
     *       |! err_map_int_char_p_t            |! ErrMapIntCharP      |
    ...
    ERR_MAP_INT_CHAR_P_STD_MEMBERS(err_map_int_char_p_t)

#ifdef __cplusplus
public:
#endif

    err_map_int_char_p_record

#ifdef __cplusplus

    /*! doc-ignore */
    err_map_int_char_p_t *it()             { return this; }

    /*! doc-ignore */
    err_map_int_char_p_t const *it() const { return this; }
...
public:
    ...
    err_map_int_char_p_t (void);

    static err_map_int_char_p_t const &static_zero();

#if ERR_MAP_INT_CHAR_P_HAVE_INT_CONSTRUCTOR
    ERR_ERWIN_EXPLICIT err_map_int_char_p_t (int initial_size);
#endif
#if ERR_MAP_INT_CHAR_P_DYN_ZERO
    ERR_ERWIN_EXPLICIT err_map_int_char_p_t (char *  zero_element);
    err_map_int_char_p_t (char *  zero_element, int initial_size);
#endif

    /* status code */
#if !ERR_ERWIN_GLOBAL_ERRNO
    int get_errno(void) const        { cn(); return it()->m_errno; }
    void clear_errno(void) const     { cn(); err_map_int_char_p_clear_errno (it()); }
#else
    ...
    ERR_ERWIN_EXPLICIT err_map_int_char_p_t (err_map_int_char_p_t const *a);

    err_map_int_char_p_t (err_map_int_char_p_t const &a);

    err_map_int_char_p_t *copy (void) const
    {
        cn();
        return new err_map_int_char_p_t (it());
    }

    err_map_int_char_p_t *copy_err (int *err) const
    {
        cn();
        err_map_int_char_p_t *result= new err_map_int_char_p_t (it());
        if (err != NULL && ERR_MAP_IS_ERROR (get_errno ()))
            *err= 1;
        return result;
    }

    err_map_int_char_p_t &xchg(err_map_int_char_p_t *other)
    {
        err_map_int_char_p_xchg (it(), other);
        return *this;
    }

    err_map_int_char_p_t &xchg(err_map_int_char_p_t &other)
    {
        err_map_int_char_p_xchg (this, &other);
        return *this;
    }

    /* Assignment */

    err_map_int_char_p_t &operator= (err_map_int_char_p_t const &);
     ...
     * DO NOT CALL err_map_int_char_p_delete or err_map_int_char_p_delete_flags ON THE RETURNED VALUE!
     * All other things you do are ok. */

    operator err_map_int_char_p_t *(void)             { cn(); return it(); }
    operator err_map_int_char_p_t const *(void) const { cn(); return it(); }
    ...
    {
        nocn();
        return err_map_int_char_p_find (it(), i);
    }
    ...
    char * &operator[] (int  i) {
        cn();
        return *err_map_int_char_p_find_ptr_ensure (it(), i);
    }


    char * *find_ptr (int  i) const
        { nocn(); return err_map_int_char_p_find_ptr (it(), i); }

    char * *find_ptr_ensure (int  i)
        { cn(); return err_map_int_char_p_find_ptr_ensure (it(), i); }

    /* All other members map to the C equivalent directly. */
    char *  find (int  i) const
        { nocn(); return err_map_int_char_p_find (it(), i); }
      
    char *  find_ensure (int  i)
        { cn(); return err_map_int_char_p_find_ensure (it(), i); }

    int  find_any_key() const
        { nocn(); return err_map_int_char_p_find_any_key (it()); }

    char *  find_any() const
        { nocn(); return err_map_int_char_p_find_any (it()); }

    err_map_int_char_p_element_ptr_t find_any_ptr() const
        { nocn(); return err_map_int_char_p_find_any_ptr (it()); }

    int find_any_pair(err_map_int_char_p_key_result_t &kp, err_map_int_char_p_element_ptr_t &vp) const
        { nocn(); return err_map_int_char_p_find_any_pair (&kp, &vp, it()); }


    /* insert */
    err_map_int_char_p_t  &insert (int  k, char *  v)
        { cn(); err_map_int_char_p_insert (it(), k, v); return *this; }

    err_map_int_char_p_t  &insert_map (err_map_int_char_p_t const &other)
        { cn(&other); err_map_int_char_p_insert_map (it(), other.it()); return *this; }

    err_map_int_char_p_t  &insert_map (err_map_int_char_p_t const *other)
        { cn(other); err_map_int_char_p_insert_map (it(), other->it()); return *this; }

#if ERR_MAP_INT_CHAR_P_DIRECT_RECURSION == 0
    err_map_int_char_p_t  &insert (err_map_int_char_p_t const &other)
        { cn(&other); err_map_int_char_p_insert_map (it(), other.it()); return *this; }
    ...
    char * modify (int  i, char *  v)
        { cn(); return err_map_int_char_p_modify (it(), i, v); }

    err_map_int_char_p_t  &modify_map (err_map_int_char_p_t const &other)
        { cn(&other);  err_map_int_char_p_modify_map (it(), other.it()); return *this; }

    err_map_int_char_p_t  &modify_map (err_map_int_char_p_t const *other)
        { cn(other); err_map_int_char_p_modify_map (it(), other->it()); return *this; }

#if ERR_MAP_INT_CHAR_P_DIRECT_RECURSION == 0
    err_map_int_char_p_t  &modify (err_map_int_char_p_t const &other)
        { cn(&other); err_map_int_char_p_modify_map (it(), other.it()); return *this; }
    ...
    err_map_int_char_p_t  &set (int  i, char *  v)
        { cn(); err_map_int_char_p_set (it(), i, v); return *this; }

    err_map_int_char_p_t  &set_map (err_map_int_char_p_t const &other)
        { cn(&other); err_map_int_char_p_set_map (it(), other.it()); return *this; }
...
#if ERR_MAP_INT_CHAR_P_DIRECT_RECURSION == 0
    err_map_int_char_p_t  &set (err_map_int_char_p_t const &other)
        { cn(&other); err_map_int_char_p_set_map (it(), other.it()); return *this; }
    ...
    /* remove */
    char * remove (int  i)
        { nocn(); return err_map_int_char_p_remove (it(), i); }

    err_map_int_char_p_t &remove_map (err_map_int_char_p_t const &other)
        { nocn(&other); err_map_int_char_p_remove_map (it(), other.it()); return *this; }

    err_map_int_char_p_t &remove_map (err_map_int_char_p_t const *other)
        { nocn(other); err_map_int_char_p_remove_map (it(), other->it()); return *this; }

    int remove_if (err_map_int_char_p_feature_t f, bool value = true)
    {
        nocn();
        return err_map_int_char_p_remove_if (it(), f, value);
    }

    /* erase */
    err_map_int_char_p_t  &erase (int  i)
        { nocn(); err_map_int_char_p_erase (it(), i); return *this; }

    err_map_int_char_p_t  &erase_map (err_map_int_char_p_t const &other)
        { nocn(&other); err_map_int_char_p_erase_map (it(), other.it()); return *this; }

    err_map_int_char_p_t  &erase_map (err_map_int_char_p_t const *other)
        { nocn(other); err_map_int_char_p_erase_map (it(), other->it()); return *this; }

#if ERR_MAP_INT_CHAR_P_DIRECT_RECURSION == 0
    err_map_int_char_p_t  &erase (err_map_int_char_p_t const &other)
        { nocn(other); err_map_int_char_p_erase_map (it(), other.it()); return *this; }
    ...
    int erase_if (err_map_int_char_p_feature_t f, bool value = true)
    {
        nocn();
        return err_map_int_char_p_erase_if (it(), f, value);
    }

    err_map_int_char_p_t &intersect (err_map_int_char_p_t const &other)
        { nocn(&other); err_map_int_char_p_intersect (it(), other.it()); return *this; }

    err_map_int_char_p_t &intersect (err_map_int_char_p_t const *other)
        { nocn(other); err_map_int_char_p_intersect (it(), other->it()); return *this; }

    err_map_int_char_p_t &intersect_no_resize (err_map_int_char_p_t const &other)
        { nocn(&other); err_map_int_char_p_intersect_no_resize (it(), other.it()); return *this; }
    ...
    /* others */
    int  find_key (int  i) const { nocn(); return err_map_int_char_p_find_key (it(), i); }

    char *  zero(void) const { nocn(); return err_map_int_char_p_zero (it()); }

    int  ensure (int  k)
        { cn(); return err_map_int_char_p_ensure (it(), k); }

    int  ensure_no_icopy (int  k)
        { cn(); return err_map_int_char_p_ensure_no_icopy (it(), k); }

    int  operator() (int  k)
        { cn(); return err_map_int_char_p_ensure (it(), k); }

    err_map_int_char_p_t &poke (
        int *kp, char * *vo,
        int  k, char *  v,
        bool aintroduce ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true),
        bool aoverwrite ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true))
    {
        cn();
        err_map_int_char_p_poke (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    err_map_int_char_p_t &poke_no_icopy (
        int *kp, char * *vo,
        int  k, char *  v,
        bool aintroduce ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true),
        bool aoverwrite ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true))
    {
        cn();
        err_map_int_char_p_poke_no_icopy (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    err_map_int_char_p_t &poke_no_ocopy (
        int *kp, char * *vo,
        int  k, char *  v,
        bool aintroduce ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true),
        bool aoverwrite ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true))
    {
        cn();
        err_map_int_char_p_poke_no_ocopy (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    err_map_int_char_p_t &poke_no_icopy_no_ocopy (
        int *kp, char * *vo,
        int  k, char *  v,
        bool aintroduce ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true),
        bool aoverwrite ERR_MAP_INT_CHAR_P_DEFAULT_ARG(true))
    {
        cn();
        err_map_int_char_p_poke_no_icopy_no_ocopy (kp,vo, it(), k,v, aintroduce, aoverwrite);
        return *this;
    }

    /* clear */
    err_map_int_char_p_t &clear (void)
    {
        nocn();
        err_map_int_char_p_clear (it());
        return *this;
    }

    err_map_int_char_p_t &clear_no_resize (void)
    {
        nocn();
        err_map_int_char_p_clear_no_resize (it());
        return *this;
    }

    err_map_int_char_p_t &clear (bool k, bool v)
    {
        nocn();
        err_map_int_char_p_clear_flags (it(), k, v);
        return *this;
    }

    int   nentries (void) const                  { nocn(); return err_map_int_char_p_nentries (it()); }
    bool  empty (void) const                     { nocn(); return ERR_ERWIN_TO_BOOL(err_map_int_char_p_empty (it())); }
    bool  non_empty (void) const                 { nocn(); return !err_map_int_char_p_empty (it()); }

    int          *get_keys   (void) const      { nocn(); return err_map_int_char_p_get_keys (it()); }
    static void delete_keys        (int          *k) { err_map_int_char_p_delete_keys (k); }

    err_map_int_char_p_pair_t     *get_entries (void) const     { nocn(); return err_map_int_char_p_get_entries (it()); }
    err_map_int_char_p_pair_ptr_t *get_entries_ptr (void) const { nocn(); return err_map_int_char_p_get_entries_ptr (it()); }
    char *          *get_values (void) const      { nocn(); return err_map_int_char_p_get_values (it()); }

    static void delete_entries_ptr (err_map_int_char_p_pair_ptr_t *k) { err_map_int_char_p_delete_entries_ptr (k); }
    static void delete_entries     (err_map_int_char_p_pair_t     *k) { err_map_int_char_p_delete_entries (k); }
    static void delete_values      (char *          *k) { err_map_int_char_p_delete_values (k); }

    int     hash_size (void) const            { nocn(); return err_map_int_char_p_hash_size (it()); }
    err_map_int_char_p_t &rehash (int n)                     { nocn(); err_map_int_char_p_rehash (it(), n); return *this;}
    double  average_line_length (void) const  { nocn(); return err_map_int_char_p_average_line_length (it()); }
    double  variance_line_length (void) const { nocn(); return err_map_int_char_p_variance_line_length (it()); }
#ifdef HAVE_SQRT
    double  deviation_line_length (void) const { nocn(); return err_map_int_char_p_deviation_line_length (it()); }
#endif
    int     max_line_length (void) const      { nocn(); return err_map_int_char_p_max_line_length (it()); }
    int     min_line_length (void) const      { nocn(); return err_map_int_char_p_min_line_length (it()); }

    void    dump (FILE *f) const              { nocn(); err_map_int_char_p_dump (f, it()); }

#ifdef ERR_ERWIN_PROFILE
    int     nrehash_ops (void) const          { nocn(); return err_map_int_char_p_nrehash_ops (it()); }
    int     nrehash (void) const              { nocn(); return err_map_int_char_p_nrehash (it()); }
    int     ninsert (void) const              { nocn(); return err_map_int_char_p_ninsert (it()); }
    int     nremove (void) const              { nocn(); return err_map_int_char_p_nremove (it()); }
    int     nfind (void) const                { nocn(); return err_map_int_char_p_nfind (it()); }
    int     nops(void) const                  { nocn(); return err_map_int_char_p_nops (it()); }
#endif

    err_hashval_t hash_raw(void) const { nocn(); return err_map_int_char_p_hash_raw (it()); }
    err_hashval_t hash(void) const     { nocn(); return err_map_int_char_p_hash     (it()); }

    bool equal(err_map_int_char_p_t const *other) const
    {
        if (this == NULL || other == NULL) /* must be NULL-safe */
            return this == other;
        return ERR_ERWIN_TO_BOOL(err_map_int_char_p_equal (it(), other->it()));
    }
    ...
    int cmp (err_map_int_char_p_t const *other) const
    {
        if (this == NULL)
            return other == NULL ? 0 : -1;
        if (other == NULL)
            return +1;
        return err_map_int_char_p_cmp (it(), other->it());
    }

    int cmp (err_map_int_char_p_t const &other) const { nocn(); return cmp (&other); }

    bool operator== (err_map_int_char_p_t const &b) const { nocn(); return equal(b); }    /* see equal() */
    bool operator== (err_map_int_char_p_t const *b) const { nocn(); return equal(b); }    /* see equal() */

    bool operator!= (err_map_int_char_p_t const &b) const { nocn(); return !equal(b); }   /* see equal() */
    bool operator!= (err_map_int_char_p_t const *b) const { nocn(); return !equal(b); }   /* see equal() */

    bool operator<= (err_map_int_char_p_t const &b) const { nocn(); return cmp(b) <= 0; } /* see cmp() */
    bool operator<= (err_map_int_char_p_t const *b) const { nocn(); return cmp(b) <= 0; } /* see cmp() */
...
/* Note: The err_map_int_char_p_pair_cmp_t argument to the next_user_... functions is useful only
 ...
 */
    ...
    {
        err_map_int_char_p_init_iterator (((ErrMapIntCharP const *)map)->it(), iter);
    }

    bool next (err_map_iterator_t &iter, int &k, char * &v) const
    {
        return err_map_int_char_p_next_iteration (it(), &iter, &k, &v) != ERR_ERWIN_FALSE;
    }

    static void init_iterator_sorted_by_key (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_key (((ErrMapIntCharP const *)map)->it(), iter);
    }

    bool next_sorted (err_map_iterator_sorted_t &iter, int &k, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted (it(), &iter, &k, &v) != ERR_ERWIN_FALSE;
    }

    static void init_iterator_sorted_by_value (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_value (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_key_and_value (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_key_and_value (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_value_and_key (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_value_and_key (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_user (void const *map, err_map_iterator_sorted_t *iter, err_map_int_char_p_void_pair_cmp_t u)
    {
        err_map_int_char_p_init_iterator_sorted_by_user (((ErrMapIntCharP const *)map)->it(), iter, (err_map_int_char_p_pair_cmp_t)u);
    }

    bool next_user_sorted (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, int &k, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted (it(), &iter, &k, &v) != ERR_ERWIN_FALSE;
    }

    bool next_ptr (err_map_iterator_t &iter, int &k, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_ptr (it(), &iter, &k, &V) != ERR_ERWIN_FALSE;
    }

    static void init_iterator_ptr_sorted_by_key (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_key (((ErrMapIntCharP const *)map)->it(), iter);
    }

    bool next_sorted_ptr (err_map_iterator_sorted_t &iter, int &k, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_ptr (it(), &iter, &k, &V) != ERR_ERWIN_FALSE;
    }

    static void init_iterator_ptr_sorted_by_value (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_value (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_key_and_value (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_key_and_value (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_value_and_key (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_value_and_key (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_user (void const *map, err_map_iterator_sorted_t *iter, err_map_int_char_p_void_pair_cmp_t U)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_user (((ErrMapIntCharP const *)map)->it(), iter, (err_map_int_char_p_pair_ptr_cmp_t)U);
    }

    bool next_user_sorted_ptr (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_cmp_t, int &k, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_ptr (it(), &iter, &k, &V) != ERR_ERWIN_FALSE;
    }
    ...
    {
        return err_map_int_char_p_next_iteration_keys (it(), &iter, &k) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_key (err_map_iterator_sorted_t &iter, int &k) const
    {
        return err_map_int_char_p_next_iteration_sorted_keys (it(), &iter, &k) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_key (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, int &k) const
    {
        return err_map_int_char_p_next_iteration_sorted_keys (it(), &iter, &k) != ERR_ERWIN_FALSE;
    }
    ...
    {
        return err_map_int_char_p_next_iteration_values (it(), &iter, &v) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_value (err_map_iterator_sorted_t &iter, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted_values (it(), &iter, &v) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_value (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted_values (it(), &iter, &v) != ERR_ERWIN_FALSE;
    }

    bool next_value_ptr (err_map_iterator_t &iter, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_values_ptr (it(), &iter, &V) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_value_ptr (err_map_iterator_sorted_t &iter, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_values_ptr (it(), &iter, &V) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_value_ptr (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_cmp_t, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_values_ptr (it(), &iter, &V) != ERR_ERWIN_FALSE;
    }

    bool next_pair (err_map_iterator_t &iter, err_map_int_char_p_pair_t &p) const
    {
        return err_map_int_char_p_next_iteration_pairs (it(), &iter, &p) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_pair (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_t &p) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs (it(), &iter, &p) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_pair (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, err_map_int_char_p_pair_t &p) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs (it(), &iter, &p) != ERR_ERWIN_FALSE;
    }

    bool next_pair_ptr (err_map_iterator_t &iter, err_map_int_char_p_pair_ptr_t &P) const
    {
        return err_map_int_char_p_next_iteration_pairs_ptr (it(), &iter, &P) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_pair_ptr (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_t &P) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs_ptr (it(), &iter, &P) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_pair_ptr (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_cmp_t, err_map_int_char_p_pair_ptr_t &P) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs_ptr (it(), &iter, &P) != ERR_ERWIN_FALSE;
    }
    ...
    {
        err_map_int_char_p_init_iterator_sorted_by_key_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    bool next_sorted_reverse (err_map_iterator_sorted_t &iter, int &k, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted_reverse (it(), &iter, &k, &v) != ERR_ERWIN_FALSE;
    }

    static void init_iterator_sorted_by_value_reverse (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_value_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_key_and_value_reverse (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_key_and_value_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_value_and_key_reverse (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_sorted_by_value_and_key_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_sorted_by_user_reverse (void const *map, err_map_iterator_sorted_t *iter, err_map_int_char_p_void_pair_cmp_t u)
    {
        err_map_int_char_p_init_iterator_sorted_by_user_reverse (((ErrMapIntCharP const *)map)->it(), iter, (err_map_int_char_p_pair_cmp_t)u);
    }

    bool next_user_sorted_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, int &k, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted_reverse (it(), &iter, &k, &v) != ERR_ERWIN_FALSE;
    }
    ...
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_key_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    bool next_sorted_ptr_reverse (err_map_iterator_sorted_t &iter, int &k, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_ptr_reverse (it(), &iter, &k, &V) != ERR_ERWIN_FALSE;
    }

    static void init_iterator_ptr_sorted_by_value_reverse (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_value_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_key_and_value_reverse (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_key_and_value_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_value_and_key_reverse (void const *map, err_map_iterator_sorted_t *iter)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_value_and_key_reverse (((ErrMapIntCharP const *)map)->it(), iter);
    }

    static void init_iterator_ptr_sorted_by_user_reverse (void const *map, err_map_iterator_sorted_t *iter, err_map_int_char_p_void_pair_cmp_t U)
    {
        err_map_int_char_p_init_iterator_ptr_sorted_by_user_reverse (((ErrMapIntCharP const *)map)->it(), iter, (err_map_int_char_p_pair_ptr_cmp_t)U);
    }

    bool next_user_sorted_ptr_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_cmp_t, int &k, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_ptr_reverse (it(), &iter, &k, &V) != ERR_ERWIN_FALSE;
    }
    ...
    {
        return err_map_int_char_p_next_iteration_sorted_keys_reverse (it(), &iter, &k) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_key_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, int &k) const
    {
        return err_map_int_char_p_next_iteration_sorted_keys_reverse (it(), &iter, &k) != ERR_ERWIN_FALSE;
    }
    ...
    {
        return err_map_int_char_p_next_iteration_sorted_values_reverse (it(), &iter, &v) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_value_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, char * &v) const
    {
        return err_map_int_char_p_next_iteration_sorted_values_reverse (it(), &iter, &v) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_value_ptr_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_values_ptr_reverse (it(), &iter, &V) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_value_ptr_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_cmp_t, err_map_int_char_p_element_ptr_t &V) const
    {
        return err_map_int_char_p_next_iteration_sorted_values_ptr_reverse (it(), &iter, &V) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_pair_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_t &p) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs_reverse (it(), &iter, &p) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_pair_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_cmp_t, err_map_int_char_p_pair_t &p) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs_reverse (it(), &iter, &p) != ERR_ERWIN_FALSE;
    }

    bool next_sorted_pair_ptr_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_t &P) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs_ptr_reverse (it(), &iter, &P) != ERR_ERWIN_FALSE;
    }

    bool next_user_sorted_pair_ptr_reverse (err_map_iterator_sorted_t &iter, err_map_int_char_p_pair_ptr_cmp_t, err_map_int_char_p_pair_ptr_t &P) const
    {
        return err_map_int_char_p_next_iteration_sorted_pairs_ptr_reverse (it(), &iter, &P) != ERR_ERWIN_FALSE;
    }
...
extern "C++" {
ERWIN_WRAPPER
err_map_int_char_p_t *err_erwin_ptr_of(err_map_int_char_p_t *x) { return x;  }

ERWIN_WRAPPER
err_map_int_char_p_t *err_erwin_ptr_of(err_map_int_char_p_t &x) { return &x; }

ERWIN_WRAPPER
err_map_int_char_p_t const *err_erwin_ptr_const_of (err_map_int_char_p_t const *x) { return x;  }
...
/*
 * For the sorted iteration you must provide ERR_INT_CMP and ERR_CHAR_P_CMP resp.  Otherwise, you
 ...
 *    : ...
 *
 * It might be interesting to compare this to the C version err_map_int_char_p_forall.
 *
 ...
 * to arbitrarily modify (err_map_int_char_p_erase, err_map_int_char_p_insert, err_map_int_char_p_modify) the map while you
 ...
 * Use err_map_int_char_p_erase and err_map_int_char_p_insert for this.
 *
...
#   define err_map_forall_sorted_by_user(h,u,k,v) \
        for(err_map_iterator_sorted_t \
                ERWIN_GENSYM(erwin_local_i)(err_erwin_ptr_const_of(h)->init_iterator_sorted_by_user, \
                    (void const *)err_erwin_ptr_const_of(h), (err_map_int_char_p_void_pair_cmp_t)u); \
...
#   define err_map_forall_ptr_sorted_by_user(h,U,k,V) \
        for(err_map_iterator_sorted_t \
                ERWIN_GENSYM(erwin_local_i)(err_erwin_ptr_of(h)->init_iterator_ptr_sorted_by_user, \
                    (void const *)err_erwin_ptr_of(h), (err_map_int_char_p_void_pair_cmp_t)U); \
...
#endif /* !defined(ERWIN_ERR_MAP_INT_CHAR_P_h) */
