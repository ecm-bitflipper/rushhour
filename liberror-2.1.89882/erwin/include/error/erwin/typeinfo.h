...
#ifndef ERR_ERWIN_TYPEINFO_H
#define ERR_ERWIN_TYPEINFO_H
...
#if ERR_ERWIN_TYPE_INFO && !defined(TYPE_INFO_T)

#define err_erwin_kind_t_defined 1
enum _err_erwin_kind_t {
    ERR_KIND_VOID,     /* void */
    ERR_KIND_SINT,     /* int, short, ... */
    ERR_KIND_UINT,     /* unsigned, unsigned short, ... */
    ERR_KIND_ENUM,     /* enums (kind of int, but named values) */
    ERR_KIND_FLOAT,    /* float, double */
    ERR_KIND_STRUCT,   /* containing some slots */
    ERR_KIND_ARRAY,    /* constant sized array */
    ERR_KIND_UNION,    /* is is doubtful that GCs can handle this. */
    ERR_KIND_POINTER,  /* a pointer to some other type. */
    ERR_KIND_REF,      /* a pointer to some other type; C++ variant: a reference. */
    ERR_KIND_STRING,   /* 0-terminated array (if all bytes of element type == 0 => end) */
    ERR_KIND_VECTOR,   /* dynamically sized array (must be embedded in struct) */
    ERR_KIND_FUNCTION, /* NYI */
    ERR_KIND_TUPLE     /* NYI */
};

ERWIN_KIND_TYPEDEFS(enum,   err_erwin_kind_t)
ERWIN_KIND_TYPEDEFS(struct, err_erwin_type_t)
ERWIN_KIND_TYPEDEFS(struct, err_erwin_slot_t)

/* Slots: */
#define err_erwin_slot_t_defined 1
struct _err_erwin_slot_t {
    char const *name;
    size_t value;
        /* struct: relative char* offset in struct,
         * enum:   value,
         * union:  unused */
    err_erwin_type_t_const_p type;
        /* struct/union: type of this sub-structure
         * enum: unused */
};

/* The type info: */
#define err_erwin_type_t_defined 1
struct _err_erwin_type_t {
    err_erwin_kind_t kind;
    char const *name;
    size_t size;
    ...
    size_t nentries;
         ...
         * else:   0 */
    err_erwin_type_t_const_p element;
        /* pointer/vector/array/string: element type
         * else:   NULL */
    err_erwin_slot_t_const_p slot;
        /* struct: slots,
         * enum:   values
         * union:  choices
         * else:   NULL */
...
/* Main type info defs: */
#define TYPE_STRUCT_T(X) err_erwin_slot_t TYPE_STRUCT_SLOTS(X)[]
#define TYPE_UNION_T(X)  err_erwin_slot_t TYPE_UNION_CHOICES(X)[]
#define TYPE_ENUM_T(X)   err_erwin_slot_t TYPE_ENUM_VALUES(X)[]

#define TYPE_INFO_T(X)   err_erwin_type_t TYPE_INFO(X)

/* Basic scalars: */
#define TYPE_INFO_SINT(Type)  { ERR_KIND_SINT,  #Type, sizeof(Type), 0, NULL, NULL }
#define TYPE_INFO_UINT(Type)  { ERR_KIND_UINT,  #Type, sizeof(Type), 0, NULL, NULL }
#define TYPE_INFO_FLOAT(Type) { ERR_KIND_FLOAT, #Type, sizeof(Type), 0, NULL, NULL }

#define TYPE_INFO_VOID(Type)  { ERR_KIND_VOID,  #Type, 0,            0, NULL, NULL }
...
#define TYPE_STRUCT_SLOT(Container,QElement,slot)     \
            { #slot,                                  \
              ERR_ERWIN_OFFSETOF(Container, slot), \
              &TYPE_INFO(QElement)                    \
            },
...
#define TYPE_INFO_VECTOR(Type,Element,Container,slot)        \
            {                                                \
                ERR_KIND_VECTOR,                          \
                #Type,                                       \
                ERR_ERWIN_SIZEOF_MEMBER(Container, slot), \
                ERR_ERWIN_OFFSETOF(Container, slot),      \
                &TYPE_INFO(Element),                         \
                NULL                                         \
            }
...
#define ERR_ERWIN_BOOL_KIND      ENUM
#define ERR_ERWIN_BOOL_TYPE_INFO TYPE_INFO_NAME(ERR_ERWIN_BOOL)
extern  TYPE_INFO_T(ERR_ERWIN_BOOL);
...
#define bool_TYPE_INFO TYPE_INFO_NAME(err_erwininternalbool)
#endif /* !defined bool_TYPE_INFO */
#ifndef bool_TYPE_INFO
#define bool_TYPE_INFO err_erwininternalbool_TYPE_INFO
#endif /* !defined bool_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalbool);
#endif
...
#endif /* !defined char_KIND */
#endif
#define err_erwininternalchar_TYPE_INFO        TYPE_INFO_NAME(err_erwininternalchar)
#ifndef char_TYPE_INFO
#define char_TYPE_INFO       err_erwininternalchar_TYPE_INFO
#endif /* !defined char_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalchar);

#ifndef int_KIND
#define int_KIND             SINT
#endif /* !defined int_KIND */
#define err_erwininternalint_TYPE_INFO         TYPE_INFO_NAME(err_erwininternalint)
#ifndef int_TYPE_INFO
#define int_TYPE_INFO        err_erwininternalint_TYPE_INFO
#endif /* !defined int_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalint);

#ifndef float_KIND
#define float_KIND           FLOAT
#endif /* !defined float_KIND */
#define err_erwininternalfloat_TYPE_INFO       TYPE_INFO_NAME(err_erwininternalfloat)
#ifndef float_TYPE_INFO
#define float_TYPE_INFO      err_erwininternalfloat_TYPE_INFO
#endif /* !defined float_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalfloat);

#ifndef double_KIND
#define double_KIND          FLOAT
#endif /* !defined double_KIND */
#define err_erwininternaldouble_TYPE_INFO      TYPE_INFO_NAME(err_erwininternaldouble)
#ifndef double_TYPE_INFO
#define double_TYPE_INFO     err_erwininternaldouble_TYPE_INFO
#endif /* !defined double_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternaldouble);

#ifndef short_KIND
#define short_KIND           SINT
#endif /* !defined short_KIND */
#define err_erwininternalshort_TYPE_INFO      TYPE_INFO_NAME(err_erwininternalshort)
#ifndef short_TYPE_INFO
#define short_TYPE_INFO      err_erwininternalshort_TYPE_INFO
#endif /* !defined short_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalshort);

#ifndef long_KIND
#define long_KIND            SINT
#endif /* !defined long_KIND */
#define err_erwininternallong_TYPE_INFO       TYPE_INFO_NAME(err_erwininternallong)
#ifndef long_TYPE_INFO
#define long_TYPE_INFO       err_erwininternallong_TYPE_INFO
#endif /* !defined long_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternallong);

#ifdef ERWIN_LONG_LONG
#ifndef ERWIN_LONG_LONG_KIND
#define ERWIN_LONG_LONG_KIND            SINT
#endif /* !defined ERWIN_LONG_LONG_KIND */
#define err_erwininternalERWIN_LONG_LONG_TYPE_INFO       TYPE_INFO_NAME(err_erwininternalERWIN_LONG_LONG)
#ifndef ERWIN_LONG_LONG_TYPE_INFO
#define ERWIN_LONG_LONG_TYPE_INFO       err_erwininternalERWIN_LONG_LONG_TYPE_INFO
#endif /* !defined ERWIN_LONG_LONG_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalERWIN_LONG_LONG);
#endif

#ifndef unsigned_char_KIND
#define unsigned_char_KIND       UINT
#endif /* !defined unsigned_char_KIND */
#define err_erwininternalunsigned_char_TYPE_INFO  TYPE_INFO_NAME(err_erwininternalunsigned_char)
#ifndef unsigned_char_TYPE_INFO
#define unsigned_char_TYPE_INFO  err_erwininternalunsigned_char_TYPE_INFO
#endif /* !defined unsigned_char_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalunsigned_char);

#ifndef unsigned_KIND
#define unsigned_KIND            UINT
#endif /* !defined unsigned_KIND */
#define err_erwininternalunsigned_TYPE_INFO       TYPE_INFO_NAME(err_erwininternalunsigned)
#ifndef unsigned_TYPE_INFO
#define unsigned_TYPE_INFO       err_erwininternalunsigned_TYPE_INFO
#endif /* !defined unsigned_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalunsigned);

#ifndef unsigned_short_KIND
#define unsigned_short_KIND      UINT
#endif /* !defined unsigned_short_KIND */
#define err_erwininternalunsigned_short_TYPE_INFO TYPE_INFO_NAME(err_erwininternalunsigned_short)
#ifndef unsigned_short_TYPE_INFO
#define unsigned_short_TYPE_INFO err_erwininternalunsigned_short_TYPE_INFO
#endif /* !defined unsigned_short_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalunsigned_short);

#ifndef unsigned_long_KIND
#define unsigned_long_KIND       UINT
#endif /* !defined unsigned_long_KIND */
#define err_erwininternalunsigned_long_TYPE_INFO  TYPE_INFO_NAME(err_erwininternalunsigned_long)
#ifndef unsigned_long_TYPE_INFO
#define unsigned_long_TYPE_INFO  err_erwininternalunsigned_long_TYPE_INFO
#endif /* !defined unsigned_long_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalunsigned_long);
...
#define err_erwininternalERWIN_UNSIGNED_LONG_LONG_TYPE_INFO  TYPE_INFO_NAME(err_erwininternalERWIN_UNSIGNED_LONG_LONG)
#ifndef ERWIN_UNSIGNED_LONG_LONG_TYPE_INFO
#define ERWIN_UNSIGNED_LONG_LONG_TYPE_INFO  err_erwininternalERWIN_UNSIGNED_LONG_LONG_TYPE_INFO
#endif /* !defined ERWIN_UNSIGNED_LONG_LONG_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalERWIN_UNSIGNED_LONG_LONG);
#endif

#ifndef signed_char_KIND
#define signed_char_KIND         SINT
#endif /* !defined signed_char_KIND */
#define err_erwininternalsigned_char_TYPE_INFO    TYPE_INFO_NAME(err_erwininternalsigned_char)
#ifndef signed_char_TYPE_INFO
#define signed_char_TYPE_INFO    err_erwininternalsigned_char_TYPE_INFO
#endif /* !defined signed_char_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalsigned_char);

#ifndef size_t_KIND
#define size_t_KIND              UINT
#endif /* !defined size_t_KIND */
#define err_erwininternalsize_t_TYPE_INFO         TYPE_INFO_NAME(err_erwininternalsize_t)
#ifndef size_t_TYPE_INFO
#define size_t_TYPE_INFO         err_erwininternalsize_t_TYPE_INFO
#endif /* !defined size_t_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalsize_t);

#ifndef void_KIND
#define void_KIND                VOID
#endif /* !defined void_KIND */
#define err_erwininternalvoid_TYPE_INFO         TYPE_INFO_NAME(err_erwininternalvoid)
#ifndef void_TYPE_INFO
#define void_TYPE_INFO         err_erwininternalvoid_TYPE_INFO
#endif /* !defined void_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalvoid);
...
#define err_erwininternalchar_string_TYPE_INFO    TYPE_INFO_NAME(err_erwininternalchar_string)
#ifndef char_string_TYPE_INFO
#define char_string_TYPE_INFO    err_erwininternalchar_string_TYPE_INFO
#endif /* !defined char_string_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalchar_string);

#ifndef char_p_KIND
#define char_p_KIND              POINTER
#endif /* !defined char_p_KIND */
#define err_erwininternalchar_p_TYPE_INFO         TYPE_INFO_NAME(err_erwininternalchar_p)
#ifndef char_p_TYPE_INFO
#define char_p_TYPE_INFO         err_erwininternalchar_p_TYPE_INFO
#endif /* !defined char_p_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalchar_p);

#ifndef char_const_p_KIND
#define char_const_p_KIND        POINTER
#endif /* !defined char_const_p_KIND */
#define err_erwininternalchar_const_p_TYPE_INFO   TYPE_INFO_NAME(err_erwininternalchar_const_p)
#ifndef char_const_p_TYPE_INFO
#define char_const_p_TYPE_INFO   err_erwininternalchar_const_p_TYPE_INFO
#endif /* !defined char_const_p_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalchar_const_p);

#ifndef void_p_KIND
#define void_p_KIND              POINTER
#endif /* !defined void_p_KIND */
#define err_erwininternalvoid_p_TYPE_INFO         TYPE_INFO_NAME(err_erwininternalvoid_p)
#ifndef void_p_TYPE_INFO
#define void_p_TYPE_INFO         err_erwininternalvoid_p_TYPE_INFO
#endif /* !defined void_p_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalvoid_p);

#ifndef void_const_p_KIND
#define void_const_p_KIND        POINTER
#endif /* !defined void_const_p_KIND */
#define err_erwininternalvoid_const_p_TYPE_INFO   TYPE_INFO_NAME(err_erwininternalvoid_const_p)
#ifndef void_const_p_TYPE_INFO
#define void_const_p_TYPE_INFO   err_erwininternalvoid_const_p_TYPE_INFO
#endif /* !defined void_const_p_TYPE_INFO */
extern  TYPE_INFO_T(err_erwininternalvoid_const_p);
...
extern char const *err_erwin_kind_to_string (err_erwin_kind_t) ATTR_PURE;

#endif

#ifdef __cplusplus
#ifdef err_erwin_type_t_defined

#define ERR_ERWIN_DEF_TYPE(Type, Which)                          \
    ERWIN_WRAPPER                                                   \
    err_erwin_type_t const *err_erwin_type (Type) ATTR_CONST; \
    ERWIN_WRAPPER                                                   \
    err_erwin_type_t const *err_erwin_type (Type)             \
        { return &Which##_TYPE_INFO; }

ERR_ERWIN_DEF_TYPE(void,           void)

ERR_ERWIN_DEF_TYPE(char,           char)
ERR_ERWIN_DEF_TYPE(signed char,    signed_char)
ERR_ERWIN_DEF_TYPE(unsigned char,  unsigned_char)

ERR_ERWIN_DEF_TYPE(short,          short)
ERR_ERWIN_DEF_TYPE(unsigned short, unsigned_short)

ERR_ERWIN_DEF_TYPE(int,            int)
ERR_ERWIN_DEF_TYPE(unsigned,       unsigned)

ERR_ERWIN_DEF_TYPE(long,           long)
ERR_ERWIN_DEF_TYPE(unsigned long,  unsigned_long)

ERR_ERWIN_DEF_TYPE(char *,        char_p)
ERR_ERWIN_DEF_TYPE(char const *,  char_p)

ERR_ERWIN_DEF_TYPE(void *,        void_p)
ERR_ERWIN_DEF_TYPE(void const *,  void_p)

#ifdef ERWIN_UNSIGNED_LONG_LONG
ERR_ERWIN_DEF_TYPE(ERWIN_LONG_LONG,          ERWIN_LONG_LONG)
ERR_ERWIN_DEF_TYPE(ERWIN_UNSIGNED_LONG_LONG, ERWIN_UNSIGNED_LONG_LONG)
#endif /* ERWIN_UNSIGNED_LONG_LONG */

#endif /* err_erwin_type_t_defined */
#endif /* !cplusplus */

/* @@Begin: #include@@ */
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_callback_ti.h"
#else
#include <error/err_map_int_callback_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_v_callback_ti.h"
#else
#include <error/err_map_int_v_callback_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_symbol_int_ti.h"
#else
#include <error/err_map_symbol_int_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_callback_ti.h"
#else
#include <error/err_v_callback_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_symbol_stream_ti.h"
#else
#include <error/err_map_symbol_stream_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_stream_ti.h"
#else
#include <error/err_v_stream_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_symbol_string_ti.h"
#else
#include <error/err_map_symbol_string_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_char_ti.h"
#else
#include <error/err_v_char_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_map_int_v_callback_ti.h"
#else
#include <error/err_map_int_map_int_v_callback_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_char_p_ti.h"
#else
#include <error/err_map_int_char_p_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_buffer_ti.h"
#else
#include <error/err_v_buffer_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_int_ti.h"
#else
#include <error/err_v_int_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_char_const_p_ti.h"
#else
#include <error/err_v_char_const_p_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_v_stream_ti.h"
#else
#include <error/err_map_int_v_stream_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_symbol_ti.h"
#else
#include <error/err_map_int_symbol_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_file_stream_ti.h"
#else
#include <error/err_map_file_stream_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_char_p_char_p_ti.h"
#else
#include <error/err_map_char_p_char_p_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_symtab_ti.h"
#else
#include <error/err_symtab_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_v_message_ti.h"
#else
#include <error/err_v_message_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_bool_ti.h"
#else
#include <error/err_map_int_bool_ti.h>
#endif
#ifdef ERR_ERWIN_COMPILING
#include "error/err_map_int_int_ti.h"
#else
#include <error/err_map_int_int_ti.h>
#endif
/* @@End: #include@@ */
