...
#ifndef ERR_ERWIN_CLASSUNDEF_H
#define ERR_ERWIN_CLASSUNDEF_H

/*
 * Undefines everything that lacks the 'Err' prefix and introduces
 * inline versions of many declarators, because the user of the library
 * will not run erwin-cgen with the library settings.
 */

/* Totally private: */
#undef  _err_member_priv
...
#define _err_member_rw_obj(TYPE, NAME, DOCSTRING)                   \
            ...
            void set_##NAME (TYPE *a) {                                \
                assert (this != NULL);                                 \
                ERR_REF ((ErrObject *)a);                \
                ERR_CHECK_OTHER_SIG(a);                             \
                ERR_UNREF_RVAL((ErrObject *)m_##NAME()); \
                _m_##NAME= a;                                          \
            }                                                          \
            void reset_##NAME () {                                     \
                ERR_UNREF_RVAL((ErrObject *)m_##NAME()); \
...
#undef  err_stdclass_no_ref
#define err_stdclass_no_ref                                                                   \
    public:                                                                                      \
        typedef THIS This;                                                                       \
        typedef SUPER Super;                                                                     \
    protected:                                                                                   \
        virtual THIS *ERWIN_CONCAT_TOKEN(v_as_, THIS) () {ERR_CHECK_SIG(this); return this; } \
    public:
...
#endif /* !defined(ERR_ERWIN_CLASSUNDEF_H) */
...
#undef child_priv
#undef child_priv_ref
#undef child_priv_eref
#undef child_priv_ptr
#undef child_priv_obj
#undef child_ri_obj
#undef child_ri_ptr
#undef child_ri_ref
#undef child_ri_eref
