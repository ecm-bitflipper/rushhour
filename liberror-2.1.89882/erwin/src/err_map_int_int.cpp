...
#ifndef ERR_MAP_INT_INT_IMPLEMENTATION
#define ERR_MAP_INT_INT_IMPLEMENTATION
#endif
...
#if ERR_MAP_INT_INT_INITIAL_SIZE < 0
#  error ERR_MAP_INT_INT_INITIAL_SIZE < 0
#endif

#if ERR_MAP_INT_INT_MINIMAL_SIZE < 0
#  error ERR_MAP_INT_INT_MINIMAL_SIZE < 0
#endif

#if ERR_MAP_INT_INT_MINIMAL_SIZE == 0
#  define ERR_MAP_INT_INT_ZERO_SIZE         1
#  define ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1 1
#elif ERR_MAP_INT_INT_INITIAL_SIZE == 0
#  define ERR_MAP_INT_INT_ZERO_SIZE         1
#  define ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1 ERR_MAP_INT_INT_MINIMAL_SIZE
#else
#  define ERR_MAP_INT_INT_ZERO_SIZE         0
#  define ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1 ERR_MAP_INT_INT_MINIMAL_SIZE
#endif

#if ERR_MAP_INT_INT_ZERO_SIZE

#  define HAS_HEAP_TABLE_AUX(hashsize)    ((hashsize) > 1)

#  define GET_SLOT(table,hashsize,i)      (HAS_HEAP_TABLE_AUX(hashsize) ? \
                                              (table[(i)])                \
                                            : *((err_map_int_int_hashlist_t**)(&(table)))     \
                                          )
...
#if defined(INT_IS_PTR) && defined(INT_IS_PTR) && !INT_IS_PTR && !INT_IS_PTR
...
#  else
#      define e_errno (ERWIN_CONST_CAST(err_map_int_int_t*,self)->m_errno)
#  endif
#else
...
#if ERR_MAP_INT_INT_HAVE_SIG
#  define return_if_bad(self) \
      return_if_fail_ppxxt(self->m_sig == ERR_MAP_INT_INT_SIG, self, self->m_sig, ERR_MAP_INT_INT_SIG, "Structure was probably overwritten");
#  define return_val_if_bad(self, val) \
      return_val_if_fail_ppxxt(self->m_sig == ERR_MAP_INT_INT_SIG, val, self, self->m_sig, ERR_MAP_INT_INT_SIG, "Structure was probably overwritten");
#  define return_if_bad_pC(self, prog) \
      return_if_fail_ppxxtC(self->m_sig == ERR_MAP_INT_INT_SIG, self, self->m_sig, ERR_MAP_INT_INT_SIG, "Structure was probably overwritten", prog);
#else
#  define return_if_bad(self)
#  define return_val_if_bad(self, val)
#  define return_if_bad_pC(self, prog)
...
#define USER_ASSERTION_FAILED_HANDLER(FI,L,FU,A)    \
            ASSERTION_FAILED;                       \
            ERR_MAP_INT_INT_ASSERTION_FAILED_HANDLER(FI,L,FU,A)
#endif
...
#define TOOSMALL(X,Y) (((X) * ERR_MAP_INT_INT_TRIGGER_DENOMINATOR) > ((Y) * ERR_MAP_INT_INT_TRIGGER_NUMERATOR))

#define TOOLARGE(X,Y) (((Y) >= ERR_MAP_INT_INT_MINIMAL_SIZE) && \
                       (((X) * ERR_MAP_INT_INT_TRIGGER_DENOMINATOR) < (((Y) * ERR_MAP_INT_INT_TRIGGER_NUMERATOR)/4)))
...
#define ITER               ((err_map_int_int_internal_Iterator*)iter)
#define SORTITER           ((err_map_int_int_internal_sorted_Iterator*)iter)
#define SORTITERPTR        ((err_map_int_int_internal_sorted_ptr_Iterator*)iter)

#ifdef E_PROFILE
typedef union {
   err_map_int_int_t       *mapt;
   err_map_int_int_t const *mapconstt;
} hack_no_const;
#endif
 ...
 *    err_map_int_int_index_t == i_type_t
 *    err_map_int_int_value_t == o_type_t
 */
...
#define SPLIT_SECTIONS ERR_MAP_INT_INT_SPLIT
...
/* Check that ERR_MAP_INT_INT_ALLOW_NULL and ERR_ERWIN_THREAD_SAFE are not used at
...
#if 0
/* FIXME: NYI */
#if ERR_MAP_INT_INT_ALLOW_NULL && defined(ERR_ERWIN_THREAD_SAFE)
#  error "Cannot use ERR_MAP_INT_INT_ALLOW_NULL and ERR_ERWIN_THREAD_SAFE at the same time."
#endif
#endif

#if ERR_MAP_INT_INT_NOMEM_IS_FATAL
...
#if ERR_MAP_INT_INT_DYN_ZERO
#  define err_map_int_int_init_internal_q(SE,Z,SI)  err_map_int_int_init_internal(SE,Z,SI)
#else
#  define err_map_int_int_init_internal_q(SE,Z,SI) err_map_int_int_init_internal(SE,SI)
#endif



#  define feature_q(K,V)                feature(K,V)
#  define err_map_int_int_hashlist_new_q(K,V)               err_map_int_int_hashlist_new(K,V)
#  define err_map_int_int_find_any_pair_q(K,V,SE)   err_map_int_int_find_any_pair(K,V,SE)
#  define err_map_int_int_insert_q(SE,K,V)          err_map_int_int_insert(SE,K,V)

#  define err_map_int_int_insert_no_copy_no_rehash_q(SE,K,V) \
                                        err_map_int_int_insert_no_copy_no_rehash(SE,K,V)

#  define err_map_int_int_poke_internal_q(KO,VO,SE,K,KC,DK,V,VK,DV,I,O) \
                                        err_map_int_int_poke_internal(KO,VO,SE,K,KC,DK,V,VK,DV,I,O)

#  define err_map_int_int_poke_q(KO,VO,SE,K,V,I,O)  err_map_int_int_poke(KO,VO,SE,K,V,I,O)

#  define err_map_int_int_poke_no_icopy_q(KO,VO,SE,K,V,I,O)  \
                                        err_map_int_int_poke_no_icopy(KO,VO,SE,K,V,I,O)

#  define err_map_int_int_remove_internal_no_resize_q(SE,K,R) \
                                        err_map_int_int_remove_internal_no_resize(SE,K,R)

#  define err_map_int_int_remove_internal_q(SE,K,R) err_map_int_int_remove_internal(SE,K,R)
...
static
TYPE_STRUCT_T(err_map_int_int_hashlist_t)=
    TYPE_STRUCT_BEGIN(err_map_int_int_hashlist_t)
        TYPE_STRUCT_SLOT(err_map_int_int_hashlist_t, int, key)
        TYPE_STRUCT_SLOT(err_map_int_int_hashlist_t, int, value)
        TYPE_STRUCT_SLOT(err_map_int_int_hashlist_t, err_map_int_int_hashlist_t_p,        next)
    TYPE_STRUCT_END
;


TYPE_INFO_T(err_map_int_int_hashlist_t)= TYPE_INFO_STRUCT (err_map_int_int_hashlist_t, err_map_int_int_hashlist_t);


TYPE_INFO_T(err_map_int_int_hashlist_t_p)= TYPE_INFO_POINTER (err_map_int_int_hashlist_t *, err_map_int_int_hashlist_t);


TYPE_INFO_T(err_map_int_int_hashlist_t_const_p)= TYPE_INFO_POINTER (err_map_int_int_hashlist_t const *, err_map_int_int_hashlist_t);


TYPE_INFO_T(err_map_int_int_content)= TYPE_INFO_VECTOR (err_map_int_int_content, err_map_int_int_hashlist_t_p, err_map_int_int_t, m_hashsize);


TYPE_INFO_T(err_map_int_int_content_p)= TYPE_INFO_POINTER (err_map_int_int_content *, err_map_int_int_content);

static
TYPE_STRUCT_T(err_map_int_int_internal_Iterator)=
    TYPE_STRUCT_BEGIN(err_map_int_int_internal_Iterator)
        TYPE_STRUCT_SLOT(err_map_int_int_internal_Iterator, err_map_int_int_hashlist_t_p, cnode)
        TYPE_STRUCT_SLOT(err_map_int_int_internal_Iterator, int,      cslot)
    TYPE_STRUCT_END
;


TYPE_INFO_T(err_map_int_int_internal_Iterator)=
    TYPE_INFO_STRUCT (err_map_int_int_internal_Iterator, err_map_int_int_internal_Iterator);

static
TYPE_STRUCT_T(err_map_int_int_t)=
    TYPE_STRUCT_BEGIN(err_map_int_int_t)
#ifdef  ERR_MAP_INT_INT_SUPER_TYPE
        TYPE_SUPER(err_map_int_int_t, ERR_MAP_INT_INT_SUPER_CLASS),
#endif
        ERR_MAP_INT_INT_TYPE_INFO_STD_MEMBERS
        err_map_int_int_record_sig     (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_sig))
        err_map_int_int_record_table   (TYPE_STRUCT_SLOT(err_map_int_int_t, err_map_int_int_content_p,   m_table))
        err_map_int_int_record_sizes   (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_hashsize))
        err_map_int_int_record_sizes   (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_nentries))
        err_map_int_int_record_errno   (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_errno))
        err_map_int_int_record_zero    (TYPE_STRUCT_SLOT(err_map_int_int_t, int, m_zero))
        err_map_int_int_record_compat  (TYPE_STRUCT_SLOT(err_map_int_int_t, err_map_int_int_internal_Iterator, compat1_iter))
        err_map_int_int_record_profile (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_nrehash))
        err_map_int_int_record_profile (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_nrehashops))
        err_map_int_int_record_profile (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_nfind))
        err_map_int_int_record_profile (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_ninsert))
        err_map_int_int_record_profile (TYPE_STRUCT_SLOT(err_map_int_int_t, int,             m_ndelete))
    TYPE_STRUCT_END
;


TYPE_INFO_T(err_map_int_int_t)= TYPE_INFO_STRUCT (err_map_int_int_t, err_map_int_int_t);


TYPE_INFO_T(err_map_int_int_t_p)= TYPE_INFO_POINTER (err_map_int_int_t *, err_map_int_int_t);


TYPE_INFO_T(err_map_int_int_t_const_p)= TYPE_INFO_POINTER (err_map_int_int_t const *, err_map_int_int_t);
...
err_map_int_int_hashlist_t * err_map_int_int_hashlist_new_q
        (int  key, int  value)
{
    err_map_int_int_hashlist_t *self;
    E_SET_PTR(self, ERR_ERWIN_THING_NEW1 (err_map_int_int_hashlist_t));
...
void err_map_int_int_hashlist_delete
        (err_map_int_int_hashlist_t *list)
{
    err_map_int_int_hashlist_t *next;

    while (list) {
        IFREE (list->key);
        OFREE (list->value);
        E_SET_PTR(next, list->next);
        ERR_ERWIN_THING_DELETE1 (list, err_map_int_int_hashlist_t);
        E_SET_PTR(list, next);
    }
}
...
void err_map_int_int_hashlist_delete_flags
        (err_map_int_int_hashlist_t *list, ERR_ERWIN_BOOL keys, ERR_ERWIN_BOOL values)
{
    err_map_int_int_hashlist_t *next;
...
void err_map_int_int_hashlist_delete_no_child_delete
        (err_map_int_int_hashlist_t *list)
{
    err_map_int_int_hashlist_t *next;
...
void err_map_int_int_hashlist_delete_cell
        (err_map_int_int_hashlist_t *list)
{
    ERR_ERWIN_THING_DELETE1 (list, err_map_int_int_hashlist_t);
}
...
int err_map_int_int_hashlist_length
        (err_map_int_int_hashlist_t *list)
{
    int result= 0;
    while (list) {
...
int err_map_int_int_errno
        (err_map_int_int_t const *self)
{
...
void err_map_int_int_clear_errno
        (err_map_int_int_t const *self)
{
    return_if_null_or_bad (self);
    SET_ERRNO(E_OK);
...
ERR_ERWIN_BOOL err_map_int_int_init_internal_q
        (err_map_int_int_t *self, int  zero, int nelem)
{
    int size;
#ifndef NDEBUG
    int err= 0;
    ...
    if (nelem >= 0) { /* Compute hash size from expected number of elements: */
        size= ((nelem * ERR_MAP_INT_INT_TRIGGER_DENOMINATOR + ERR_MAP_INT_INT_TRIGGER_NUMERATOR - 1) / /* round up */
                ERR_MAP_INT_INT_TRIGGER_NUMERATOR * 2
              ) + 1;
    }

    if (size < 0)
        size= ERR_MAP_INT_INT_INITIAL_SIZE;

#if  ERR_MAP_INT_INT_HAVE_SIG
    self->m_sig= ERR_MAP_INT_INT_SIG;
#endif
    ...
    if (size == 1)    /* this means that the slot table is missing and we have a single list. */
        ...
        E_SET_PTR(self->m_table, ERR_ERWIN_THING_CNEW_ARRAY (err_map_int_int_content, (unsigned)size));
...
{
    err_map_int_int_init_internal_q (self, OZERO, ERR_MAP_INT_INT_INITIAL_SIZE);
    return e_errno;
}

CODE_SECTION(".text.init_with_initial_size")
int err_map_int_int_init_with_initial_size
        (err_map_int_int_t *self, int size)
{
    err_map_int_int_init_internal_q (self, OZERO, size);
    return e_errno;
}
...
int err_map_int_int_init_with_zero_and_initial_size
        (err_map_int_int_t *self, int  zero, int size)
{
    err_map_int_int_init_internal_q (self, zero, size);
    return e_errno;
}
...
err_map_int_int_t * err_map_int_int_new_with_zero_and_initial_size
        (int  zero, int size)
{
    err_map_int_int_t *self;

    E_SET_PTR(self, ERR_ERWIN_THING_NEW1 (err_map_int_int_t));
    SET_ERRNO(E_OK);
    ...
    if (ERWIN_LIKELY(err_map_int_int_init_internal_q (self, zero, size)))
       return self;

    ERR_ERWIN_THING_DELETE1 (self, err_map_int_int_t);
    return NULL;
}
...
err_map_int_int_t * err_map_int_int_new_with_zero
        (int  zero)
{
    return err_map_int_int_new_with_zero_and_initial_size (zero, ERR_MAP_INT_INT_INITIAL_SIZE);
}

#endif /* ERR_MAP_INT_INT_DYN_ZERO */

#if ERR_MAP_INT_INT_CONSTANT_ZERO
#define err_map_int_int_new_with_zero_and_initial_size(Z,S) err_map_int_int_new_with_initial_size(S)
#define err_map_int_int_new_with_zero(Z)                    err_map_int_int_new()
#endif
...
err_map_int_int_t * err_map_int_int_new_with_initial_size
        (int size)
{
    err_map_int_int_t *self;
    ...
    if (ERWIN_LIKELY(err_map_int_int_init_internal_q (self, OZERO, size)))
       return self;
...
err_map_int_int_t * err_map_int_int_new
        (void)
{
    return err_map_int_int_new_with_zero_and_initial_size (OZERO, ERR_MAP_INT_INT_INITIAL_SIZE);
}


CODE_SECTION(".text.zero")
o_type_result_t err_map_int_int_zero
        (err_map_int_int_t const *self)
{
    (void)self; /*unused*/
...
void err_map_int_int_struct_copy
        (err_map_int_int_t *copy, err_map_int_int_t const *self)
{
    int i;

    for (i= 0; i < self->m_hashsize; i++) {
       err_map_int_int_hashlist_t *lauf;
       E_SET_PTR(lauf, SLOT(self,i));
       while (lauf) {
           err_map_int_int_insert_q (copy, lauf->key, lauf->value);
...
err_map_int_int_t * err_map_int_int_copy
        (err_map_int_int_t const* self)
{
    err_map_int_int_t *copy;
    if (self == NULL) {
        SET_ERRNO(E_OK);
        return NULL;
    }
    ...
    E_SET_PTR(copy, err_map_int_int_new_with_zero_and_initial_size (ZERO(self), self->m_nentries));
    err_map_int_int_struct_copy (copy, self);
    return copy;
}

CODE_SECTION(".text.copy_err")
err_map_int_int_t * err_map_int_int_copy_err
        (err_map_int_int_t const* self, int *err)
{
    err_map_int_int_t *result;

    E_SET_PTR(result, err_map_int_int_copy (self));
...
int err_map_int_int_hash_size
        (err_map_int_int_t const* self)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return 0;
#endif
...
ERR_ERWIN_BOOL err_map_int_int_empty
        (err_map_int_int_t const* self)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
...
void err_map_int_int_clear_internal
        (err_map_int_int_t* self)
{
    int i;
    for (i=0; i < self->m_hashsize; i++) {
        err_map_int_int_hashlist_delete (SLOT(self,i));
        E_SET_PTR(SLOT(self,i), NULL);
    }
}

CODE_SECTION(".text.clear_no_resize")
void err_map_int_int_clear_no_resize
        (err_map_int_int_t* self)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    err_map_int_int_clear_internal (self);
...
void err_map_int_int_clear_internal_flags
        (err_map_int_int_t* self, ERR_ERWIN_BOOL keys, ERR_ERWIN_BOOL values)
{
    int i;
    for (i=0; i < self->m_hashsize; i++) {
        err_map_int_int_hashlist_delete_flags (SLOT(self,i), keys, values);
        E_SET_PTR (SLOT(self,i), NULL);
    }
}
        ...
        (err_map_int_int_t* self, ERR_ERWIN_BOOL keys, ERR_ERWIN_BOOL values)
{
    ...
    err_map_int_int_clear_internal_flags (self, keys, values);
    self->m_nentries= 0;
    SET_ERRNO(E_OK);
}
...
void err_map_int_int_destroy_internal
        (err_map_int_int_t* self)
{
    return_if_null2i_or_bad (self);
...
void err_map_int_int_xchg
        (err_map_int_int_t *self, err_map_int_int_t *other)
{
    err_map_int_int_record_table   (ERWIN_XCHG (err_map_int_int_content_p,   self->m_table,      other->m_table));
    err_map_int_int_record_sizes   (ERWIN_XCHG (int,             self->m_hashsize,   other->m_hashsize));
    err_map_int_int_record_sizes   (ERWIN_XCHG (int,             self->m_nentries,   other->m_nentries));
    err_map_int_int_record_errno   (ERWIN_XCHG (int,             self->m_errno,      other->m_errno));
    err_map_int_int_record_zero    (ERWIN_XCHG (int,        self->m_zero,       other->m_zero));
    err_map_int_int_record_compat  (ERWIN_XCHG (map_iterator_t,  self->compat1_iter, other->compat1_iter));
    err_map_int_int_record_profile (ERWIN_XCHG (int,             self->m_nrehash,    other->m_nrehash));
    err_map_int_int_record_profile (ERWIN_XCHG (int,             self->m_nrehashops, other->m_nrehashops));
    err_map_int_int_record_profile (ERWIN_XCHG (int,             self->m_nfind,      other->m_nfind));
    err_map_int_int_record_profile (ERWIN_XCHG (int,             self->m_ninsert,    other->m_ninsert));
    err_map_int_int_record_profile (ERWIN_XCHG (int,             self->m_ndelete,    other->m_ndelete));
}

ERWIN_STATIC_INLINE
CODE_SECTION(".text.destroy_internal_flags")
void err_map_int_int_destroy_internal_flags
        (
    err_map_int_int_t* self,
    ...
    ERR_ERWIN_BOOL destroy_values)
{
    ...
    err_map_int_int_clear_internal_flags (self, destroy_keys, destroy_values);
    FREE_TABLE(self);
...
void err_map_int_int_destroy
        (err_map_int_int_t* self)
{
    err_map_int_int_destroy_internal (self);
}

CODE_SECTION(".text.destroy_flags")
void err_map_int_int_destroy_flags
        (err_map_int_int_t* self, ERR_ERWIN_BOOL k, ERR_ERWIN_BOOL v)
{
    err_map_int_int_destroy_internal_flags (self, k, v);
}
...
void err_map_int_int_delete_flags
        (
    err_map_int_int_t* self, ERR_ERWIN_BOOL destroy_keys, ERR_ERWIN_BOOL destroy_values)
{
    if (self != NULL) {
        err_map_int_int_destroy_internal_flags (self, destroy_keys, destroy_values);
        ERR_ERWIN_THING_DELETE1 (self, err_map_int_int_t);
    }
}

CODE_SECTION(".text.delete")
void err_map_int_int_delete
        (err_map_int_int_t* self)
{
    if (self != NULL) {
        err_map_int_int_destroy_internal (self);
...
ERR_ERWIN_BOOL err_map_int_int_expect_size
        (err_map_int_int_t *self, int newsize)
{
    int new_hash_size;
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    if (TOOSMALL(newsize, new_hash_size)) {
        ...
        if (new_hash_size <= 1) {
             ...
             * this too small. :-) */
            if (newsize <= ERR_MAP_INT_INT_PLAIN_LIST_LENGTH)
                return ERR_ERWIN_FALSE;
        }
#endif
        ...
        err_map_int_int_rehash (self, new_hash_size);
    ...
    if (TOOLARGE(newsize, new_hash_size)) {
...
#endif
        {
            ...
            if (new_hash_size < ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1)
                new_hash_size= ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1;
        }
...
ERR_ERWIN_BOOL err_map_int_int_shrink_perhaps
        (err_map_int_int_t *self)
{
...
#if ERR_MAP_INT_INT_ZERO_SIZE
        if (self->m_nentries <= ERR_MAP_INT_INT_PLAIN_LIST_LENGTH)
            newsize= 1;
        else
#endif
        {
            ...
            if (newsize < ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1)
                newsize= ERR_MAP_INT_INT_MINIMAL_SIZE_OR_1;
        }

        err_map_int_int_rehash (self, newsize);
...
void err_map_int_int_clear_flags
        (err_map_int_int_t* self, ERR_ERWIN_BOOL keys, ERR_ERWIN_BOOL values)
{
    err_map_int_int_clear_flags_no_resize (self, keys, values);
    err_map_int_int_shrink_perhaps (self);
}
...
#endif
    err_map_int_int_clear_no_resize(self);
    err_map_int_int_shrink_perhaps (self);
    SET_ERRNO(E_OK);
}
...
unsigned err_map_int_int_slot_no
        (err_map_int_int_t const *self, int  key)
{
    int slot;
    return0_if_null (self);
...
err_map_int_int_hashlist_t ** err_map_int_int_find_internal_ptr
        (err_map_int_int_t const* self, int  key)
{
    err_map_int_int_hashlist_t **lauf;
#ifdef E_PROFILE
    ...
    E_SET_PTR(lauf, &SLOT(self, err_map_int_int_slot_no (self, key)));
    while (*lauf) {
...
err_map_int_int_hashlist_t * err_map_int_int_find_internal
        (err_map_int_int_t const* self, int  key)
{
    err_map_int_int_hashlist_t **result;

    E_SET_PTR(result, err_map_int_int_find_internal_ptr (self, key));
#if ERR_MAP_INT_INT_ALLOW_NULL
    if (result == NULL)
        return NULL;
#endif
...
err_map_int_int_element_ptr_t err_map_int_int_find_ptr
        (err_map_int_int_t const* self, int  key)
{
    err_map_int_int_hashlist_t *lauf;

    E_SET_PTR(lauf, err_map_int_int_find_internal (self, key));
    if (lauf == NULL) {
 ...
 *        err_map_int_int_ensure which currently evaluates ENSURE_VALUE to often).
 *
...
int err_map_int_int_poke_internal_q
        (
        int                *key_out,
        int             *value_out,
        err_map_int_int_t                *self,
        ...
        ERR_ERWIN_BOOL     overwrite)
{
    ...
    E_SET_PTR(lauf, err_map_int_int_find_internal_ptr (self, key));
#if ERR_MAP_INT_INT_ALLOW_NULL
...
#endif
    {
        ...
        if (introduce) {
            ...
            if (err_map_int_int_grow_perhaps (self)) {
                E_SET_PTR(lauf, err_map_int_int_find_internal_ptr (self, key));
            }
            ...
            if (dovaluecopy) {
                ...
                if (dokeycopy) {
                    ...
                    E_SET_PTR(*lauf, err_map_int_int_hashlist_new (keycopy, valuecopy));
                    ...
                    E_SET_PTR(*lauf, err_map_int_int_hashlist_new (givenkeycopy, valuecopy));
            ...
            else
            {
                if (dokeycopy) {
                    ...
                    E_SET_PTR(*lauf, err_map_int_int_hashlist_new_q (keycopy, givenvaluecopy));
                    ...
                    E_SET_PTR(*lauf, err_map_int_int_hashlist_new_q (givenkeycopy, givenvaluecopy));
    ...
    ERR_ERWIN_BOOL i, ERR_ERWIN_BOOL o)
{
    ...
    return err_map_int_int_poke_internal_q (ko,vo,self, k,IZEROVAR,ERR_ERWIN_TRUE, v,ZEROVAR(self),ERR_ERWIN_TRUE, i,o);
}

CODE_SECTION(".text.poke_no_icopy_q")
int err_map_int_int_poke_no_icopy_q
        (
    int *ko, int *vo, err_map_int_int_t *self, int  k, int  v, ERR_ERWIN_BOOL i, ERR_ERWIN_BOOL o)
{
    return_val_if_null_or_bad (self, ASSERTION_FAILED);
    return err_map_int_int_poke_internal_q (ko,vo,self, k,k,ERR_ERWIN_FALSE, v,ZEROVAR(self),ERR_ERWIN_TRUE, i,o);
}
...
int err_map_int_int_poke_no_ocopy
    ...
    int *ko, int *vo, err_map_int_int_t *self, int  k, int  v, ERR_ERWIN_BOOL i, ERR_ERWIN_BOOL o)
{
    return err_map_int_int_poke_internal (ko,vo,self, k,IZEROVAR,ERR_ERWIN_TRUE, v,v,ERR_ERWIN_FALSE, i,o);
}
...
int err_map_int_int_poke_no_icopy_no_ocopy
    ...
    int *ko, int *vo, err_map_int_int_t *self, int  k, int  v, ERR_ERWIN_BOOL i, ERR_ERWIN_BOOL o)
{
    return err_map_int_int_poke_internal (ko, vo, self, k,k,ERR_ERWIN_FALSE, v,v,ERR_ERWIN_FALSE, i,o);
}
...
o_type_result_t err_map_int_int_find
        (err_map_int_int_t const* self, int  key)
{
    err_map_int_int_hashlist_t *lauf;

#if defined(ERR_MAP_INT_INT_ALLOW_NULL) && ERR_MAP_INT_INT_CONSTANT_ZERO
    if (self == NULL) {
        SET_ERRNO(E_KEYNOTFOUND);
        return OZERO;
    }
...
o_type_result_t err_map_int_int_find_ensure
        (err_map_int_int_t * self, int  key)
{
    err_map_int_int_element_ptr_t result;
    E_SET_PTR(result, err_map_int_int_find_ptr_ensure (self, key));
#if !ERR_MAP_INT_INT_NOMEM_IS_FATAL
...
i_type_result_t err_map_int_int_find_key
        (err_map_int_int_t const* self, int  key)
{
    err_map_int_int_hashlist_t *lauf;
...
o_type_var_t err_map_int_int_modify
        (err_map_int_int_t *self, int  key, int  value)
{
...
ATTR_FLATTEN
int err_map_int_int_set
        (err_map_int_int_t *self, int  key, int  value)
{
    return0_if_null (self);
    return err_map_int_int_poke_internal (
            NULL,NULL,self,
...
err_map_int_int_element_ptr_t err_map_int_int_find_ptr_ensure
        (err_map_int_int_t *self, int  key)
/* NOTE: This cannot be implemented with _poke_internal, since it
 *       returns a pointer to an internal structure. */
/* FIXME: extract common parts from err_map_int_int_ensure and err_map_int_int_find_ptr_ensure,
 *        which do essentially the same. */
{
    ...
    SET_ERRNO(E_OK);
    if (*lauf == NULL) {
        if (ERWIN_UNLIKELY(err_map_int_int_grow_perhaps (self))) {
            E_SET_PTR(lauf, err_map_int_int_find_internal_ptr (self, key));
            return0_if_null_pp (lauf, self);
...

        {
            ...
            {
                int valuecopy;
                E_SET_VALUE (valuecopy, ERR_MAP_INT_INT_ENSURE_VALUE(self, key, &copyerror));
                if (ERWIN_UNLIKELY(OCOPY_PROVIDED && copyerror)) {
                    IFREE (keycopy);
                    MAP_NOMEM;
                    return NULL;
...
int err_map_int_int_insert_no_copy_no_rehash_q
        (
        err_map_int_int_t* self,
        int keycopy,
        int valuecopy)
 ...
 *       delete keycopy or valuecopy! */
{
    ...
    E_SET_PTR(lauf, err_map_int_int_find_internal_ptr (self, keycopy));
    return_val_if_null_pp (lauf, ASSERTION_FAILED, self);

    if (*lauf != NULL)
        return PASS_ERRNO(E_EXISTINGKEY);

    E_SET_PTR(*lauf, err_map_int_int_hashlist_new_q (keycopy, valuecopy));
...
ATTR_FLATTEN
int err_map_int_int_insert_q
        (err_map_int_int_t* self, int  key, int  value)
{
    return_val_if_null_or_bad (self, ASSERTION_FAILED);
    return err_map_int_int_poke_internal_q (
                NULL, NULL, self,
                key,   IZEROVAR, ERR_ERWIN_TRUE,
                value, ZEROVAR(self), ERR_ERWIN_TRUE,
...
int err_map_int_int_insert_map
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    int i;
    int total_errno;
    ...
    for (i= 0; i < other->m_hashsize; i++) {
       ...
       while (lauf) {
           err_map_int_int_insert_q (self, lauf->key, lauf->value);
           if (e_errno != E_OK)
        ...
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    ...
    for (i= 0; i < other->m_hashsize; i++) {
       ...
       E_SET_PTR (lauf, SLOT(other,i));
       while (lauf) {
           err_map_int_int_set (self, lauf->key, lauf->value);
           if (e_errno != E_OK)
               total_errno= e_errno; /* this does not break, it tries to do as
                                      * much as possible. */
           E_SET_PTR (lauf, lauf->next);
...
int err_map_int_int_modify_map
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    int i;
    int total_errno;
    ...
    for (i= 0; i < other->m_hashsize; i++) {
       ...
       E_SET_PTR (lauf, SLOT(other,i));
       while (lauf) {
           err_map_int_int_modify (self, lauf->key, lauf->value);
           if (e_errno != E_OK)
               total_errno= e_errno; /* this does not break, it tries to do as
                                      * much as possible. */
           E_SET_PTR (lauf, lauf->next);
        ...
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    ...
    for (i= 0; i < other->m_hashsize; i++) {
       ...
       E_SET_PTR (lauf, SLOT(other,i));
       while (lauf) {
           err_map_int_int_erase (self, lauf->key);
           if (e_errno != E_OK)
               total_errno= e_errno; /* this does not break, it tries to do as
                                      * much as possible. */
           E_SET_PTR (lauf, lauf->next);
...
int err_map_int_int_erase_map_no_resize
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    int i;
    int total_errno;
    ...
    for (i= 0; i < other->m_hashsize; i++) {
       ...
       E_SET_PTR (lauf, SLOT(other,i));
       while (lauf) {
           err_map_int_int_erase_no_resize (self, lauf->key);
           if (e_errno != E_OK)
               total_errno= e_errno; /* this does not break, it tries to do as
                                      * much as possible. */
           E_SET_PTR (lauf, lauf->next);
...
int err_map_int_int_intersect_no_resize
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    int i;
    int cnt;
    ...
    for (i= 0; i < self->m_hashsize; i++) {
        ...
        E_SET_PTR (lauf, &SLOT(self,i));
        while (*lauf) {
            (void)err_map_int_int_find (other, (*lauf)->key);
            if (e_errno != E_OK) {
                 err_map_int_int_hashlist_t *cell;
                 E_SET_PTR (cell,  *lauf);
                 E_SET_PTR (*lauf, (*lauf)->next);

                 IFREE (cell->key);
                 OFREE (cell->value);
                 err_map_int_int_hashlist_delete_cell (cell);
                 self->m_nentries--;
                 cnt++;
            }
            else
...
int err_map_int_int_intersect
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    int cnt= err_map_int_int_intersect_no_resize (self, other);
    err_map_int_int_shrink_perhaps (self);
    return cnt;
}
...
i_type_result_t err_map_int_int_ensure
        (err_map_int_int_t *self, int  key)
{
    err_map_int_int_hashlist_t **lauf;
...
i_type_result_t err_map_int_int_ensure_no_icopy
        (err_map_int_int_t *self, int  key)
{
    err_map_int_int_hashlist_t **lauf;
    ...
    if (*lauf == NULL) {
...

        {
            ...
            E_SET_PTR (*lauf, err_map_int_int_hashlist_new_q (key, valuecopy));
            if (ERWIN_UNLIKELY(*lauf == NULL)) {
                OFREE (valuecopy);
                MAP_NOMEM;
                return IZERO;
...
ERR_ERWIN_BOOL err_map_int_int_remove_internal_no_resize_q
        (
    err_map_int_int_t *self,
    int  key,
    int *result)
...
ERR_ERWIN_BOOL err_map_int_int_remove_internal_q
        (
    err_map_int_int_t *self,
    int  key,
    int *result)
{
    ...
    return err_map_int_int_remove_internal_no_resize_q (self, key, result);
}

CODE_SECTION(".text.remove")
o_type_var_t err_map_int_int_remove
        (err_map_int_int_t *self, int  key)
{
    int result;
#if defined(ERR_MAP_INT_INT_ALLOW_NULL) && ERR_MAP_INT_INT_CONSTANT_ZERO
...
#endif
    if (err_map_int_int_remove_internal_q (self, key, &result))
        return result;
    return ZEROVAR(self);
}
...
o_type_var_t err_map_int_int_remove_no_resize
        (err_map_int_int_t *self, int  key)
{
    int result;
#if defined(ERR_MAP_INT_INT_ALLOW_NULL) && ERR_MAP_INT_INT_CONSTANT_ZERO
...
#endif
    if (err_map_int_int_remove_internal_no_resize_q (self, key, &result))
        return result;
    return ZEROVAR(self);
}
...
int err_map_int_int_remove_map
        (err_map_int_int_t* self, err_map_int_int_t const *other)
{
    int i;
    int total_errno;
    ...
    for (i= 0; i < other->m_hashsize; i++) {
       ...
       E_SET_PTR (lauf, SLOT(other,i));
       while (lauf) {
           err_map_int_int_remove (self, lauf->key);
           if (e_errno != E_OK)
               total_errno= e_errno; /* this does not break, it tries to do as
                                      * much as possible. */
           E_SET_PTR (lauf, lauf->next);
...
int err_map_int_int_remove_if
        (err_map_int_int_t *self, err_map_int_int_feature_t feature, ERR_ERWIN_BOOL value)
{
    int slot;
    int cnt= 0;
...
int err_map_int_int_erase_no_resize
        (err_map_int_int_t *self, int  key)
{
    int result;
#if defined(ERR_MAP_INT_INT_ALLOW_NULL) && ERR_MAP_INT_INT_CONSTANT_ZERO
        ...
        (err_map_int_int_t* self, int newsize)
{
    ...
    if (newsize != self->m_hashsize) {
        int i;
        err_map_int_int_content_p newtable;
        ...
        if (newsize == 1) {
            ...
            E_SET_PTR (newtable, ERR_ERWIN_THING_CNEW_ARRAY (err_map_int_int_content, (unsigned)newsize));
        ...
        for (i=0; i < self->m_hashsize; i++) {
            ...
            while (lauf != NULL) {
                err_map_int_int_hashlist_t *next;
                err_map_int_int_hashlist_t **newcell= &GET_SLOT(
                                      newtable,
                                      newsize,
...
err_map_int_int_hashlist_t * err_map_int_int_first_internal
        (err_map_int_int_t const *self, e_iterator_t *iter)
{
...
err_map_int_int_hashlist_t * err_map_int_int_next_internal
        (err_map_int_int_t const*self, e_iterator_t *iter)
{
    if (ERWIN_UNLIKELY(ITER->cslot == -1))
        return err_map_int_int_first_internal (self, iter);
...
void err_map_int_int_init_iterator
        (err_map_int_int_t const *self, e_iterator_t *iter)
{
    (void)self; /*unused*/

#ifndef ERR_MAP_INT_INT_ALLOW_NULL
    return_if_null_or_bad (self);
#endif
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_keys
        (void const *a, void const *b)
{
    ...
    (void)b; /*unused*/
#ifdef ICMP
#define err_map_int_int_check_cmp_keys
#define err_map_int_int_check0_cmp_keys
    return ICMP ((((err_map_int_int_pair_t*)a)->key),(((err_map_int_int_pair_t*)b)->key));
#else
#define err_map_int_int_check_cmp_keys \
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_keys_ptr
        (void const *a, void const *b)
{
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    (void)a; /*unused*/
    (void)b; /*unused*/
#ifdef ICMP
#define err_map_int_int_check_cmp_keys_ptr
#define err_map_int_int_check0_cmp_keys_ptr
    return ICMP ((((err_map_int_int_pair_ptr_t*)a)->key),(((err_map_int_int_pair_ptr_t*)b)->key));
#else
#define err_map_int_int_check_cmp_keys_ptr \
    return_if_reached_pt ("ICMP is not implemented.  Sorting keys is not possible.")
#define err_map_int_int_check0_cmp_keys_ptr \
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_values
        (void const *a, void const *b)
{
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    (void)a; /*unused*/
    (void)b; /*unused*/
#ifdef OCMP
#define err_map_int_int_check_cmp_values
#define err_map_int_int_check0_cmp_values
    return OCMP ((((err_map_int_int_pair_t*)a)->value),(((err_map_int_int_pair_t*)b)->value));
#else
#define err_map_int_int_check_cmp_values \
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_values_ptr
        (void const *a, void const *b)
{
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    (void)a; /*unused*/
    (void)b; /*unused*/
#ifdef OCMP
#define err_map_int_int_check_cmp_values_ptr
#define err_map_int_int_check0_cmp_values_ptr
    return OCMP ((*(((err_map_int_int_pair_ptr_t*)a)->value)),(*(((err_map_int_int_pair_ptr_t*)b)->value)));
#else
#define err_map_int_int_check_cmp_values_ptr \
    return_if_reached_pt ("OCMP is not implemented.  Sorting values is not possible.")
#define err_map_int_int_check0_cmp_values_ptr \
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_values_and_keys
        (void const *a, void const *b)
{
    int result;
    (void)a; /*unused*/
...
#define err_map_int_int_check_cmp_values_and_keys
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    result= OCMP ((((err_map_int_int_pair_t*)a)->value),(((err_map_int_int_pair_t*)b)->value));
    if (result == 0)
        result= ICMP ((((err_map_int_int_pair_t*)a)->key),(((err_map_int_int_pair_t*)b)->key));
#else
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
#define err_map_int_int_check_cmp_values_and_keys \
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_values_and_keys_ptr
        (void const *a, void const *b)
{
    int result;
    (void)a; /*unused*/
...
#if defined(OCMP) && defined(ICMP)
#define err_map_int_int_check_cmp_values_and_keys_ptr
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    result= OCMP ((*(((err_map_int_int_pair_ptr_t*)a)->value)),(*(((err_map_int_int_pair_ptr_t*)b)->value)));
    if (result == 0)
        result= ICMP ((((err_map_int_int_pair_ptr_t*)a)->key),(((err_map_int_int_pair_ptr_t*)b)->key));
#else
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
#define err_map_int_int_check_cmp_values_and_keys_ptr \
    return_if_reached_pt ("OCMP or ICMP is not implemented.  Sorting values is not possible.");
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_keys_and_values
        (void const *a, void const *b)
{
    int result;
    (void)a; /*unused*/
...
#if defined(OCMP) && defined(ICMP)
#define err_map_int_int_check_cmp_keys_and_values
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    result= ICMP ((((err_map_int_int_pair_t*)a)->key),(((err_map_int_int_pair_t*)b)->key));
    if (result == 0)
        result= OCMP ((((err_map_int_int_pair_t*)a)->value),(((err_map_int_int_pair_t*)b)->value));
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_cmp_keys_and_values_ptr
        (void const *a, void const *b)
{
    int result;
    (void)a; /*unused*/
...
#if defined(OCMP) && defined(ICMP)
#define err_map_int_int_check_cmp_keys_and_values_ptr
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    result= ICMP ((((err_map_int_int_pair_ptr_t*)a)->key),(((err_map_int_int_pair_ptr_t*)b)->key));
    if (result == 0)
        result= OCMP ((*(((err_map_int_int_pair_ptr_t*)a)->value)),(*(((err_map_int_int_pair_ptr_t*)b)->value)));
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_detcmp_keys
        (void const *a, void const *b)
{
    int result;
    (void)a; /*unused*/
...
#  define err_map_int_int_detcmp_pairs     err_map_int_int_pair_cmp_keys
#  define err_map_int_int_detcmp_pairs_ptr err_map_int_int_pair_cmp_keys_ptr
#else
#  define ERR_MAP_INT_INT_DET_SORT_PROVIDED 1
#endif

#ifndef ERR_MAP_INT_INT_DET_SORT_PROVIDED
#  define ERR_MAP_INT_INT_DET_SORT_PROVIDED 0
#endif

#if ODETCMP_PROVIDED || ERR_MAP_INT_INT_DET_SORT_PROVIDED
#  define ERR_MAP_INT_INT_ODET_REQUIRE 1
#endif

#ifndef ERR_MAP_INT_INT_ODET_REQUIRE
#  define ERR_MAP_INT_INT_ODET_REQUIRE 0
#endif
...
ATTR_FUNC_UNUSED
int err_map_int_int_pair_detcmp_values
        (void const *a, void const *b)
{
    int result;
    (void)a; /*unused*/
...
#if ERR_MAP_INT_INT_DET_SORT_PROVIDED
    ...
    result= OCMP (*((int const*)a), *((int const*)b));
#else
#define err_map_int_int_check_detcmp_values \
    return0_if_reached_pt ("Need ERR_INT_DETCMP or ERR_INT_CMP to enforce determinism on err_map_int_int.  Try to '#define ERR_INT_DETCMP(x,y) false_if_reached_pk(ERR_INT_DETCMP)' if you think you never invoke it.");
    result=0;
#endif

#ifndef err_map_int_int_check_detcmp_values
#define err_map_int_int_check_detcmp_values
#endif /* !defined err_map_int_int_check_detcmp_values */
...
ATTR_FUNC_UNUSED
int err_map_int_int_detcmp_pairs
        (void const *a, void const *b)
{
    ...
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    result= IDETCMP ((((err_map_int_int_pair_t*)a)->key),(((err_map_int_int_pair_t*)b)->key));

    if (result == 0)
        result= ODETCMP ((((err_map_int_int_pair_t*)a)->value),(((err_map_int_int_pair_t*)b)->value));
...
ATTR_FUNC_UNUSED
int err_map_int_int_detcmp_pairs_ptr
        (void const *a, void const *b)
{
    /* This uses paranoid paranoid, perhaps duplicate comparisons.  But the user
     * wants determinism and we try to enforce that in any way.  It may be slower,
    ...
    /* return0_if_null2 (a,b);  needs self via ASSERTION_FAILED when THREAD_SAFE */
    result= IDETCMP ((((err_map_int_int_pair_ptr_t*)a)->key),(((err_map_int_int_pair_ptr_t*)b)->key));

    if (result == 0)
        result= ODETCMP ((*(((err_map_int_int_pair_ptr_t*)a)->value)),(*(((err_map_int_int_pair_ptr_t*)b)->value)));
...
#endif /* ERR_MAP_INT_INT_DET_SORT_PROVIDED */
...
void err_map_int_int_det_sort
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    qsort ((void*)SORTITER->table,
           self->m_nentries,
           sizeof (err_map_int_int_pair_t),
           err_map_int_int_detcmp_pairs);
}


ERWIN_STATIC_INLINE_SPEED
CODE_SECTION(".text.det_sort_ptr")
void err_map_int_int_det_sort_ptr
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    qsort ((void*)SORTITERPTR->table,
           self->m_nentries,
           sizeof (err_map_int_int_pair_ptr_t),
           err_map_int_int_detcmp_pairs_ptr);
}
...
void err_map_int_int_free_sorted_iterator
        (void *iter)
{
    err_map_int_int_delete_entries (SORTITER->table);
}


static
CODE_SECTION(".text.free_sorted_iterator_ptr")
void err_map_int_int_free_sorted_iterator_ptr
        (void *iter)
{
    err_map_int_int_delete_entries_ptr (SORTITERPTR->table);
}


CODE_SECTION(".text.init_iterator_sorted_by_key")
void err_map_int_int_init_iterator_sorted_by_key
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (SORTITER->table, err_map_int_int_get_entries (self));
        SORTITER->count= 0;
        SORTITER->lauf=  0;
        E_SET_PTR (SORTITER->free_cb, err_map_int_int_free_sorted_iterator);
        return;
    }
#else
    return_if_null_or_bad (self);
#endif
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_keys;
    ...
    return_if_fail_pp ((void*)SORTITER_VOLATILE->free_cb == (void*)err_map_int_int_free_sorted_iterator, self);
    ...
    if (e_require_determinism ()) {
        err_map_int_int_det_sort (self, iter);
        e_merge_sort ((void*)SORTITER->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_t),
               err_map_int_int_pair_cmp_keys);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_sorted_by_value
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_values;
    ...
    return_if_null_pp2 (SORTITER_VOLATILE->p,
        SORTITER, self);
    return_if_fail_pp2 ((void*)SORTITER_VOLATILE->free_cb == (void*)err_map_int_int_free_sorted_iterator,
        SORTITER, self);
    ...
    if (e_require_determinism ()) {
        ...
        e_merge_sort ((void*)SORTITER->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_t),
               err_map_int_int_pair_cmp_values);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_sorted_by_value_and_key
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_values_and_keys;
...
#if ERR_MAP_INT_INT_ODET_REQUIRE
    ...
    if (e_require_determinism ()) {
        ...
        e_merge_sort ((void*)SORTITER->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_t),
               err_map_int_int_pair_cmp_values_and_keys);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_sorted_by_key_and_value
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_keys_and_values;
    ...
    if (e_require_determinism ()) {
        ...
        e_merge_sort ((void*)SORTITER->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_t),
               err_map_int_int_pair_cmp_keys_and_values);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_sorted_by_user
        (
    err_map_int_int_t const *self,
    e_iterator_sorted_t *iter,
    err_map_int_int_pair_cmp_t u)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (SORTITER->table, err_map_int_int_get_entries (self));
...
void err_map_int_int_init_iterator_ptr_sorted_by_key
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (SORTITERPTR->table, err_map_int_int_get_entries_ptr (self));
        SORTITERPTR->count= 0;
        SORTITERPTR->lauf=  0;
        E_SET_PTR (SORTITERPTR->free_cb, err_map_int_int_free_sorted_iterator_ptr);
        return;
    }
#endif
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_keys_ptr;
    ...
    return_if_null_pp2 (SORTITER_VOLATILE->p,
        SORTITER, self);
    return_if_fail_pp2 ((void*)SORTITER_VOLATILE->free_cb == (void*)err_map_int_int_free_sorted_iterator_ptr,
        SORTITER, self);
     ...
     * we still need to pre-sort and use (the stable) merge sort.  */
    if (e_require_determinism ()) {
        err_map_int_int_det_sort_ptr (self, iter);
        e_merge_sort ((void*)SORTITERPTR->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_ptr_t),
               err_map_int_int_pair_cmp_keys_ptr);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_ptr_sorted_by_value
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_values_ptr;
    ...
    if (e_require_determinism ()) {
        ...
        e_merge_sort ((void*)SORTITERPTR->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_ptr_t),
               err_map_int_int_pair_cmp_values_ptr);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_ptr_sorted_by_value_and_key
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_values_and_keys_ptr;
    ...
    if (e_require_determinism ()) {
        ...
        e_merge_sort ((void*)SORTITERPTR->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_ptr_t),
               err_map_int_int_pair_cmp_values_and_keys_ptr);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_ptr_sorted_by_key_and_value
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
    ...
    return_if_null_or_bad (self);
    return_if_null_pp (iter, self);
    err_map_int_int_check_cmp_keys_and_values_ptr;
    ...
    if (e_require_determinism ()) {
        ...
        e_merge_sort ((void*)SORTITERPTR->table,
               self->m_nentries,
               sizeof (err_map_int_int_pair_ptr_t),
               err_map_int_int_pair_cmp_keys_and_values_ptr);
    }
    else
#endif
    {
...
void err_map_int_int_init_iterator_ptr_sorted_by_user
        (
    err_map_int_int_t const *self,
    e_iterator_sorted_t *iter,
    err_map_int_int_pair_ptr_cmp_t u)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (SORTITERPTR->table, err_map_int_int_get_entries_ptr (self));
...
void err_map_int_int_init_iterator_sorted_by_key_reverse
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_sorted_by_key (self, iter);
    SORTITER->lauf= SORTITER->count;
}


CODE_SECTION(".text.init_iterator_sorted_by_value_reverse")
void err_map_int_int_init_iterator_sorted_by_value_reverse
        (err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_sorted_by_value (self, iter);
    SORTITER->lauf= SORTITER->count;
}
...
void err_map_int_int_init_iterator_sorted_by_value_and_key_reverse
    ...
    err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_sorted_by_value_and_key (self, iter);
    SORTITER->lauf= SORTITER->count;
}
...
void err_map_int_int_init_iterator_sorted_by_key_and_value_reverse
    ...
    err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_sorted_by_key_and_value (self, iter);
    SORTITER->lauf= SORTITER->count;
}
...
void err_map_int_int_init_iterator_sorted_by_user_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_pair_cmp_t u)
{
    err_map_int_int_init_iterator_sorted_by_user (self, iter, u);
    SORTITER->lauf= SORTITER->count;
}


CODE_SECTION(".text.init_iterator_ptr_sorted_by_key_reverse")
void err_map_int_int_init_iterator_ptr_sorted_by_key_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_ptr_sorted_by_key (self, iter);
    SORTITERPTR->lauf= SORTITERPTR->count;
}


CODE_SECTION(".text.init_iterator_ptr_sorted_by_value_reverse")
void err_map_int_int_init_iterator_ptr_sorted_by_value_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_ptr_sorted_by_value (self, iter);
    SORTITERPTR->lauf= SORTITERPTR->count;
}
...
void err_map_int_int_init_iterator_ptr_sorted_by_value_and_key_reverse
    ...
    err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_ptr_sorted_by_value_and_key (self, iter);
    SORTITERPTR->lauf= SORTITERPTR->count;
}
...
void err_map_int_int_init_iterator_ptr_sorted_by_key_and_value_reverse
    ...
    err_map_int_int_t const *self, e_iterator_sorted_t *iter)
{
    err_map_int_int_init_iterator_ptr_sorted_by_key_and_value (self, iter);
    SORTITERPTR->lauf= SORTITERPTR->count;
}
...
void err_map_int_int_init_iterator_ptr_sorted_by_user_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_pair_ptr_cmp_t u)
{
    err_map_int_int_init_iterator_ptr_sorted_by_user (self, iter, u);
    SORTITERPTR->lauf= SORTITERPTR->count;
}


CODE_SECTION(".text.next_iteration_sorted")
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted
        (err_map_int_int_t const *self,
                                e_iterator_sorted_t *iter,
                                int *keyp,
                                int *valuep)
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_ptr
        (err_map_int_int_t const *self,
                                e_iterator_sorted_t *iter,
                                int *keyp,
                                err_map_int_int_element_ptr_t *valuepp)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_keys
        (err_map_int_int_t const *self,
                                e_iterator_sorted_t *iter,
                                int *keyp)
{
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_values
        (err_map_int_int_t const *self,
                                e_iterator_sorted_t *iter,
                                int *valuep)
{
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_values_ptr
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_element_ptr_t *valuepp)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_pairs
        (err_map_int_int_t const *self,
                                e_iterator_sorted_t *iter,
                                err_map_int_int_pair_t *p)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_pairs_ptr
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_pair_ptr_t *p)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, int *keyp, int *valuep)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_ptr_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, int *keyp, err_map_int_int_element_ptr_t *valuepp)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_keys_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, int *keyp)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_values_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, int *valuep)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_values_ptr_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_element_ptr_t *valuepp)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_pairs_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_pair_t *p)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
        return ERR_ERWIN_FALSE;
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_sorted_pairs_ptr_reverse
        (
    err_map_int_int_t const *self, e_iterator_sorted_t *iter, err_map_int_int_pair_ptr_t *p)
{
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration
        (
    err_map_int_int_t const*self,
    e_iterator_t *iter,
    int *keyp,
    int *valuep)
{
    ...
    E_SET_PTR (it, err_map_int_int_next_internal (self, iter));
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_values
        (
    err_map_int_int_t const *self,
    e_iterator_t *iter,
    int *valuep)
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_keys
        (err_map_int_int_t const *self, e_iterator_t *iter, int *keyp)
{
    err_map_int_int_hashlist_t *it;
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_pairs
        (err_map_int_int_t const *self, e_iterator_t *iter, err_map_int_int_pair_t *pairp)
{
    err_map_int_int_hashlist_t *it;
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_ptr
        (
    err_map_int_int_t const*self,
    e_iterator_t *iter,
    int *keyp,
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_values_ptr
        (
    err_map_int_int_t const *self,
    e_iterator_t *iter,
    err_map_int_int_element_ptr_t *valuepp)
...
ERR_ERWIN_BOOL err_map_int_int_next_iteration_pairs_ptr
        (err_map_int_int_t const *self, e_iterator_t *iter, err_map_int_int_pair_ptr_t *pairp)
{
    err_map_int_int_hashlist_t *it;
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL)
...
err_map_int_int_pair_t * err_map_int_int_get_entries
        (err_map_int_int_t const *self)
{
    struct _err_map_int_int_pair_t *result, *rlauf;
    int    i;

#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (result, PAIR_NEW_ARRAY (err_map_int_int_pair_dynarray, 1));
    ...
    E_SET_PTR (result, PAIR_NEW_ARRAY (err_map_int_int_pair_dynarray, self->m_nentries+1));
    ...
    if (e_require_determinism ())
        qsort (result,
               self->m_nentries,
               sizeof (err_map_int_int_pair_t),
               (int(*)(void const *, void const *))err_map_int_int_detcmp_pairs);
#endif
...
err_map_int_int_pair_ptr_t * err_map_int_int_get_entries_ptr
        (err_map_int_int_t const*self)
{
    struct _err_map_int_int_pair_ptr_t *result, *rlauf;
    int    i;

#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (result, ERR_ERWIN_THING_NEW_ARRAY (err_map_int_int_pair_ptr_dynarray, 1));
        if (result == NULL) {
            MAP_NOMEM;
            return NULL;
        }
    ...
    E_SET_PTR (result, ERR_ERWIN_THING_NEW_ARRAY (err_map_int_int_pair_ptr_dynarray, self->m_nentries+1));
    E_SET_PTR (rlauf,  result);
    if (ERWIN_UNLIKELY(result == NULL)) {
        MAP_NOMEM;
        return NULL;
    ...
    if (e_require_determinism ())
        qsort (result,
               self->m_nentries,
               sizeof (err_map_int_int_pair_ptr_t),
               (int(*)(void const *, void const *))err_map_int_int_detcmp_pairs_ptr);
#endif
...
o_type_t * err_map_int_int_get_values
        (err_map_int_int_t const *self)
{
    int *result;
    int *rlauf;
...
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (result, VALUE_NEW_ARRAY (err_map_int_int_value_dynarray, 1));
        if (ERWIN_UNLIKELY(result == NULL)) {
            MAP_NOMEM;
            return NULL;
        }
    ...
    E_SET_PTR (result, VALUE_NEW_ARRAY (err_map_int_int_value_dynarray, self->m_nentries+1));
    E_SET_PTR (rlauf,  result);
    if (ERWIN_UNLIKELY(result == NULL)) {
        MAP_NOMEM;
        return NULL;
...
#if defined(E_REQUIRE_DETERMINISM) && !defined(E_WEAK_DETERMINISM)
    if (e_require_determinism ()) {
        err_map_int_int_check_detcmp_values;
        qsort (result,
               self->m_nentries,
               sizeof (int),
               (int(*)(void const *, void const *))err_map_int_int_pair_detcmp_values);
    }
#endif
...
i_type_t * err_map_int_int_get_keys
        (err_map_int_int_t const *self)
{
    int *result;
    int *rlauf;
...
#ifdef ERR_MAP_INT_INT_ALLOW_NULL
    if (self == NULL) {
        E_SET_PTR (result, KEY_NEW_ARRAY (err_map_int_int_key_dynarray, 1));
        if (ERWIN_UNLIKELY(result == NULL)) {
            MAP_NOMEM;
            return NULL;
        }
    ...
    E_SET_PTR (result, KEY_NEW_ARRAY (err_map_int_int_key_dynarray, self->m_nentries+1));
    E_SET_PTR (rlauf,  result);
    if (ERWIN_UNLIKELY(result == NULL)) {
        MAP_NOMEM;
        return NULL;
    ...
    if (e_require_determinism ())
        qsort (result,
               self->m_nentries,
               sizeof (int),
               (int(*)(void const *, void const *))err_map_int_int_pair_detcmp_keys);
#endif
...
void err_map_int_int_delete_entries
        (err_map_int_int_pair_t *entries)
{
    PAIR_DELETE_ARRAY (entries);
}

CODE_SECTION(".text.delete_entries_ptr")
void err_map_int_int_delete_entries_ptr
        (err_map_int_int_pair_ptr_t *entries_ptr)
{
...
void err_map_int_int_delete_values
        (int *values)
{
...
void err_map_int_int_delete_keys
        (int *keys)
{
...
ERR_ERWIN_BOOL err_map_int_int_equal
        (err_map_int_int_t const *self, err_map_int_int_t const *other)
{
    ...
    err_map_int_int_forall_nondet (self, iter, key, value)
    {
        int *value_ptr;
        E_SET_PTR (value_ptr, err_map_int_int_find_ptr (other, key));
        if (value_ptr == NULL)
            return ERR_ERWIN_FALSE;
    ...
    error_return0_if_reached_ppt (
        self,
        "Because neither ERR_INT_EQUAL nor ERR_INT_CMP was #defined, err_map_int_int_equal could not be implemented.");
#endif
}


CODE_SECTION(".text.find_any_pair_q")
int err_map_int_int_find_any_pair_q
        (err_map_int_int_key_result_t *key_p, err_map_int_int_element_ptr_t *value_p, err_map_int_int_t const* self)
{
    int i;
    ...
    { /* Find smallest entry. */
        ...
        for (i= 0; i < self->m_hashsize; i++) {
           ...
           E_SET_PTR (lauf, SLOT(self,i));
           while (lauf) {
               if (first || err_map_int_int_pair_detcmp_keys (&lauf->key, &last) < 0) {
                   first= 0;
...
i_type_result_t err_map_int_int_find_any_key
        (err_map_int_int_t const *self)
{
    int result;
    int n= err_map_int_int_find_any_pair_q (&result, NULL, self);
...
err_map_int_int_element_ptr_t err_map_int_int_find_any_ptr
        (err_map_int_int_t const *self)
{
    err_map_int_int_element_ptr_t result;
    int n= err_map_int_int_find_any_pair (NULL, &result, self);
    if (ERWIN_UNLIKELY(n == 0))
        return NULL;
    return result;
}
...
o_type_result_t err_map_int_int_find_any
        (err_map_int_int_t const *self)
{
    err_map_int_int_element_ptr_t result_p;
    int n= err_map_int_int_find_any_pair (NULL, &result_p, self);
    if (ERWIN_UNLIKELY(n == 0))
        return ZERO(self);
    return *result_p;
}
...
ERR_ERWIN_BOOL err_map_int_int_equal_keys
        (err_map_int_int_t const *self, err_map_int_int_t const *other)
{
    e_iterator_t iter;
    int key;
    ...
    err_map_int_int_forall_keys_nondet (self, iter, key) {
        (void)err_map_int_int_find_ptr (other, key);
        if (e_errno != E_OK)
            return ERR_ERWIN_FALSE;
    }
...
int err_map_int_int_cmp
        (err_map_int_int_t const *self, err_map_int_int_t const *other)
/* must be NULL safe per definition! */
{
#if defined(ICMP) && defined(OCMP)
    err_map_int_int_pair_t *them1;
    err_map_int_int_pair_t *them2;
    int i;
    int result= 0;
    int cnt;
    err_map_int_int_check0_cmp_keys;
    err_map_int_int_check0_cmp_values;
#endif
    ...
    E_SET_PTR (them1, err_map_int_int_get_entries (self));
    if (ERWIN_UNLIKELY(e_errno != E_OK))
        return 0;

    E_SET_PTR (them2, err_map_int_int_get_entries (other));
    if (ERWIN_UNLIKELY(e_errno != E_OK)) {
        err_map_int_int_delete_entries (them1);
        return 0;
    }

#if defined(E_REQUIRE_DETERMINISM) && !defined(E_WEAK_DETERMINISM)
    if (e_require_determinism()) {
        qsort ((void*)them1, cnt, sizeof (err_map_int_int_pair_t), err_map_int_int_pair_detcmp_keys);
        qsort ((void*)them2, cnt, sizeof (err_map_int_int_pair_t), err_map_int_int_pair_detcmp_keys);

        e_merge_sort ((void*)them1, cnt, sizeof (err_map_int_int_pair_t), err_map_int_int_pair_cmp_keys);
        e_merge_sort ((void*)them2, cnt, sizeof (err_map_int_int_pair_t), err_map_int_int_pair_cmp_keys);
    }
    else
#else
    {
        qsort ((void*)them1, cnt, sizeof (err_map_int_int_pair_t), err_map_int_int_pair_cmp_keys);
        qsort ((void*)them2, cnt, sizeof (err_map_int_int_pair_t), err_map_int_int_pair_cmp_keys);
    }
#endif

    for (i=0; i < cnt; i++) {
        result= err_map_int_int_pair_cmp_keys (them1 + i, them2 + i);
        if (result != 0)
            break;

        result= err_map_int_int_pair_cmp_values (them1 + i, them2 + i);
        if (result != 0)
            break;
    }

    err_map_int_int_delete_entries (them1);
    err_map_int_int_delete_entries (them2);
    ...
    error_return0_if_reached_ppt (
        self,
        "Because either ERR_INT_CMP or ERR_INT_CMP was not #defined, err_map_int_int_cmp could not be implemented.");
#endif
}
...
/* must be NULL safe per definition! */
{
    ...
    E_SET_PTR (them1, err_map_int_int_get_keys (self));
    if (ERWIN_UNLIKELY(e_errno != E_OK))
        return 0;

    E_SET_PTR (them2, err_map_int_int_get_keys (other));
    if (ERWIN_UNLIKELY(e_errno != E_OK)) {
        err_map_int_int_delete_keys (them1);
        return 0;
    }

    qsort ((void*)them1, cnt, sizeof (int), err_map_int_int_wrap_icmp);
    qsort ((void*)them2, cnt, sizeof (int), err_map_int_int_wrap_icmp);
    ...
    err_map_int_int_delete_keys (them1);
    err_map_int_int_delete_keys (them2);
    ...
    error_return0_if_reached_ppt (
        self,
        "Because either ERR_INT_CMP was not #defined, err_map_int_int_cmp_keys could not be implemented.");
#endif
}
...
e_hashval_t err_map_int_int_hash_raw
        (err_map_int_int_t const *self)
/* must be NULL-safe */
{
#ifdef OHASH
    ...
    error_return0_if_reached_ppt (
        self,
        "Because ERR_INT_HASH was not #defined, err_map_int_int_hash_raw could not be implemented.");
#endif
}
...
CODE_SECTION(".text.t")
 err_map_int_int_t::err_map_int_int_t
        (void)
{
    ERR_ERWIN_BOOL ok= err_map_int_int_init_internal_q (it(), OZERO, ERR_MAP_INT_INT_INITIAL_SIZE);
    (void)ok; /*unused*/
    return_if_fail_pp (ok, this);
}

CODE_SECTION(".text._constructor")
void err_map_int_int_t::_constructor
        (void)
{
    ERR_ERWIN_BOOL ok= err_map_int_int_init_internal_q (it(), OZERO, ERR_MAP_INT_INT_INITIAL_SIZE);
    (void)ok; /*unused*/
...
err_map_int_int_t const & err_map_int_int_t::static_zero
        ()
{
    static err_map_int_int_t const *z= NULL;
    if (ERWIN_UNLIKELY(!z))
        E_SET_PTR (z, new err_map_int_int_t);
    return *z;
}
...
CODE_SECTION(".text.t")
 err_map_int_int_t::err_map_int_int_t
        (int size)
{
    ERR_ERWIN_BOOL ok= err_map_int_int_init_internal_q (it(), OZERO, size);
    (void)ok; /*unused*/
    return_if_fail_pp (ok, this);
}
#endif /* ERR_MAP_INT_INT_HAVE_INT_CONSTRUCTOR */
...
CODE_SECTION(".text.t")
 err_map_int_int_t::err_map_int_int_t
        (int  zeroval)
{
    ERR_ERWIN_BOOL ok= err_map_int_int_init_internal_q (it(), zeroval, ERR_MAP_INT_INT_INITIAL_SIZE);
    (void)ok; /*unused*/
    return_if_fail_pp (ok, this);
}
...
{
    ERR_ERWIN_BOOL ok= err_map_int_int_init_internal_q (it(), zeroval, size);
    (void)ok; /*unused*/
    return_if_fail_pp (ok, this);
}
#endif /* ERR_MAP_INT_INT_DYN_ZERO */
...
CODE_SECTION(".text.t")
 err_map_int_int_t::err_map_int_int_t
        (err_map_int_int_t const &other)
{
#ifdef ERWIN_DOS
    if (other.it()->m_table == NULL && other.it()->m_nentries == 0) {
        /* See copy constructor for vectors for explanation. */
        err_map_int_int_init_internal_q (it(), OZERO, ERR_MAP_INT_INT_INITIAL_SIZE);
    }
    else
#endif
    {
        err_map_int_int_init_internal_q (it(), ZERO(other.it()), other.it()->m_nentries);
        err_map_int_int_struct_copy (it(), other.it());
    }
}
...
CODE_SECTION(".text.t")
 err_map_int_int_t::err_map_int_int_t
        (err_map_int_int_t const *other)
{
    err_map_int_int_init_internal_q (it(), ZERO(other), other->m_nentries);
    err_map_int_int_struct_copy (it(), other);
}
...
CODE_SECTION(".text.err_map_int_int_t")
 err_map_int_int_t::~err_map_int_int_t
        ()
{
    err_map_int_int_destroy_internal (it());
}


CODE_SECTION(".text._destructor")
void err_map_int_int_t::_destructor
        ()
{
    err_map_int_int_destroy_internal (it());
}
...
void * err_map_int_int_t::operator new
        (size_t s)
{
...
void err_map_int_int_t::operator delete
        (void *p, size_t s)
{
    (void)s; /*unused*/
...
err_map_int_int_t & err_map_int_int_t::operator=
        (err_map_int_int_t const *other)
{
    err_map_int_int_clear_no_resize (it());
    err_map_int_int_expect_size (it(), other->it()->m_nentries); /* realloc to good size */
    err_map_int_int_struct_copy (it(), other->it());
    return *this;
}
...
double err_map_int_int_average_line_length
        (err_map_int_int_t const *self)
{
    double sum = 0.0;
    int i;
    for (i=0; i < self->m_hashsize; i++)
        sum+= err_map_int_int_hashlist_length (SLOT(self,i));
    return sum / (double)(self->m_hashsize);
}

CODE_SECTION(".text.variance_line_length")
double err_map_int_int_variance_line_length
        (err_map_int_int_t const *self)
{
    double average= err_map_int_int_average_line_length (self);
    double sum2= 0.0;
    int i;
    for (i=0; i < self->m_hashsize; i++) {
        double diff= err_map_int_int_hashlist_length (SLOT(self,i)) - average;
        sum2+= diff*diff;
    }
...
int err_map_int_int_max_line_length
        (err_map_int_int_t const *self)
{
    int i;
    int max = 0;
    for (i=0; i < self->m_hashsize; i++) {
        int len= err_map_int_int_hashlist_length (SLOT(self,i));
        if (len > max) max= len;
    }
    return max;
}
...
int err_map_int_int_min_line_length
        (err_map_int_int_t const *self)
{
    int i;
...
double err_map_int_int_deviation_line_length
        (err_map_int_int_t const *self)
{
    return sqrt (err_map_int_int_variance_line_length (self));
}
#endif /* defined(HAVE_SQRT) */


CODE_SECTION(".text.dump")
void err_map_int_int_dump
        (FILE *thefile, err_map_int_int_t const *self)
{
    int i;
    fprintf (thefile, "(err_map_int_int_dump):\n");
...
int err_map_int_int_nrehash_ops
        (err_map_int_int_t const *self)
{
...
#undef ERR_MAP_INT_INT_IMPLEMENTATION
