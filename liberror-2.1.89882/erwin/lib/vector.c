...
int err_erwininternalvectorerrno= ERR_ERWININTERNALVECTOROK;
...
int *err_erwininternalvectorerrnoptr(void)
{
    int *errno_ptr;
    ...
    if (ERWIN_UNLIKELY(!errno_ptr)) {
        ...
        *errno_ptr= ERR_ERWININTERNALVECTOROK;
...
char const *err_erwininternalvectorstrerror (int i)
{
    switch (i) {
        case ERR_ERWININTERNALVECTOROK:
            return "No error";

        case ERR_ERWININTERNALVECTORERRNOMEM:
            return "Error: Memory exhausted";

        case ERR_ERWININTERNALVECTORERROUTOFRANGE:
            return "Error: Index out of range";

        case ERR_ERWININTERNALVECTORERRASSERTIONFAILED:
            return "Error: Assertion failed";

        case ERR_ERWININTERNALVECTORERRNOTCOMPILED:
            return "Error: Feature disabled at compile time";

        case ERR_ERWININTERNALVECTORERRIO:
            return "Error: Input/output error";

        case ERR_ERWININTERNALVECTORWARNOUTOFRANGE:
            return "Warning: Index out of range";

        case ERR_ERWININTERNALVECTORWARNEMPTY:
            return "Warning: Vector is empty";
    }
