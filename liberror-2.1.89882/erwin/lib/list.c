...
int err_erwininternallisterrno= ERR_ERWININTERNALLISTOK;
...
int *err_erwininternallisterrnoptr(void)
{
    int *errno_ptr;
    ...
    if (ERWIN_UNLIKELY(!errno_ptr)) {
        ...
        *errno_ptr= ERR_ERWININTERNALLISTOK;
...
char const *err_erwininternalliststrerror (int i)
{
    switch (i) {
        case ERR_ERWININTERNALLISTOK:
            return "No error";

        case ERR_ERWININTERNALLISTERRNOMEM:
            return "Error: Memory exhausted";

        case ERR_ERWININTERNALLISTERROUTOFRANGE:
            return "Error: Index out of range";

        case ERR_ERWININTERNALLISTERRASSERTIONFAILED:
            return "Error: Assertion failed";

        case ERR_ERWININTERNALLISTERRNOTCOMPILED:
            return "Error: Feature disabled at compile time";

        case ERR_ERWININTERNALLISTWARNOUTOFRANGE:
            return "Warning: Index out of range";

        case ERR_ERWININTERNALLISTWARNEMPTY:
